...
\left(1-\frac26\right)^{7-5} = \LoesungsRaum{\frac{28}{729}} \approx \LoesungsRaum{0.03841}$$
...
$$P(E=17) = {20 \choose 17}\cdot 0.85^{17}\cdot (1-0.85)^{20-17} =  {20 \choose 17}\cdot 0.85^{17}\cdot (0.15)^{3}\approx{}\LoesungsRaum{24.28\%}$$
