...
c) ... höchstens eine \epsdice{6} zu werfen?\\
d) ... nicht viermal eine eine \epsdice{6} zu werfen?\\
e) ... mehr als dreimal eine \epsdice{6} zu werfen?\\
}%% end Aufgabenfarbe
\TNTeop{
...
c) ca. 48.45\,\%: Dies ist die selbe Aufgabe wie b)

d) $P(X \ne 4) = 1- P(X = 4) \approx 1 - 0.0543 = 94.57\,\%$

e) $P(X > 3) = 1-P(X\le 3) = 1 - \sum_{k=0}^{3} {10 \choose k} \cdot{} \left( \frac16 \right)^k \cdot{}
