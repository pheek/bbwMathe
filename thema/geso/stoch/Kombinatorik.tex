...
\aufgabenFarbe{Johann W. G. aus Frankfurt schrieb viele Texte. Er
  wollte vielleicht auch einmal die acht Vorsilben «ver», «vor», «be», «über», «an», «ab», «fort» und
...
\TNT{6}{
Theoretisch gibt es $6\cdot{}8 = 48$ Möglichkeiten. Welche Bedeutung
...
Auf wie viele Arten kann ich die Buchstaben im Namen «OTTO» neu anordnen?

\TNT{3.2}{OOTT, TTOO,  OTOT, TOTO, TOOT, OTTO

  $$N = \frac{4!}{2!\cdot{} 2!} = \frac{24}{2\cdot{}2} = 6$$
}
