...
(Eine Zusammenfassung und Entscheidungshilfe finden Sie auf Seite
...
\aufgabenFarbe{Bei einem Spiel wird zunächst eine Münze geworfen (Kopf oder Zahl), danach ein Spielwürfel geworfen (1-6) und zuletzt mit dem Kompass eine der vier Himmelsrichtungen (N,O,S,W) bestimmt. Ein Möglicher Ausgang wäre (Kopf, Drei, Ost). Ein anderer möglicher Ausgang wäre (Zahl, Zwei, Süd). Wie viele solche Ausgänge sind denkbar?}
