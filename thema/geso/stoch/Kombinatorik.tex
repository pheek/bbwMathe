...
\begin{definition}{Variation}{}\index{Variation!Definition}
...
\TNT{8}{\bbwGraphic{15cm}{geso/stoch/img/Urnenmodell.png}\\
...
\TNT{2}{Jedes Ergebnis ist vom vorangehenden unabhängig. Somit gibt es zwei mal sechs mal vier Variationen = 48 Mögliche Ausgänge}


\newpage

\subsection{Variation ohne Wiederholung}\index{Variation!ohne Wiederholung}
...
\TNT{6}{6 Varianten. Jede der drei Personen
...
\TNT{2.4}{24 = 4!\vspace{28mm}}%% END TNT
...
\TNT{2.4}{120 = 5!\vspace{30mm}}%% END TNT
\newpage
...
\end{gesetz}
\TNT{4}{Urne mit 4 Kugeln und daneben 4 Plätze zeichnen lassen.}
\newpage
...
\subsection*{Aufgaben}
\aufgabenFarbe{Kompendium S. 46 Kap. 5.5.1 Aufg. 15}
\newpage


\subsubsection{Permutation einer Teilmenge}\index{Permutation!einer Teilmenge}
...
$\frac{10!}{(10-8)!}\cdot 4$ 10 mal 9 mal 4 = 360.}
...
$10000-10-360=9630$. (2. Rechenweg: Muster «XYZT» + «XYZZ» + «XXYY»
und alle Vertauschungen: $10\cdot{}9\cdot{}8\cdot{}7 +
10\cdot{}9\cdot{}8\cdot{}\frac{12}2 + 10\cdot{}9\cdot{}\frac62$)
}
\newpage
Aufgaben aus dem Kompendium:


\aufgabenFarbe{Kompendium S. 46 Kap. 5.5.1 Aufg. 16.}
...
\TNT{2.8}{$$N={5\choose 3} = \frac{5!}{3!\cdot{} 2!}=10$$}%% END TNT
\newpage
...
Ebenso haben wir die Variationen aus AB ($=2!$) doppelt gezählt.
}%% END TRAINER
...
\TNT{2}{$$N ={5\choose 3} = {5\choose 2} = \frac{5!}{3!\cdot{}2!} = \frac{120}{6\cdot{}2}$$}%% END TNT
...
\TNT{12}{${50 \choose 5} \cdot {12 \choose 2} =139\,838\,160$
