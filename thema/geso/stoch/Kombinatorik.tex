...
\subsection{Kombinationen ohne Wiederholung}\index{Kombination}\label{kombiKombination}
...
\subsection{Kombinationen mit Wiederholung}\index{Kombination!mit Wiederholung}\label{kombiVariationMitWiederholung}
...
\TNT{8}{$n=3$: Optional zur Auswal,

  $k=10: Müssen gewählt werden$
...
Gipfeli Sorte 1 (Bsp. Butter)

Gipfeli Sorte 2 (Bsp. Laugen)

Gipfeli Sorte 3 (Bsp. Vollkorn)
