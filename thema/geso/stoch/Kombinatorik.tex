...
\begin{gesetz}{Produktregel}{}
  ...
  einzelnen Möglichkeiten ($n_i$) zur Gesamtzahl aller Möglichkeiten ($N$).
\end{gesetz}
...
\aufgabenFarbe{Johann W. G. aus Frankfurt schrieb viele Texte. Er
  wollte vielleicht auch einmal die acht Vorsiblen «ver», «vor», «be», «über», «an», «ab», «fort» und
«zu» in einem Gedicht verwenden und diese mit den sechs Verben
«gehen», «geben», «laufen», «lassen», «schlagen» und «ziehen»
kombinieren. Wie viele solche Kombinationen aus Vorsilbe und Verb (wie «fortlassen» oder
«angeben» sind damit möglich? Ergeben alle diese Wörter einen Sinn?}
\TNT{6}{
Theoretisch gibt es $6\cdot{}8 = 48$ Möglichkeiten. Ob das Wort
«fortschlagen» jedoch sinnvoll ist, kann uns nicht mal der J. W. Goethe sagen.}
