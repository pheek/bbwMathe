...
\begin{definition}{Nullhypothese}{}
...
\TNT{2}{Es ist ein «fairer» Würfel, der ca. ein
Sechstel aller Würfe eine \epsdice{3} zeigt.}


Die Alternativhypothese lautet hier:

\TNT{2}{Der Würfel ist nicht fair und
zeigt mehr Dreien als der bloße Zufall.}
...
Auch wenn der Würfel nun nicht exakt fünf mal die Drei bringt, können
...
Würfel bei 29maligem Werfen \textbf{maximal} sechs Mal eine \epsdice{3}
zeigt:
...
$k$  & Wahrscheinlichkeit, genau $k$-mal eine \epsdice{3} zu erzielen
...
\TNT{2}{\textbf{Der Würfel ist fair}: Er liefert bei 29-maligem Werfen
typischerweise nicht mehr als 4 bis 5 Mal die \epsdice{3}.}
\end{center}

\begin{center} $H_1$ (Alternativhypothese):

\TNT{2}{\textbf{Der Würfel ist nicht fair}: Er liefert bei 29-maligem Werfen
...
Wir wollen für unsere Annahme ($H_1$) mit minimal 95 \%-iger
Wahrscheinlichkeit sicher gehen.
...
\texttt{binomil\textbf{c}df} $n=29; p=\frac16$
...
\TNT{2}{\textbf{Annahmebereich} = 0 bis 8 \epsdice{3}-ern und der}
...
a) Wie lautet die $H_0$-Hypothese (Nullhypothese)? Und wie die
Alternativhypothese ($H_1$), also die Hypothese zur \textbf{Vermutung}?
...
b) Geben Sie den Annahmebereich und den Ablehnungsbereich der
Nullhypothese auf einem 95\% Signifikanzniveau (Heißt $\alpha \le
5\%$) an bei einer Stichprobe von 45 Abgängerinnen.

\TNTeop{
Binomial\textbf{c}df liefert bei $n=1$ 3.46 \% und bei $n=2$ bereits
11.45 \%. Somit ist der Annahmebereich der $H_0$-Hypothese (also der
Nullhypothese) 2 bis 45.
