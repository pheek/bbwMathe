...
b) \textbf{Unter den Kranken} eine positiv getestete Person (P) zu finden? \LoesungsRaum{95/97}
...
Frage 1: Wie viele Prozente der negativ Getesteten sind trotzdem krank?
...
\TNTeop{
  $$P(G|N) = \frac{22}{24}\approx 91.7\%$$


  Mögliche weitere Aufgabe: BMP 2018 Serie 4 Aufgabe 14
}%%
