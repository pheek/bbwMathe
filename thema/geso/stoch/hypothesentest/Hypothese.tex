...
\subsubsection*{Referenzaufgabe Basketballspieler}

Basil Ballisti trifft im Mittelwert 17 von 20 Bällen beim Basketball.

Heute hat er gerade mal 12 Treffer gelandet.

Formulierern Sie eine Hypothese und eine Alternativhypothese, wo Sie
glauben, er treffe weniger, als seine üblichen 17 von 20 Bällen.


\textbf{Nullhypothese}:

\TNT{4}{
$H_0$: Basil Ballisti trifft mit einer Wahrscheinlichkeit von 85\,\%.
}

\textbf{Alternativhypothese}:

\TNT{4}{$H_1$: Basil Ballisti trifft mit weniger als 85\,\%.}
