...
Mit 98.43 \% Wahrscheinlichkeit liefert der normale Würfel bis max. 8 Mal die \epsdice{3}.
...
Das Signifikanzniveau wird in Sozialwissenschaften oft als \zB 5 \%
Wahrscheinlichkeit «sich zu irren» angenommen.
...
Fehler erster Art (Alpha ($\alpha$)-Fehler) = Fälschliche
Zurückweisung der Nullhypothese. $H_0$ wird abgelehnt, obschon sie
wahr ist. 
...
Fehler zweiter Art (Beta ($\beta$)-Fehler) = Fälschliche Beibehaltung
der Nullhypothse. $H_0$ wird beibehalten, obschon sie falsch ist. 
