...
\sectuntertitel{77\,\% der schwedischen und 88\,\% der amerikanischen
Autofahrer haben das Gefühl, sie fahren besser als der Durchschnitt.}
...
\TRAINER{(Der Beweis sprengt den Rahmen der BMS.)}
...
\TNT{2}{$$\mathbb{E}(X) = n\cdot{} p = 100\cdot{}0.8 = 80 \text{ Personen}$$}
...
Basil Ballisti wird mit der höchsten Wahrscheinlichkeit genau
\LoesungsRaumLen{30mm}{17} Treffer landen.

Auch wenn die
Wahrscheinlichkeit dafür nur \LoesungsRaumLen{30mm}{24.28\,\%} beträgt.
\newpage
