...
\TNT{1.6}{Wir ersetzen: $u := {\color{ForestGreen}\tmpPart{}}$}

und die ursprüngliche Gleichung ist nun äquivalent zu
\TNT{1.6}{$$-6{\color{ForestGreen}u} + 8.75 = -{\color{ForestGreen}u}^2.$$}

Substituierte Gleichung \GESO{mit TR }lösen:


$$\mathbb{L}_u=\LoesungsRaumLang{\{2.5; 3.5\}}$$

\TALS{\TRAINER{
  Erst in Grundform bringen $$u^2 - 6u + 8.75 = 0$$
  und danach mit der $a$-$b$-$c$ -- Formel auf"|lösen ($a=1, b=-6, c=8.75$).
}}%%
...
\TNTeop{
$$1.: u_1 = 2.5 = \tmpPart{} \Rightarrow 7.5 = 5x+0.5 \Rightarrow x = \frac{7}{5} = 1.4$$

$$2.: u_2 = 3.5 = \tmpPart{} \Rightarrow 10.5=5x+0.5 \Rightarrow x = 2$$
...
\TNT{8}{Lösung der Substituierten $u=(x-5)^2)$ ist $u=3$ bzw. $u=-\frac83$. Die zweite Lösung kommt jedoch nur als Scheinlösung vor.\vspace{45mm}}%% END TNT
