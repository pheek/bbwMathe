...
Bemerkungen:
\TNT{1.6}{Lernziel $x^2+10x+25=7$ bekannt geben.}%% END TNT


\TNT{1.6}{ Mathematisches Verfahren = \textbf{Algorithmus}\index{Algorithmus}}%% END TNT
...
\TRAINER{Zu zweit besprechen; danach geführt Lösungsweg gemeinsam festhalten.}
$$x^2=49$$
...
( Erinnert Sie das ursprüngliche Beispiel an $|x-2| = 7$ ??)
 ...
 danach unbedingt Probe vorzeigen.\vspace{32mm}
...
\input{allg/gleichungen/quadratische/Substitution}
