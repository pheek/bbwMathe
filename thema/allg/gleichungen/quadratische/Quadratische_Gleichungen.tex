...
Bemerkungen:
\TNT{1.6}{Lernziel/Fernziel $x^2+10x+25=7$ bekannt geben. Allgemein
  $x^2 +2bx + b^2 = r \text{ mit } b,r\in\mathbb{R} $}%% END TNT
...
\TALS{\olatLinkArbeitsblatt{Quadratische
    Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/107315676197926}{Was ändert sich von Aufgabe zu Aufgabe?}}
...
\GESO{\olatLinkArbeitsblatt{Quadratische
    Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/107315676197926}{(Weiter ab derjenigen Nummer, wo Sie aufgehört hatten.)}}
