...
\GESO{Repetitionsaufgabe:
\subsubsection{Voraussetzungen}
  $$|x-2| = 7$$
  \TNT{3.2}{1. Fall $x-2 = +7\Longrightarrow x=9$ und 2. Fall $x-2 =
    -7 \Longrightarrow x=-5$ }
}
...
\TNTeop{Nach einigen Aufgaben folgende abkürzende Schreibweise
  zeigen:
  $$(x-5)^2 = 81 | \pm \sqrt{\,}$$
$$x-5 = \pm 9 | + 5$$
$$ x = 5 \pm 9$$
...
\textbf{2. Beispiel mit Parametern}
