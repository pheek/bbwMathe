...
\TALS{\item Taschenrechner: Mit und ohne Parameter}
...
\GESO{\input{geso/gl1/Voraussetzungen}}
...
\GESO{\olatLinkArbeitsblatt{GlQuad}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/111365559999287}{Aufgabe 1 von «a bis z» [bis und mit s); Aufgabe h) optional; Bei Aufgabe l) mit der Lösung die Probe machen]}
  }%% end GESO
...
\TRAINER{(optionaler Beweis): $$z^2 = az + b^2$$ wird quadratisch ergänzt zu
...
\DeclareRobustCommand{\tempA}{Aufgabe 2. a) bis d) und und 3. a) bis e)}
...
\TALS{\olatLinkArbeitsblatt{GlQuad}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/111365560138736}{\tempA{}}}%% end GESO
...
\DeclareRobustCommand{\tempA}{Aufg. 4. (jede 2. Aufgabe) und zusätzlich
  4. n), 5. a) und b)}
\GESO{\olatLinkArbeitsblatt{GlQuad}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/111365559999287}{\tempA}
  }%% end GESO
\TALS{\olatLinkArbeitsblatt{GlQuad}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/111365560138736}{\tempA}
  }%% end GESO
...
\TALS{\input{tals/gl2/Spezialfaelle}}%% END TALS
\newpage
...
\TALS{\input{tals/gl2/Taschenrechner}}
%%\GESO{\input{geso/gl1/Taschenrechner}}%% nicht mehr RLP 2030

\newpage


\TALS{\input{tals/gl2/Fallunterscheidung}}
\newpage
\TALS{\input{tals/gl2/Substitution}}
\newpage
...
die anderen Verfahren (Binome, weitere Spezialfälle, ...)
...
\begin{tabular}{|p{30mm}|p{53mm}|p{64mm}|}
	\hline
	Spezialfall $b=0$               & $5x^2 = 3$                   &
  Durch $a$ dividieren; auch negatives der Wurzel beachten.\\
	\hline
	...
	\hline
	Grundform            & $x^2 -2x + 1= 0$           & ABC-Formel (Mitternachtsformel) oder faktorisieren $x^2-2x+1=(x-1)^2$ und danach jeden einzelnen Faktor $=0$ setzen.\\
	\hline
...
\DeclareRobustCommand{\tempA}{Aufgabe 11: Vermischte Aufgaben,
  15. (Textaufgaben) Bsp. a) c) e) g) j) l) m) n)}
\GESO{\olatLinkArbeitsblatt{GlQuad}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/111365559999287}{\tempA{}}}%% end GESO
