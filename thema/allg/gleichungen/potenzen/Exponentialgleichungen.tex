...
Im wievielten Jahr ist ein Vermögen von anfänglich 1\,234.50 CHF bei gleichbleibendem Zinsfuß von 3 \% mit Zins und Zinseszins auf 1\,500.- CHF angewachsen?

\TNTeop{
  $$1500 = 1234.5 \cdot{} 1.03^n$$
  $$n = \log_{1.03}\left(\frac{1\,500}{1\,234.50}\right) \approx 6.6$$
  Im 7. Jahr ist das Vermögen auf 1\,500 angewachsen.
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%555555
...
\TRAINER{Tipp: Erst TR-Lösung, dann Kontrolle von Hand! Dies ist
...
\begin{gesetz}{Term im Exponenten}{}
  $$a^{T(x)} = b \Longleftrightarrow \LoesungsRaumLen{40mm}{T(x) = \log_a(b)}$$
\end{gesetz}
\newpage
\subsection*{Aufgaben}
\GESO{\olatLinkArbeitsblatt{Exponentialgleichungen
