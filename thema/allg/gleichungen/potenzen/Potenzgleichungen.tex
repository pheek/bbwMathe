...
\begin{gesetz}{}{}
 ...
 \begin{center}\fbox{Gegeben $x^n=c$, $n\ne 0$}\end{center}
 ...
 \begin{bbwFillInTabular}{l|l|l}
                        & $c>0$                                  & $c<0$                      \\\hline
  $n$ gerade            & $\lx =\LoesungsRaumLen{45mm}{\{-\sqrt[n]{c}; +\sqrt[n]{c}\}}$ & $\lx=\LoesungsRaumLen{45mm}{\{\}}$               \\\hline
  $n$ \textbf{un}gerade & $\lx = \LoesungsRaumLen{45mm}{\{+\sqrt[n]{c}\}}$
   & $\lx = \LoesungsRaumLen{45mm}{ \{\text{ TR:  }  \sqrt[n]{c} \}  = \{-\sqrt[n]{|c|}\}}$
 \end{bbwFillInTabular}  
...
\subsection*{Aufgaben: Anwendungen}

\aufgabenFarbe{Ein Kapital wächst mit Zins- und Zinseszins innerhalb von 25 Jahren von CHF 10\,000.- auf CHF 18\,092.50 an. Wie groß ist der Jahreszins?}
\TNT{8}{
  Formel: $K_0 \cdot{} r^{25} = K_{25}$

  $$10\,000 \cdot{} r^{25} = 18\,092.50$$
  $$r^{25} = 1.80925$$
  $$r = \sqrt[25]{1.80925}\approx 1.024$$
  Somit betrug der Jahreszins 2.4\,\%
}

\aufgabenFarbe{Der Anfangsbestand einer Bakterienpopulation in einem Reisgericht rechnete sich lediglich auf ca. 200 Stk. Nach 8.5 Stunden werden ca. 10\,000 Stk. gemessen. Um welchen Faktor haben sich die Bakterien pro Stunde vermehrt?}

\TNTeop{
  $$10\,000 = 200 \cdot{} a^{8.5}$$
  $$\frac{10\,000}{200} = 50 = a^{8.5}$$
  Wurzel:
  $$a = \sqrt[8.5]{50} \approx 1.58445$$

  Die Bakterien vermehren sich pro Stunde ca. um den Faktor 1.584.
}
...
\TNT{2}{Anstelle von $\sqrt[n]{x}$ hatten wir auch  $x^{\frac{1}{n}}$
  geschrieben.}%% end TNT
...
Elementare Wurzelgleichungen\index{Wurzelgleichung} können aufgefasst werden als
