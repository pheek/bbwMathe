...
\TNT{1.6}{$a$ = Potenzwert, $n$ = Exponent}
...
\begin{bbwFillInTabular}{c|l|c|c|}
  \multicolumn{2}{l}{} & $a$ & $n$ \\
  \hline
  $x^2 =  4$ & $\lx=\LoesungsRaumLang{\{-2; +2\}}$        &\LoesungsRaumLen{20mm}{$a>0$}&\LoesungsRaumLen{40mm}{$n$ gerade}\\\hline
  $x^3 =  8$ & $\lx=\LoesungsRaumLang{\{2\}}$             &\LoesungsRaumLen{20mm}{$a>0$}&\LoesungsRaumLen{40mm}{$n$ ungerade}\\\hline
  $x^3 = -8$ & $\lx=\LoesungsRaumLang{\{-2\}}$            &\LoesungsRaumLen{20mm}{$a<0$}&\LoesungsRaumLen{40mm}{$n$ ungerade}\\\hline
  $x^6 = -5$ & $\lx=\LoesungsRaumLang{\{\,\}}$            &\LoesungsRaumLen{20mm}{$a<0$}&\LoesungsRaumLen{40mm}{$n$ gerade}\\\hline
  $x^7 = -5$ & $\lx=\LoesungsRaumLang{\{-\sqrt[7]{5}\}}$  &\LoesungsRaumLen{20mm}{$a<0$}&\LoesungsRaumLen{40mm}{$n$ ungerade}\\\hline
