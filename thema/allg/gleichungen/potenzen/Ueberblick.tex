...
%%  \multicolumn{3}{c}{\,}\\ %% Generiere etwas Abstand
  ...
  \hline
  $\sqrt[3]{1000}=c$       & $\sqrt[3]{b}=10$                    &  $\sqrt[x]{1000}=10$               \\
  \hline
  $1000^{\frac{1}{3}}=c$     & $b^{\frac{1}{3}}=10$                   &  $1000^{\frac{1}{x}}=10$               \\
  $c=\TRAINER{\sqrt[3]{1000}=10}$       & \noTRAINER{\hspace{15mm}}$\TRAINER{\left(b^\frac13 \right)^3}=\TRAINER{10^3}$  & $\TRAINER{\frac{1}{x} }\noTRAINER{\hspace{2cm}}=\TRAINER{  \log_{1000}(10)}$      \\
