...
<<<<<<< HEAD
\TALS{\input{tals/gl2/QuadratischeGleichungenVoraussetzungen}}{Al Chwarizmi}\index{Al Chwarizme}\index{Chwarizmi (Al
  Chwarizmi)}
...
\TNTeop{
  ...
  Alle $10$ senden es $9$ Personen weiter. Daraus erfolgen $10\cdot{}9$, also $90$
  Posts.
...
\subsubsection{Einfache quadratische Gleichungen}
\TRAINER{zu zweit besprechen.}
$$x^2=49$$

\TNT{3.2}{$$\sqrt{x^2} = \sqrt{49}$$
  $$|x| = 7$$
  $\lx = \{-7; 7\}$ \vspace{15mm}}
...
\TNT{12}{
 ...
 Ausmultiplizieren führt in eine Sackgasse:
 $$x^2-4x+4=49$$
 $$x^2-4x=45 \text{Sackgasse! Umkehren!}$$
 ...
 $$|x-2|=7$$
 und somit
 $$x=9 \text{ aber auch } x=-5$$

 $$\lx = \{-5; 9\}$$

 danach unbedingt Probe vorzeigen.\vspace{32mm}}%% END TNT

Bemerkung: \TRAINER{ Mathematisches Verfahren =
  \textbf{Algorithmus}\index{Algorithmus}}
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\subsection{Begriffe und Definition}

\subsubsection{Definition}

\begin{definition}{quadratische Gleichung}{}\index{quadratische Gleichung}\index{Gleichung!quadratische}
...
$5^2=25x-6$ &
  \noTRAINER{\fbox{\,\vphantom{$X$}}}\TRAINER{\fbox{\color{red} X} falsch} \\
$5=x^2-6$ &
  \noTRAINER{\fbox{\,\vphantom{$X$}}}\TRAINER{\fbox{\color{green} \checkmark}} \\
$5x^3=18$ & \noTRAINER{\fbox{\,\vphantom{$X$}}} \TRAINER{\fbox{\color{red} X} falsch}\\
$\sqrt{b}-x^2=b^3$ &
...
\TALS{\olatLinkArbeitsblatt{Quadratische
    Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/107315676197926}{3., 4., 6., 8., 9., 10., und 11.}}
...
\subsubsection{Al Chwarizmi}\index{Al Chwarizme}\index{Chwarizmi (Al
  Chwarizmi)}
...
Al-Chwarizmis Buch (al-Kit\={a}b al-muhta\d{s}ar f\={i} \d{h}is\={a}b al-$\check{\text{g}}$abr wa-\'{}l-muq\={a}bala)
...
\subsection{Grundform}\index{Grundform!Quadratische
  Gleichung}\index{Quadratische Gleichung!Grundform}
...
\GESO{\olatLinkArbeitsblatt{Quadratische
    Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/107315676197926}{(Weiter
    ab derjenigen Nummer, wo Sie aufgehört hatten.)}}

\TALS{\olatLinkArbeitsblatt{Quadratische Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/107315676111812}{(Weiter
    ab derjenigen Nummer, wo Sie aufgehört hatten.)}}
...
\TALS{\input{tals/gl2/Quadratische_Gleichungen_mit_Parametern}
\newpage}
