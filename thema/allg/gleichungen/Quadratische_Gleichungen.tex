...
genau ein \textit{snap} (bzw. \textit{ein post}) an alle anderen versendet hat.\\Wie viele Personen waren
beteiligt?}
...
\subsubsection{Erste Berechnungen}
$$x^2=49$$
...
\TNTeop{Mathematisches Verfahren =
...
Al-Chwarizmis Buch (al-Kit\={a}b al-muhta\d{s}ar f\={i} \d{h}is\={a}b al-gabr wa-\'{}l-muq\={a}bala)
...
\TRAINER{al-gabr = «Wieder herstellen», «vervollständigen», «ganz machen»}
...
\GESO{\olatLinkArbeitsblatt{Quadratische
    Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/107315676111812}{Alle geraden Aufgaben plus Aufgabe 9.}}

\olatLinkGESOKompendium{2.3.1.}{16}{42. bis 44.}

\TALS{\olatLinkArbeitsblatt{Quadratische
    Gleichungen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/107315676197926}{Alle geraden Aufgaben plus Aufgabe 9.}}
