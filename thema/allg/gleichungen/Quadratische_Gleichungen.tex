...
\GESOAadB{181}{3. a) d) e), 4. e) [Bei Aufgabe 4. e) die Probe machen!]}
...
\GESOAadB{181}{5. a) e), 6. d) und  7. a)  e)}
\newpage
...
$$x^2-2rx-9 = -r^2 + 3x$$
\TNT{4.8}{Grundform: $$x^2 + (-2r)\cdot{}x -3x+(r^2-9) = 0$$
...
\subsection*{Aufgaben}
\aufgabenfarbe{Blatt $a$-$b$-$c$-Finden (OLAT)}
\GESOAadB{182}{13. a) b)}
Wer fertig ist:\\
\aufgabenfarbe{Weiter im Blatt im OLAT (Gallin)}


\TALSAadB{95ff}{269. a), 275. a) b) d), 276. a) b) f)}%%
...
\TRAINER{Was fällt bei folgender Gleichung auf?}
$$72x^2 - 605 x + 848 = 0$$
...
\GESO{
  ...
  \begin{tabular}{|c|p{13cm}|}
    ...
    von quadratischen Gleichungen. Lösung obiger Gleichung: $\mathbb{L}_x=\left\{\frac{53}8,\frac{16}9\right\}$\\
    \hline
...
\TNT{2}{$x_{1,2} = 1, 0.4$}
$$x^2 +x  = -1$$
\TNT{2}{$x_{1,2} = \textrm{keine reelle Lsg. mit} \approx
  \textrm{verschwindet das }i$}%% END TNT
}%% END GESO
...
\GESOAadB{182}{ 8. a) d) e) i), 9. c) und 10. b) e)}
...
\begin{tabular}{c|c|p{5cm}}
  $x^2 + 3x +1 = 0$ & $b^2-4ac = \LoesungsRaumLang{9 -4 > 0}$ & \TNDF{zwei Lösungen} \\
  \hline
  $x^2 + 2x +1 = 0$ & $b^2-4ac = \LoesungsRaumLang{4 -4 = 0}$ & \TNDF{eine Lösung} \\
  \hline
  $x^2 + 1x +1 = 0$ & $b^2-4ac = \LoesungsRaumLang{1 -4 < 0}$ & \TNDF{keine Lösungen} \\
\end{tabular}
...
\GESO{
  ...
  \GESOAadB{182ff}{11. c) f), und 16. c)}
}%% END GESO
