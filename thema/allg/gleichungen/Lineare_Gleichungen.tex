...
\begin{beispiel}{Einstiegsbeispiel}{}
  ...
  $2x-7+\sqrt{5}\cdot{}x = 5x-5-\frac{x}{7}$ 

\TNT{15.2}{  \begin{tabular}{ll}
    $2x-7+\sqrt{5}x=5x-5-\frac{x}{7}$            & $| +7$\\
    $2x+\sqrt{5}x=5x+2-\frac{x}{7}$              & $| -5x$\\
    $-3x + \sqrt{5}x=2-\frac{x}{7}$              & $| $ TU (Hinweis)\\
    $-2x + \sqrt{5}x=2-\frac{1}{7}\cdot{}x$      & $| +\frac17 x$ \\
    $-3x+\sqrt{5}x + \frac17 x=2$                & $| x $ ausklammern \\
    $x\cdot{}(-3+ \sqrt{5} + \frac17 )=2$        & $| : (-3+\sqrt{5}+\frac17)$ \\
    $x=\frac{2}{-3+\sqrt{5}+\frac17} \approx -3.220$        &  \\
    \end{tabular}

Allenfalls Probe mit TR: \GESO{\tiprobutton{sto}\tiprobutton{xyzabcd}}\TALS{$x:=\frac{2}{-3+\sqrt{5}+frac17}$}, dann $2x-7+\sqrt{5}x$ und $5x-5-\frac{x}7$ berechnen: je $\approx -20.64$
  \vspace{75mm}
  }%% END TNT
\end{beispiel}
...
\textbf{Äquivalenzumformungen sind\TRAINER{\footnote{Mit $|$
...
\GESO{\input{allg/gleichungen/Lineare_Gleichungen_Mit_NumSolv}}
