...
\TNT{15.2}{  \begin{tabular}{ll}
    $7x - 3 + \sqrt{5}x              =5x - \sqrt{7} - \frac{x}7$  & $| + \frac{x}7$\\
    $7x - 3 + \sqrt{5}x +\frac{x}7   =5x - \sqrt{7}            $  & $| -5x        $\\
    $2x - 3 + \sqrt{5}x +\frac{x}7   = - \sqrt{7}              $  & $|  +3             $\\
    $2x     + \sqrt{5}x +\frac{x}7   = 3 - \sqrt{7}            $  & $|$ $x$ ausklammern\\
    $x (2+\sqrt{5} + \frac17)        = 3 - \sqrt{7}            $  & $|$ durch die Klammer teilen\\
    $x        = \frac{3 - \sqrt{7}}{2+\sqrt{5} + \frac17}    $  &\\
...
\TALS{$x:= \frac{3 - \sqrt{7}}{2+\sqrt{5} + \frac17}$}, dann $x$ links und rechts einsetzen: Term wird je $-2.2528$.
\vspace{75mm}
}%% END TNT
