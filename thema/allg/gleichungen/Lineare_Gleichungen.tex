...
\GESO{S. \cite{marthaler21} Seite 111 (Liste der Äquivalenzumformungen)}
...
$| $ potenzieren  & Beide Seiten potenzieren & ...hinzukommen.&$| \color{red} {\textrm{hoch }}^6$\\
...
Die Lösungsmenge $\lx$ zur allgemeinen Grundform $ax+b=0$ lautet somit $$\lx=\left\{ \frac{-b}{a} \right\}.$$
