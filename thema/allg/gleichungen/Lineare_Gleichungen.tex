...
TU      & Termumformung & Beispiel: Links des Gleichheitszeichens $a$ ausklammern\\
$+ T(x)$  & Term beidseitig addieren. & $|+4$, $|+\sqrt{x}$, $|+8\cdot{}x^2$\\
$- T(x)$  & Term beidseitig subtrahieren. & $|-6$, $|-x^3$, $|-5x$\\
\end{tabular}

\textbf{keine} Termumformungen sind

\begin{tabular}{lp{6cm}>{\raggedright}p{4cm}p{6cm}}
Umformung  & Beschreibung &Lösungen können... & Beispiel\\\hline
$| $ quadrieren  & Beide Seiten quadrieren & ...hinzukommen.&$\color{red}\textrm{quadireren}$\\
$| $ radizieren  & Auf beiden Seiten die Wurzel ziehen& ...verschwinden.&$\color{red}\textrm{Wurzel ziehen}$\\
$|\cdot{}T(x)$  & mit der Unbekannten multiplizieren & ...hinzukommen.&$\color{red}|\cdot{}(x+4)$, $\color{red}|\cdot{}3x^2$\\
$|:T(x)$  & durch Unbekannte dividieren & ... verschwinden.&$\color{red}|:(x-8)$, $\color{red}|:\sqrt{x}$\\
