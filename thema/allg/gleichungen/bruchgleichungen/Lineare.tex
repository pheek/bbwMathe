...
\begin{bemerkung}{\textbf{Keine} Bruchgleichung!}{}
  ...
  \TNT{2}{$$\frac17 + \frac17x = \frac1{\sqrt{2}}x+\frac3{\sqrt{2}}$$
    (ist linear)
    $$\left(x= \frac{-1}{47} \cdot{}\left(145 + 14\cdot{}\sqrt{2} \right)  \approx -3.506\right)$$
  }
\end{bemerkung}
\newpage
...
\TNTeop{
  ...
  2. Als einzigen Bruch schreiben:
  ...
  3. Mit Nenner multiplizieren, d.\,h.: Nur Zähler beachten
  ...
  \frac{{\color{red}5}+13}{2\cdot{}{\color{red}5}-10}$$

  $$\frac90 \stackrel{?}{=} \frac{18}0$$

  Nicht möglich!
}%% end TNT eop
%% implicit nepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Noch ein Beispiel (optional):
...
\TNT{2}{
  ...
  Zwei ist aber keine Lösung!

  Wir schreiben:
  
  $$\lx = \{\} \text{ und } \DefinitionsMenge = \mathbb{R}\backslash \{2\}$$
...
\TNT{2}{$$5x^2 - 5x - 60 $$   $$= 5(x^2-x-12) $$   $$= 5(x-4)(x+3)$$}
...
\TNTeop{Wir müssen nur den Nenner (unten) betrachten:
$$3x^2-5x\stackrel{?}{=} 0$$
...
\DeclareRobustCommand{\tempA}{1.), 2.) und Kap. 2: Tabelle Definitionsbereich}
\GESO{\olatLinkArbeitsblatt{Bruchgleichungen (Definitionsbreich)}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/108794294060339}{\tempA{}}}


\TALS{\olatLinkArbeitsblatt{Bruchgleichungen (Definitionsbereich)}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/105951754967029}{\tempA{}}}

\vspace{5mm}
\textbf{Bruchgleichungen, die auf lineare Gleichungen führen}


\GESO{\olatLinkArbeitsblatt{Bruchgleichungen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/108794294060339}{3.,
    4. a) d) und 5. a) b) }}

\olatLinkGESOKompendium{2.1.2.}{10}{7. bis 11.}

\TALS{\olatLinkArbeitsblatt{Bruchgleichungen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/105951754967029}{3.,
    4. und 5.}}
