...
Termvereinfachung (alles gleichnamig):

$$\frac{6x-24}{3-x} + \frac{(x-2)(3-x)}{3-x} - \frac{6}{x-3} = 0$$

3. Bruch mit $(-1)$ erweitern:
...
$$-x^2 +11x-24 = 0 \Longrightarrow x_1 = 8; x_2=3$$
...
\olatLinkGESOKompendium{2.3.1.}{16}{45.}
