...
\TNTeop{
  ...
  2. $x$ = Preis des Rocks \textbf{in} Mark.

  3. Terme:
  \begin{itemize}
  \item $x+180$: Jahreslohn
    \item $\frac{x+180}{12}$ : Monatslohn
    \item $5\cdot{}\frac{x+180}{12}$: Lohn für 5 Monate
      \item $54+x$ : Auch: Lohn für 5 Monate
  \end{itemize}

  4. Gleichung
  $$5\cdot{} \frac{x+180}{12} = x+54$$
