...
\begin{bemerkung}{Textaufgabe}{}
  ...
  \begin{tabular}{c  | p{101mm}}%%
    \textbf{Textaufgabe} &  «Eine Aufgabe, bei der eine Unbekannte als
    Variable eingeführt werden soll.» \\\hline%%
    \textbf{Aufgaben in Textform} & «Eine Aufgabe bei der alles
    Gegebene in einen Text verpackt ist.».
  \end{tabular}%%

  \vspace{5mm}
  
  Eine \textbf{Textaufgabe} könnte sein:

  \begin{center}
  {\textit{«Gesucht ist eine Zahl, deren Doppeltes
gleich 20 ist.}}»
  \end{center}
  
Hier wird die Zahl typischerweise als $x$ bezeichnet
und die Gleichung $2x=20$ aufgestellt und gelöst.

\vspace{5mm}

Eine \textbf{Aufgabe in Textform} könnte sein:

\begin{center}{\textit{«Gegeben ist die Zahl
$x=10$. Was erhalten Sie, wenn Sie die Zahl verdoppeln?»}}\end{center}
