...
$$\sqrt{2}(x+5) = 3x + \sqrt{7} - \frac{x}4$$
  ...
  \TNT{20}{ 1. Ausmultiplizieren
    ...
    \begin{tabular}{ll}
      ...
      $x\sqrt{2} + \frac14x -3x =   \sqrt{7} - 5\sqrt{2}$          & \\

      \text{3. $x$ ausklammern} & \\

      $x (\sqrt{2} + \frac14 -3) =   \sqrt{7} - 5\sqrt{2}$          &  \\

      \text{4. Durch die Klammer teilen} & \\

      $x = \frac{  \sqrt{7} - 5\sqrt{2}}{\sqrt{2} + \frac14 -3} =
      \frac{4}{89}( 55\cdot{}\sqrt{2} + 40 -(4\cdot{}\sqrt{2} +
      11)\cdot{} \sqrt{7} ) \approx   3.31289 $          &      \\
...
\subsection*{Aufgaben}
%%\AadBMTA{127ff}{2. a) f), 3. a) c) h), 4. f), 6. a) d) }

\GESO{\olatLinkArbeitsblatt{Lineare Gleichungen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/110662976644490}{Aufgabe 1}}
...
Notation & $\LoesungsRaumLen{18mm}{\lx=\{4\}}$             & 
           $\LoesungsRaumLen{18mm}{\lx=\{0\}}$             &
           $\LoesungsRaumLen{18mm}{\lx=\mathbb{R}}$        &
           $\LoesungsRaumLen{18mm}{\mathbb{L}=\mathbb{R}}$ &
           $\LoesungsRaumLen{18mm}{\mathbb{L}=\{\}}$       &
           $\LoesungsRaumLen{18mm}{\mathbb{L}=\{\}}$\\\hline
\end{bbwFillInTabular} 
\end{gesetz}

\begin{bemerkung}{Index ${}_x$}{}
  Ist klar, um welche Lösungsvariable\index{Lösungsvariable} es sich handelt, kann der
...
\subsection*{Aufgaben}
\GESO{\olatLinkArbeitsblatt{Lineare Gleichungen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/110662976644490}{Aufgabe 2}}
\TALS{\olatLinkArbeitsblatt{Lineare Gleichungen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/110662976730861
}{Aufgabe 2}}


%%\AadBMTA{127ff}{2. g) h), 6. e) f)}
...
\newpage
\TALS{\input{tals/gl1/Mit_CAS_Loesen}\newpage}
\TALS{\input{allg/gleichungen/lineare/GraphischeInterpretation}}
  
\GESO{\input{allg/gleichungen/lineare/Mit_NumSolv}}
