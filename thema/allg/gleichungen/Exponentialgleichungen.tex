...
\bbwCenterGraphic{8cm}{allg/gleichungen/img/SchwarzerRitterV2.jpg}
...
\TALS{
  ...
  $$\log(2\cdot{}8^{x-1}) = \log(7^{x+2})$$
  Log Gesetz (Produktregel):
  $$\log(2) + \log(8^{x-1}) = \log(7^{x+2})$$
  Log Gesetz (Potenzregel):
  $$\log(2) + (x-1)\cdot{}\log(8) = (x+2)\cdot{}\log(7)$$
  ausmultiplizieren
  $$\log(2) + \log(8)\cdot{}x-\log(8) = \log(7)\cdot{}x+2\cdot{}\log(7)$$
  und $x$ auf eine Seite bringen
  $$\log(8)\cdot{}x-\log(7)\cdot{}x = 2\cdot{}\log(7)+\log(8)-\log(2)$$
  ausklammern
  $$x\cdot{}(\log(8)-\log(7)) = 2\cdot{}\log(7)+\log(8)-\log(2)$$
  und durch die Klammer $(\log(8)-\log(7))$ teilen
  $$x = \frac{2\cdot{}\log(7)+\log(8)-\log(2)}{\log(8)-\log(7)} \approx 39.53$$
...
\GESO{\TNT{14}{
  ...
  ausmultiplizieren
  $$\log(8)\cdot{}x-\log(8)=\log(7)\cdot{}x+2\cdot{}\log(7)$$
  und $x$ auf eine Seite bringen
  $$\log(8)\cdot{}x-\log(7)\cdot{}x = 2\cdot{}\log(7)+\log(8)$$
  ausklammern
  $$x\cdot{}(\log(8)-\log(7)) = 2\cdot{}\log(7)+\log(8)$$
  und durch die Klammer $(\log(8)-\log(7))$ teilen
  $$x = \frac{2\cdot{}\log(7)+\log(8)}{\log(8)-\log(7)}\approx 44.718$$
}%% END TNT
}%% END GESO
