...
\item \TNDF{Histogramme benötigen quantitative Daten.\footnote{Rein nominale
  ...
  \vspace{8mm}
\item \TNDF{Die $y$-Achse zeigt die Anzahl Werte, die zwischen den
  Säulengrenzen liegen, und beginnt bei Null (0).}
  \vspace{8mm}
...
\item \TNDF{Die Klassengrenzen liegen auf einfachen Werten (5, 10, 15, ...)
  und nicht auf komplizierten Dezimalbrüchen (7.34, 8.92, 10.50, ...).}\vspace{10mm}
\end{itemize}
\newpage
...
\TRAINER{Bei GESO Klassen hat es im OLAT Kurs noch drei alte
