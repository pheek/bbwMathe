...
\item unimodal, multimodal, bimodal
\end{itemize}
...
\begin{rezept}{}{}
  ...
  \item Q1\footnote{Q1 = untere Quartilsgrenze},
    Median\index{Median} (= Zentralwert\index{Zentralwert}) und Q3\footnote{Q3 = obere Quartilsgrenze} besitmmen (Sortieren
  ...
  \item Beide Ausreißerschwellen bei $1.5\cdot$IQR je ab Boxende andeuten
...
\item Minimum und Maxium bestimmen: \LoesungsRaum{7, 32}

\item Skala zeichnen\TRAINER{ gleich unten}
...
\item Beide Ausreißerschwellen (1.5 $\cdot{}$ IQR) je ab Boxende
  andeuten:

  obere Ausreißerschwelle = Q3 + 1.5 $\cdot{}$ 8 = \LoesungsRaum{29}

  untere Ausreißerschwelle = Q1 - 1.5 $\cdot{}$ 8 = \LoesungsRaum{-3}
