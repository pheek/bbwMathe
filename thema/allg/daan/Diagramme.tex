...
\item visualisieren/Diagramme
  ...
  \item Histogramme und Boxplot (Kastengrafik)
  \end{itemize}
\end{itemize}
...
\subsection{Säulen- und
  Balkendiagramme}\index{Saulendiagramm@Säulendiagramm}\index{Balkendiagramm|textbf}
\TadBMTA{380}{24.1}
...
\begin{tabular}{|c|c|c|p{8cm}|}
  ...
  bedeutet $f_i=\LoesungsRaum{0.7045}$, dass die Merkmalsausprägung mit 70.45\%
  Häufigkeit vorkommt.\\
  \hline
...
\end{tabular}
  ...
  \olatLinkGESOKompendium{4.2}{36}{1 (Anzahl Kinder)}
...
\olatLinkGESOKompendium{4.4}{39ff}{9. a) (Körpergrößen) 11. (Praliné)}
...
\subsection{Median}\index{Median|textbf}
...
\begin{definition}{Median}{}
  ...
  \textbf{Median}\index{Median} genannt und wird mit $\mediantilde{x}$ bezeichnet.

  Bei einer geraden Anzahl von Messwerten wird der Durchschnitt der beiden mittleren Werte genommen.
\end{definition}


\begin{beispiel}{Median bei gerader Anzahl Werte}{}
...
\AadBMTA{409}{39., 40. und 41.}
\newpage
\subsubsection{Quartile}\index{Quartil}
Der Median wird auch 50 \%-Quantil\index{Quantil} oder $Q_{50\%} = Q_{0.5}$ genannt. Ein
Datensatz kann aber nicht nur in der Mitte (50 \%), sondern bei jeder
prozentualen Anzahl der Werte aufgeteilt werden. Es bezeichnen:

\begin{definition}{Quartil}{}

  \begin{tabular}{ccccccc}
  
  \textbf{Q1} &=& unteres Quartil & 25 \%-Quantil & $Q_{25 \%}$ &=& $Q_{0.25}$ \\

  $\mediantilde{x}$ &=&  Median & 50 \%-Quantil &  $Q_{50 \%}$ &=& $Q_{0.5}$ \\

  \textbf{Q3} &=& oberes Quartil & 75 \%-Quantil &  $Q_{75 \%}$ &=& $Q_{0.75}$
  \end{tabular}
  \end{definition}

Teilen Sie die folgenden Datensätze in die Quartile und bestimmen Sie
Q1, Median und Q3.

2, 3, 3, 4, 5, 6, 8, 8, 9, 10

Q1= \LoesungsRaumLen{30mm}{3}

Median = \LoesungsRaumLen{30mm}{5.5}

Q3 = \LoesungsRaumLen{30mm}{8}

\begin{rezept}{Quartile}{}
  
  Q1 ist der Median der linken Hälfte der Daten und

  Q3 ist der Median der rechten
  Hälfte der Daten.

  Bei einer ungeraden Anzahl an Werten wird der Median aus der
  Datenreihe gestrichen um Q1 und Q3 zu bestimmen.
\end{rezept}
...
Q1= \LoesungsRaumLen{30mm}{3.5}

Median = \LoesungsRaumLen{30mm}{5}

Q3 = \LoesungsRaumLen{30mm}{8.5}
