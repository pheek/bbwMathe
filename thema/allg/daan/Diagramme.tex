...
\begin{itemize}
\item \TRAINER{Histogramme benötigen quantitative Daten.\footnote{Rein nominale
  oder rein ordinale Daten reichen nicht aus, da die Intervalle [Abstände] hier relevant sind.}}\noTRAINER{\dotfill{}}
\item \TRAINER{Die $y$-Achse zeigt die Anzahl Werte, die zwischen den Säulengrenzen liegen, und beginnt bei Null (0).}\noTRAINER{\dotfill{}}
\item \TRAINER{Es hat für einen guten Überblick fünf bis zwanzig Säulen.}\noTRAINER{\dotfill{}}
\item \TRAINER{Alle Säulen berühren sich und sind gleich breit.}\noTRAINER{\dotfill{}}
\item \TRAINER{Fällt ein Messwert genau auf die Säulengrenze ist dieser stets
...
\item \TRAINER{Die Klassengrenzen liegen auf einfachen Werten (5, 10, 15, ...)
...
\TNT{4}{min = 7, max=32, median = 13, q1 = 9, q3 = 17\\ IQR = Q3-Q1 =
  8}

2. IQR rechnen = \LoesungsRaumLang{17-9 = 8}

3. Skala und Box zeichnen
\TNT{2}{Hier kommt die Box hin auf einer Skala von 7 bis  32.}

4. Ausreißerschwellen rechnen und andeuten

\TNT{4}{Untere: q1 - 1.5 IQR = 9 - 1.5 IQR = 9-12 = -3\\
        Obere: q3+ + 1.5 IQR = 17 + 1.5 IQR = 17 + 12 = 29}
...
\GESOAadB{408}{37.}
\GESO{\aufgabenfarbe{Kompendium S. 38 (Kap. 4.4) Aufg 8., 9. und 10.}}
