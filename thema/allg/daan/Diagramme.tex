...
\subsection{Median}\index{Median}

Ein weiteres Lagemaß ist der \textbf{Median}:

Gegeben sind die folgenden Messwerte:

\begin{center}7.1; 3.2; 8.1; 4.3; 9.6; 9.5; 2.4; 7.7\end{center}

1. Schritt: Sortieren

\begin{center}2.4; 3.2; 4.3; 7.1; 7.7; 8.1; 9.5; 9.6\end{center}

2. Schritt: Mittleren Wert finden:

\begin{center}2.4; 3.2; 4.3; \textbf{7.1}; 7.7; 8.1; 9.5; 9.6\end{center}

\begin{definition}{Median}{}
  Der mittlere Wert einer sortierten Datenreihe wird
  \textbf{Median}\index{Median} genannt.
\end{definition}
