...
so sprechen wir von \textbf{multimodalen} Daten. Gibt es
genau zwei «Spitzen», so sprechen wir von \textbf{bimodalen}
Daten. «Normale» Verteilungen mit genau einer «Spitze» nennen wir \textbf{unimodal}\index{unimodal|textbf}.
...
«Von einer bimodalen \textbf{Verteilung} sprechen wir bei
  Histogrammen. Dort ist es aber i.\,d.\,R nicht möglich, den Modus zu
  berechnen, denn wir verwenden Klassifizierungen, um die Säulen zu
  zeichnen.»

  Es ist möglich, dass einer unimodalen Verteilung
  (Histogramm) bimodale Daten zugrunde liegen und umgekehrt. Beispiel
  die Daten 1, 3, 3, 3, 7, 7, 8, 8, 9, 9, 13, 13, 13, 14 im Histogramm 0-5-10-15.
}%% END TNT
