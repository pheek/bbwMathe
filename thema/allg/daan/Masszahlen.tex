...
\vphantom{Ög}\\
    \begin{itemize}
    \item  \TRAINER{Median $\mediantilde{x}$}\noTRAINER{\dotfill}
    \item \TRAINER{Modus $x_{\textrm{mod}}$}\noTRAINER{\dotfill}
    \item \TRAINER{Quartile Q1 bzw. Q3}\noTRAINER{\dotfill}
    \item \TRAINER{(Ausreißerschwellen)}\noTRAINER{\dotfill}\\
  \end{itemize} \end{minipage}
  & \begin{minipage} [t] {0.4\textwidth}
\vphantom{Ög}\\
      \begin{itemize}
    \item \TRAINER{Interquartilsabstand (IQR)}\noTRAINER{\dotfill{}}
  \end{itemize} \end{minipage} \\
  \hline
  nicht robust & \begin{minipage} [t] {0.4\textwidth}
\vphantom{Ög}\\
    \begin{itemize}
    \item \TRAINER{Mittelwert (Durchschnitt) $\overline{x}$}\noTRAINER{\dotfill{}}
    \item \TRAINER{Minimum (min) und}\noTRAINER{\dotfill}
    \item \TRAINER{Maximum (max)}\noTRAINER{\dotfill}\\
  \end{itemize} \end{minipage} & \begin{minipage} [t] {0.4\textwidth}
\vphantom{Ög}\\
    \begin{itemize}
    \item \TRAINER{Standardabweichung $\sigma$}\noTRAINER{\dotfill}
    \item \TRAINER{Spannweite (max - min)}\noTRAINER{\dotfill}\\
  \end{itemize} \end{minipage} \\
  \hline
  \end{tabular} 
