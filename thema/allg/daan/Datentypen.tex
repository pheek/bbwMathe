...
\bbwCenterGraphic{17cm}{allg/daan/img/Datentypen.png}\index{ordinale Daten}\index{Nominale
  Daten}\index{Verhaltnisskala@Verhältnisskala}\index{Kardinalskala}\index{Intervallskala}
...
\bbwCenterGraphic{14cm}{allg/daan/img/DatenanalyseSkalentypen.pdf}\index{ordinale Daten}\index{Kardinalskala}\index{Intervallskala}
...
(Die beiden untersten Skalen, Intervall- und Verhältnisskala, werden oft als Kardinalskala\index{Kardinalskala} zusammengefasst.)
\newpage
...
\TRAINER{%%
  \begin{tabular}{c|c|c|c}
    nominal & ordinal & Intervall & Verhältnis\\\hline
    Geschlecht     & BMS - Motivation & Schlafenszeit         & Alter\\
    Handymarke     & Wetterfühligkeit & max. Temperatur       & Körpergröße \\
    BMS-Gründe     & Mathematiknote   &                       & Anzahl Mitarbeiter\\
    Lieblingsfarbe &                  &                       & Umf. Handgelenk\\
    Händigkeit     &                  &                       & Puls\\
                   &                  &                       & Hausaufgabenzeit\\
                   &                  &                       & Preis Coiffeur\\
                   &                  &                       & Handspanne\\
