...
\noTRAINER{\bbwCenterGraphic{85mm}{allg/funktionen/img/exp/HalbwertszeitLeer.png}}
  \TRAINER{\bbwCenterGraphic{70mm}{allg/funktionen/img/exp/Halbwertszeit.png}}
...
\TNTeop{
  ...
  $$\frac{b}{2} = f(T) \Longrightarrow  \frac{b}{2}  = b \cdot{} a^{\frac{T}{\tau}}$$
...
\DeclareRobustCommand{\tempA}{Kap. 1.6 (Halbwertszeit/Verdopplungszeit): Aufg. 25. - 28.}
