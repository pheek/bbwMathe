...
$\mathcal{D} = [-5;5]\TRAINER{\backslash \{0\}}\noTRAINER{......}$
...
$$x^{-5} = \frac{1}{x^5} \Longrightarrow \mathcal{D} = \mathbb{R} \backslash \{0\}$$
...
\begin{tabular}{c|c|c}
Funktionsterm & Definitionsbereich $\mathcal{D}$& Wertebereich $\mathcal{W}$\\ \hline
