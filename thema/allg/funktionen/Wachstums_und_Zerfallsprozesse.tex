...
\bbwGraph{-1}{13}{-1}{5}{
\TRAINER{  \bbwFuncC{pow(1.15,\x)}{0:12}{blue}
}%% end TRAINER
}%% end graph
...
\TRAINER{Das Wachstum beim Taxiunternehmen ist nicht von den aktuell
  gefahrenen Kilometern abhängig; nur der Gesamptpreis. Das Wachstum
  ist beim Taxiunternehmen konstant.}

\TRAINER{Optional: Zeige mit Geogebar $x^2$ vs. $1.2^x$. Fazit:
...
Bemerkung: 
\TNT{2.4}{
$\frac{f(\tau)}{f(0)}=\frac{b\cdot{}a^{\frac{\tau}{\tau}}}{b\cdot{}a^{\frac0{\tau}}}
...
\TNT{12}{
  ...
  $a=\frac{4.9}{3.5} = 1.404...$ pro 29 Jahre (Taschenrechner!). 
...
\TNT{12}{
  Gesucht $T$ = Verdopplungszeitpunkt.

  $$f(T) = 2\cdot{}f(0)$$

  Funktionsgleichung einsetzen:

  $$b\cdot{}a^\frac{T}{\tau} = 2\cdot{} b\cdot{} a^\frac0\tau$$

  Weil $a^\frac0\tau = 1$ folgt:

  $$b\cdot{}a^\frac{T}{\tau} = 2\cdot{} b$$
...
$$T = \tau\cdot{}\log_a(2) = 29\cdot{}\log_a(2) \approx 59.17$$
...
\TNT{8}{
  ...
  Somit
  $$f(T_{\frac12})  = \frac12\cdot{}f(0)$$
$$b\cdot{}0.8^{\frac{T_{\frac12}}{7}}  = \frac12 b\cdot{} 0.8^{\frac{0}{7}}$$

   $$0.8^\frac{T_\frac12}{7} = \frac12$$

   $$\frac{T_\frac12}{7} = \log_{(0.8)}\left(\frac12\right)$$
  
  $$T_{\frac12} = 7\cdot{} \log_{0.8}\left(\frac12\right)
  \approx 21.74
  [\textrm{Tage}]$$
\vspace{2cm}}
\newpage
