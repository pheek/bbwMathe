...
\GESO{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/106029175831971}{Kap. 1.4:
    ...
    12: Tierpopulation; 17. Bauchspeicheldrüse;  weitere Aufgaben aus
    Kap. 1.4}}
...
\TALS{  \AadBMTA{353}{6. (C-14 Methode)}}

Als Vorbereitung zur allgemeinen Wachstumsfunktion:

\DeclareRobustCommand{\tempA}{Aufgabe 20.: Algen}
...
\GESO{(optional) }Alternativ «die harte Tour» (ohne das $\tau$ mit anderer Basis):
  ...
  $$f(t) = b\cdot{}A^1 = b\cdot{} \left(\sqrt[5]{2}\right)^t  = b\cdot{}
  \left(2^{\frac15}\right)^t=b\cdot{} 2^{\frac{t}5} \approx b\cdot{} 1.1487^t$$

  In Worten: «in 5 Tagen eine Verdopplung» = «Pro Tag eine Zunahme von
  14.87 \%»
}%% end TNTeop
...
\GESO{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/106029175831971}{Kap. 1.5: Aufg. 21. a) b)}}
\TALS{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/106029175777725}{Kap. 1.5: Aufg. 21. a) b) }}
...
\DeclareRobustCommand{\tempA}{Kap. 1.5: Aufg. 21. c), 22. - 24.}
\GESO{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/106029175831971}{\tempA}}
\TALS{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/106029175777725}{\tempA}}
