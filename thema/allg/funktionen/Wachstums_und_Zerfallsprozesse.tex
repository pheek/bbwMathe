...
\GESO{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/106029175831971}{Kap. 1.3: Zerfall: Aufg. 7., 8. und 9.}}
\TALS{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/106029175777725}{Kap. 1.3: Zerfall Aufg. 7. 8. und 9.}}
...
\TNT{6}{$5 \text{m}^2 = 50\,000 \text{cm}^2$
     ...
     $$n = \log_{1.23}(\frac{50\,000}{35}) \approx 35.1 \text{Tage}$$
...
\TALS{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/106029175777725}{Kap. 1.4:
    Frei wählbarer Startwert: Aufg. 10. Gummiball; 12. Federpendel;
    13. Licht im Wasser; 15. Luftdruck;}}
...
\noTRAINER{\bbwCenterGraphic{10cm}{allg/funktionen/img/exp/WachstumTuerlerseeLeer.png}}
\TRAINER{\bbwCenterGraphic{10cm}{allg/funktionen/img/exp/tuerlerAlgen.png}}
\newpage

\textbf{Funktionsgleichung}

Wir betrachten die selbe Algenpopulation mit einer Startfläche von \textbf{zwanzig}
$\text{m}^2$ und einer Ver\textbf{dopplung} dieser Fläche alle \textbf{fünf} Tage.
...
\begin{bbwFillInTabular}{c|c|c||c|c|c|c|c|c|c|c}\hline
  Tage      & $t$ & \noTRAINER{\hspace{2cm}} & 0            & 1-4 & 5            & 6-9 & 10           & 11-14 & 15           &\\\hline
  Fläche     & $A$ & \TRAINER{$20\cdot v$}    &
  \TRAINER{20}\noTRAINER{\hspace{15mm}} &      &
  \TRAINER{40}\noTRAINER{\hspace{15mm}} &      &
  \TRAINER{80}\noTRAINER{\hspace{15mm}} &                &
  \TRAINER{160}\noTRAINER{\hspace{15mm}} &\\\hline
  Intervalle & $z$ & \TRAINER{$z=\frac{t}{5}$}    & \TRAINER{0}  &      & \TRAINER{1.}  &      & \TRAINER{2.}  &                & \TRAINER{3.} &\\\hline
  Potenz     &\TRAINER{$2^z$} & \TRAINER{$2^\frac{t}{5}$}     & \TRAINER{$2^0$}  &      & \TRAINER{$2^1$}  &      & \TRAINER{$2^2$}  &                & \TRAINER{$2^3$} &\\\hline
  Faktor    & $v$ & \TRAINER{$v=2^z$}    & \TRAINER{1}  &      & \TRAINER{2}  &      & \TRAINER{4}  &                & \TRAINER{8} &\\\hline
...
\subsubsection{Allgemeiner exponentieller Prozess}\index{Exponentieller Prozess! allgemeine Form}
...
\TNTeop{
  Die Algenzahl verdoppelt sich alle fünf Tage (Startwert $b$):

  $$f(t) = b\cdot{}A^t$$

  $$f(0) = b\cdot{}A^0 = b \cdot{} 1$$

  und
  $$f(5) = b\cdot{}A^5$$

  Nach fünf Tagen verdoppeln: Ansatz:
  $$f(5) = 2\cdot{}f(0)$$
  $$b\cdot{}A^5 = 2\cdot{}b\cdot{} A^0 = 2\cdot{} b \cdot{} 1$$
  $$b\cdot{}A^5 = 2\cdot{} b$$
  $$A^5 = 2 | \sqrt[5]{\,\,}$$
  $$A = \sqrt[5]{2} = 2^{\frac15}$$
  ...
  $$b \cdot{} A^t =
  b \cdot{} \left( \sqrt[5]{2} \right)^t  =
  b \cdot{} \left( 2^{\frac15} \right)^t =
  b \cdot{} 2^{\frac{t}5}$$
}%% end TNTeop
...
\TNTeop{
  ...
  $a=\frac{m}{b}=\frac{4.93}{3.51} = 1.404...$ pro 29 Jahre (Taschenrechner! STO). 
...
\TNT{6}{
  $f(t) = a^t$. $80\%$ und $7$ Tage einsetzen:
  ...
  $$T_{1/2} =\log_a\left(\frac12\right)= \log_{\sqrt[7]{0.8}}\left(\frac12\right) \approx 21.74 \text{Tage}$$
