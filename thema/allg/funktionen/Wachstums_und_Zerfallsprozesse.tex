...
\TNT{12}{
  1. Skizze:Ersichtlich: $\tau=1$, 1990 = $t_0=0$, 2019 = $t_1=29$, 3.5 und 4.9 (Rest irrelevant)

  $\tau$ = 1 Jahr, somit ist $f(t) = b\cdot{} a^t$

  Somit ist $a$ pro Jahr zu verstehen.
  
  Ansatz: Zeitpunkt $t_0 = 0$. Folglich $b=3.5$ [Mio].

  $t_1=29$ und hier sind 4.9 [Mio.] Einwohner:

  $4.9 = f(29) = b\cdot{}a^{29} = 3.5 \cdot{} a^{29}$

  Auflösen nach $a$: $a= \sqrt[29]{\frac{4.9}{3.5}}$.

  $a$ und $b$ abspeichern im TR!!!!
  ...
  $f(35) = b\cdot{} a^{35} \approx 5.25$ [Mio.]
