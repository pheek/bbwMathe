...
\TNTeop{
  ...
  $$b = \frac4{a^2} = \frac4{(\sqrt[3]{2})^2} \approx 2.52$$
  Ergo: $$f(x) = b\cdot{}a^x = \frac4{(\sqrt[3]{2})^2}  \cdot{}
  \left(\sqrt[3]2\right)^x \approx 2.5198 \cdot{} 1.2599^x$$
}

\subsection*{Aufgaben}
%%\AadBMTA{334}{10. a) b)\TALS{ e)}\GESO{ f)}}
\GESO{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/106029175831971}{Kap. 2.1:
    E-Funktion / Punkte-Aufgaben}}
\TALS{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/106029175777725}{Kap. 2.1:
    E-Funktion / Punkte-Aufgaben}}
...
$$e^{m\cdot{} 0}\cdot{} 2 =e^{m\cdot{} 5}$$
  ...
  $$\ln(2) = m \cdot{} 5$$
  $$m = \frac{\ln(2)}{5} \approx 1.386$$

  Somit lautet die Funktion:
  $$f(t) \approx  b\cdot{} e^{1.386\cdot{} t}$$
  
  Bedeutung: Gerade $g(t): y=1.386\cdot{}t+b$ zeichnen: Dies ist die
...
\AadBMTA{336ff}{11. a) b), 15. a) b) [Zeichnen mit \texttt{geogebra.org}], 17. a) b) e), 22. a) b), 23. d), 25. a) b)}
...
\TNTeop{Tipp: Setzen Sie $t=0$, um den Startwert $b$ zu erhalten
  ($b=3\,000$) und danach $t=1$ ein: $$a = \e^{1.504} \approx 5.000$$
\vspace{3cm}}


\subsubsection*{Aufgaben}
\GESO{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/106029175831971}{Kap. 2.2:
    E-Funktion / Basiswechsel}}
\TALS{\olatLinkArbeitsblatt{Exponentialfunktionen}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/106029175777725}{Kap. 2.2:
    E-Funktion / Basiswechsel}}
\newpage
