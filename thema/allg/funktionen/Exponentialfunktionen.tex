...
\TNT{2.4}{$$f(t) = b\cdot{} 2^\frac{t}5 \stackrel{!}{=} b\cdot{} 4^{\frac{1}{10}}$$}
...
\subsubsection*{... natürliche Basen}
Zu Punkt 4.: Pro Tag.
\TNT{4}{$b\cdot{}a^t =b\cdot{} 2^{\frac{t}{5}} \Longrightarrow   a^t =
  2^{\frac{t}{5}} \Longrightarrow   a=2^{\frac15} = \sqrt[5]{2}\approx
  1.148698$}

Zu Punkt 5.: $b\cdot{}a^\frac{t}\tau = b\cdot{}\e^{m\cdot{}t}$ (Basis $\e$):
\TNT{4.8}{
