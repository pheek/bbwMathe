...
\TadBMTA{217}{13.3}
%%\TALSTadBFWA{163}{3}
Betrachten Sie die Funkktionen

$$f(x) = a\cdot{}\left(\frac{x\TALS{-d}}b\right)^5+c$$
und
$$g(x) = a\cdot{}\left(\frac{x\TALS{-d}}b\right)^4+c$$
...
\subsubsection{Zusammenfassung der Transltaionen}
