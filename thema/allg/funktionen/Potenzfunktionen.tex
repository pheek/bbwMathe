...
\begin{definition}{Potenzfunktion}{definition_potenzfunktion}
...
Die Funktion $P(T) = \sigma\cdot\varepsilon\cdot
  A\cdot{}T^4$ beschreibt, welche Leistung $P$ ein Körper der
  Oberfläche $A$ bei Temperatur $T$ (in Kelvin) abstrahlt.

  $\sigma$ = Bolzmann Konstante = $5.6\cdot{}10^{-8}$
  
  $\varepsilon$ = Emissionswert (eg. https://ennologic.com/wp-content/uploads/2018/07/Ultimate-Emissivity-Table.pdf)
...
\TNTeop{$T$ = 20 Grad Zimmertemperatur in Kelvin: 293.15;
  ...
  \cdot{} \cdot{} 293.15^4 \approx 155 \text{kW} $$
  Natürlich straht eine 20 grädige Umgebungstemperatur gleich viel
