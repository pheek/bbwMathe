...
Ordnung\index{Parabel}\index{Ordnung!Parabel}\footnote{Der Graph einer
...
<<<<<<< HEAD
%%  $x$ &  \TNT{0.8}{Am Ursprung $O(0|0)$, an sich selbst, und viele mehr, ...}\\\hline
  $x^2$ &  \TNT{0.8}{An der $y$-Achse}\\\hline
  $x^3$ &  \TNT{0.8}{Am Ursprung $O(0|0)$}\\\hline
  $x^4$ &  \TNT{0.8}{wie $x^2$}\\\hline
  $x^5$ &  \TNT{0.8}{wie $x^3$}\\\hline
=======
...
>>>>>>> 6d75fc45ae138877c86485dd67d954ba4e820606
\end{tabular}
...
\TALS{\aufgabenfarbe{Strukturaufgaben S. 15ff:  Aufg. 48., 51. und 52.}%% END Aufgabenfarbe
=======
\TALS{\aufgabenfarbe{Strukturaufgaben Teil 2: Taschenrechner: S. 15ff:  Aufg. 48. und 51.}%% END Aufgabenfarbe
>>>>>>> 6d75fc45ae138877c86485dd67d954ba4e820606
}%% END TALS
