...
\paragraph{Aufgabe:}  Bestimmen Sie $k$ so, dass der Graph von $y = \frac3{200} \cdot{} x^k$
durch den Punkt $P\left( 10 | 150 \right)$ verläuft.

\TNT{6.4}{  Punkt $P$ einsetzen in die Funktionsgleichung:

  $$150   = \frac3{200} \cdot{} 10^k$$
  Beide Seiten durch $\frac3{200}$ teilen:
  $$10\,000= 10^k$$
...
\aufgabenfarbe{Arbeitsblatt im OLAT «Positive Potenzfunktionen zuordnen»}
\newpage
