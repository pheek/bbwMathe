...
\TRAINER{%% Steigungsdreieck: 
 \bbwLine{-7,2.8}{10,6.2}{green}%%
  ...
  \bbwLetter{0.5,3.5}{y^*}{blue}
  \bbwLetter{-2.5,3.3}{6}{blue}
}%% end TRAINER
}%% end bbwGraph
...
4. $b$ «ablesen» oder Punkt einsetzen\\

Einsetzen: $y=0.2x+b$ durch (-6|3) liefert $3=0.2\cdot{}(-6)+b$ ergo
$b = 3+1.2=4.2$

Dreisatz falls Zeit: $y^*: 6 = 3:15 \Longrightarrow y^* = 6\cdot{} 3:15 = 1.2$\\
    ergo\\
    $b = 3 + y^* = 3+1.2 = 4.2.$
...
\textbf{Rezept II: Rein rechnerisch; algbraisch}\\
...
$$a = \frac{\text{V}}{\text{H}}=\TALS{\frac{\Delta y}{\Delta x}}=\LoesungsRaumLang{\frac{y_Q-y_P}{x_Q-x_P}} = \LoesungsRaumLang{\frac{3 - 6}{(-6) - 9} = \frac{-3}{-15} = \frac{1}{5}}$$
...
\DeclareRobustCommand{\tempA}{8.1 bis 8.8}
