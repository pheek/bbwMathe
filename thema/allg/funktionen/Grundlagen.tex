...
\GESO{
  \begin{beispiel}{Jahreszins}{}
    ...
    $\text{ mit } K \LoesungsRaum{\mapsto{} K\cdot{}3 \cdot{} \frac1{100}}$
    \end{beispiel}
}


\GESO{%%
\olatLinkArbeitsblatt{Funktionsbegriff}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/108030908300504}{Aufgabe 1.1}
}%% end GESO


\TALS{%%
\olatLinkArbeitsblatt{Funktionsbegriff}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/108030908410625}{Aufgabe 1.1}
}%% end GESO
...
\GESO{%%
\olatLinkArbeitsblatt{Funktionsbegriff}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/108030908300504}{Alle weiteren Aufgaben (1.2 - 1.7)}
}%% end GESO


\TALS{%%
\olatLinkArbeitsblatt{Funktionsbegriff}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/108030908410625}{Alle weiteren Aufgaben (1.2 - 1.7)}
}%% end GESO
