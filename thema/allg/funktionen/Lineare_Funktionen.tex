...
\TALS{
  \paragraph{Punkte mit dem Taschenrechner}: Mit der ``Lists \&
  Spreadsheet hinzufügen''-Funktion auf Ihrem Taschenrechner lassen
  sich Wertetabellen ganz einfach erstellen. Sind Sie bei einer Seite
  ``Lists \& Spreadsheet'' (Tabellenkalkulation) angelangt, so drücken
  Sie die «menu»-Taste und wählen Sie «5: Wertetabelle».
...
\AadBMTA{250ff}{5. a) (1) und b) (1), 7. a), 8. a) [Ursprungsgerade =
...
\TALSAadBMTA{249ff}{4.}
\AadBMTA{252ff}{30. Tropfsteinhöle visualisieren}
