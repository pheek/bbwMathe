...
\noTRAINER{
  ...
  \mmPapier{16}}%%
\TRAINER{\bbwCenterGraphic{14cm}{allg/funktionen/img/Taxiunternehmen.png}
...
\TNT{12}{
  \bbwCenterGraphic{8cm}{allg/funktionen/img/Steigungsdreieck.png}
...
\newpage
\subsection*{Aufgaben}
\GESO{\aufgabenfarbe{OLAT → Kurs (Mathematik) → Funktionen 1 (lineare) → Arbeitsblatt (SAN = Steigung,
    Achsenabschnitt, Nullstellen)}}
\GESOAadB{250ff}{5. a) (1) und b) (1), 7. a), 8. a) [Ursprungsgerade =
  Gerade durch den Nullpunkt], 10., 23. a) c) e)}
