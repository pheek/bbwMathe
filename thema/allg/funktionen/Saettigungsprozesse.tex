...
\TNT{8.8}{\bbwCenterGraphic{18cm}{allg/funktionen/img/zusammenfassung_exp/wachstum_zerfall.png}}%% END TNT

\vspace{8mm}
\begin{center}\textbf{Sättigung}\end{center}

\TNTeop{\bbwCenterGraphic{18cm}{allg/funktionen/img/zusammenfassung_exp/saettigung.png}}%% END TNT
