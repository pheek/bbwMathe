...
\begin{itemize}
  \item $c+b = f(0) = y$-Achsenabschnitt = Startwert
	...
	\item $m$:  Sättigungsdefizit\index{Sättigungsdefizit}\index{Defizit!Sättigung}. Wie viel fehlt, bis zur
...
\begin{itemize}
	...
	\item $m$ ist das Sättigungsdefizit\index{Sättigungsdefizit}. Wie viel fehlt, bis zur
