...
\TNT{10}{Vorzeigen Aufgabe «Farben mischen» aus dem Kompendium Seite
  14 Aufgabe 35}
\GESO{
...
\subsubsection{Ziffern-Aufgaben /
  Rest-Aufgaben}\index{Rest!Textaufgaben mit Divisionsrest}\index{Divisionsrest}
...
\paragraph{Rest-Aufgaben}\index{Rest!teilen mit}\index{Divisionsrest}\index{teilen mit Rest}:
