...
\begin{center}\includegraphics[width=65mm]{allg/gls/img/aepfel_bananen_41.jpg}\end{center}
\begin{center}{\tiny{«Stillleben» (2022), Heiner Fierz 41, \href{www.fierz.art}{fierz.art}}}\end{center}
...
\begin{center}\includegraphics[width=6cm]{allg/gls/img/ApfelBanane.jpg}\end{center}
...
\DeclareRobustCommand{\tempA}{Kap. 1: a) b) c) g) h)}
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{\tempA}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{\tempA}}
\newpage
  
\subsubsection{Ein nicht lineares Beispiel\GESO{ (optional)}}
...
Lösungsweg:
  \TNT{10.8}{
    ...
    Gleichung» $(III)$ einsetzen: $b=\frac{72}{a} = \frac{72}2 = 36$.
...
\subsection*{Aufgaben}
\DeclareRobustCommand{\tempA}{Kap. 2. a) und b)}
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{\tempA}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{\tempA}}
\newpage

%%%%%%%%%%%
\input{allg/gls/Additionsverfahren}
  
\input{allg/gls/GraphischeMethode}

\input{allg/gls/Lineare_Abhaengigkeit}

%%\input{allg/gls/Spezialfaelle}

\TALS{\input{allg/gls/TaschenRechnerSysSolve}}
...
\TALS{\input{tals/gls/Substitution}}

\input{allg/gls/VermischteAufgaben}

\TALS{\input{tals/gls/GLS_mit_Parametern}}

\TALS{\input{tals/gls/Fallunterscheidung}}
