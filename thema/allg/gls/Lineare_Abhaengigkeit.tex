...
\textbf{TYP B:} Beliebig viele Lösungen (lineare Abhängigkeit)\index{abhängig!linear}\index{lineare Abhängigkeit}
...
Hier gibt es unendlich viele Lösungen. Die entsprechenden Geraden sind
identisch bzw. zusammefallend.
...
zusammenfallend\\
 & & \\
\vspace{0.5mm}
$\gleichungZZ{y}{x+1}{y}{8}$ & $\gleichungZZ{y}{x+5}{y}{x+7}$ & $\gleichungZZ{y}{x+3}{2y}{2x+6}$   \\
& & \\\hline
& & \\
$\times$                   & //            &   \textbf{/}      \\
 & & \\\hline
$x=7; y=8$                 & $5=7$ \, ???  &  $3=3$            \\
 & & \\
$\mathbb{L}_{(x;y)}=\LoesungsRaumLen{11mm}{\{(7; 8)\}}$       & $\lx=\mathbb{L}_{(x;y)}=\LoesungsRaumLen{11mm}{\{\}}$    & $\lx=\LoesungsRaumLen{11mm}{\mathbb{R}}$ \\ 
 & & $\mathbb{L}_y=\LoesungsRaumLen{11mm}{\mathbb{R}}$\\
 & & $\mathbb{L}_{(x;y)}=\left\{ (x;y) \in \mathbb{R}\times\mathbb{R}
\text{ mit } y=x+3 \right\}$\\


&&\LoesungsRaumLen{70mm}{}\\
&&\LoesungsRaumLen{70mm}{}\\
&&\LoesungsRaumLen{70mm}{Es gibt unendlich}\\
&&\LoesungsRaumLen{70mm}{viele Lösungen}\\
\end{tabular} 
\end{center}
...
\subsection*{Aufgaben}
\DeclareRobustCommand{\tempA}{Gleichungssysteme - lineare Abhängigkeit}
\DeclareRobustCommand{\tempB}{Kap. 6: a) b) c) (optional alle sechs Aufgaben)}
\GESO{\olatLinkArbeitsblatt{\tempA}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{\tempB}}
\TALS{\olatLinkArbeitsblatt{\tempA}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{\tempB}}
