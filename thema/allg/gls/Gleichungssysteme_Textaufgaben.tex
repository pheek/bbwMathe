...
Dividiert man die erste von zwei Zahlen durch fünf und die zweite Zahl
durch sechs, so sind die Quotienten gleich groß. Multipliziert man
hingegen die erste Zahl mit sieben und die zweite Zahl mit sechs, so
ist das zweite Produkt um zwanzig größer als das erste Produkt.
...
\TNTeop{
  ...
  Grundform
  \gleichungZZ{\frac15 \cdot x - \frac16 \cdot{} y}{0}{6y-7x}{20}

  1. Gleichung mit 30 multiplizieren, um die Brüche wegzuschaffen:

  \gleichungZZ{6x - 5y}{0}{-7x + 6y}{20}
  1. Gleichung mit 6, 2. Gleichung mit 5 multiplizieren

  \gleichungZZ{36x - 30 y}{0}{-35x+30y}{100}
  Additionsverfahren:
  $$x = 100$$
  Wegen $7x+20=6y$ folgt $y=\frac16\cdot{}\left(7x+20\right)$. Somit
  ist $y=\frac16 \cdot{}720 = 120$.

  Die erste Zahl lautet 100, die zweite 120.
}
...
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{Kap. 12.1}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 12.1}}
...
Frau Groß hat ein Kapital in zwei Posten angelegt, einen zu 4\,\%
...
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{Kap. 12.2}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 12.2}}
%  \AadBMTA{157}{44., 45.}
...
Beispiel: Der Rasenmäher verbrauchte während dem Mähen 0.8 kWh. Er hat eine Leistung von
1.5 kW. Wie lange war er im Betrieb?

\TNTeop{h = kWh / kW = $0.8$ kWh / $1.5$ kW = $0.5\overline{3}$ h = $32$ min.}
...
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{Kap. 12.3}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 12.3}}
%Matura Niveau:
%\AadBMTA{160}{72.}
...
so erhalte ich dasselbe, wie wenn ich der Zahl ihre Ziffern vertausche.
...
\TNT{10.4}{
  ...
  \gleichungZZ{x+y}{9}{10x+y+45}{10y+x}
  Ordnen:
  \gleichungZZ{x+y}{9}{9x-9y}{-45}
...
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{Kap. 12.4}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 12.4}}
...
\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{Kap. 12.5}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 12.5}}

Schwierigere Aufgaben

\GESO{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/112603866030292}{Kap. 12.6}}
\TALS{\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 12.6}}
