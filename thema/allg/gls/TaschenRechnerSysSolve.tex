...
\TALS{Definieren Sie das Gleichungssystem gls:=\{3a+2b=3.1,
  4a+5b=6.0\}. Dies können Sie nun einfach mit solve(gls,\{a, b\})
  auflösen lassen. $a=0.5; b=0.8$}
...
\TNT{4}{Lösung \texttt{false}. Das heißt, die Gleichungen haben keine
...
\DeclareRobustCommand{\tempA}{Gleichungssysteme}
\DeclareRobustCommand{\tempB}{Kap. 7: a) bis f)}
