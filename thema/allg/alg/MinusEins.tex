...
\begin{tabular}{p{5cm}|rcl}
 ...
 Notation/Gegenzahl & $(-1)\cdot(...)$                &$=$& $-(...)$                      \\
  ...
  \\
  \hline\\
  Erweitern         & $\frac{-7x+3b}{-3x - 4y}$ &$=$&
 $\frac{{\color{ForestGreen}(-1)}\cdot(-7x+3b)}{{\color{ForestGreen}(-1)}\cdot(-3x - 4y)}$\\
%%                    & $\frac{a-b}{b-a}$               &$=$& $\frac{{\color{ForestGreen}(-1)}\cdot(a-b)}{{\color{ForestGreen}(-1)}\cdot(b-a)}$\\
  \\
  \hline\\                      
  Erweitern und Ausmultiplizieren  & $\frac{-7x+3b}{-3x - 4y}$ &$=$& $\frac{(-1)\cdot(-7x+3b)}{(-1)\cdot(-3x - 4y)}$\\
                    &                                 &$=$& $\frac{7x-3b}{3x+4y}$\\
  \\
  \hline\\                    
  Gemischtes
...
Konto Hr. Ph. Freimann Stand 1. Jan. 2027: CHF {\color{ForestGreen}10\,377.--}.

Multiplikation am 2. Jan. 2027 mit $(-1)$.

Konto Hr. Ph. Freimann Stand 3. Jan. 2027: CHF {\color{red} -10\,377.--}.
\newpage
