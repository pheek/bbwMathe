...
\textbf{Beispiele und Gegenbeispiele}

Welche der folgenden sind Terme? Welche nicht?

\begin{bbwFillInTabular}{lcl}\hline
Zeichenfolge              & Term?     & Begründung oder Termname\noTRAINER{\hspace{33mm}\,}\\
$7\cdot{}5+3$             & $\BoxT{}$ & \TRAINER{Summe}     \\\hline
$8\cdot{} -x$             & $\Box{}$  & \TRAINER{zwei Operationszeichen hintereinander!}   \\\hline
$(7+a)x$                  & $\BoxT{}$ & \TRAINER{Produkt aus den Faktoren $(7+a)$ und $x$} \\\hline
$\sqrt{\left( \right)^2}$ & $\Box{}$  & \TRAINER{leere Klammer}   \\\hline
$\frac{7}{\mathbb{N}}$    & $\Box$    & \TRAINER{Division durch Menge}  \\\hline
$5^2t : 2t$               & $\BoxT$   & \TRAINER{Quotient}  \\\hline
$\sqrt{-(-4)^2}$          & $\BoxT$   & \TRAINER{Wurzelterm, wenn auch
    nicht in $\mathbb{R}$}\\\hline 
$\frac{(a+b}{-c-d)}$      & $\Box{}$  & \TRAINER{Falsch verschachtelte Klammern}\\\hline
$7\cdot{}-5 + 3$          & $\Box{}$  & \TRAINER{zwei Operationszeichen hintereinander} \\\hline
$-8\cdot{}x$              & $\BoxT{}$ & \TRAINER{Gegenzahl zu $8x$}   \\\hline
...
$$3\cdot{} 2^4 = \LoesungsRaumLen{8cm}{3 \cdot{}
  (2\cdot{}2\cdot{}2\cdot{}2) = 3\cdot{}16 = 48} $$
...
\DeclareRobustCommand{\tempA}{1.: Namen der Terme und 2. a) bis d): Werte von Zahltermen}

\TALS{\olatLinkArbeitsblatt{Terme
    [A1Te]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/106261488967281}{\tempA}}%% TALS
\GESO{\olatLinkArbeitsblatt{Terme
    [A1Te]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/106261488881900}{\tempA}}%% GESO
...
\subsection{Terme auswerten}\index{Terme!auswerten}\index{Werte in Terme einsetzen}\index{Terme!Werte einsetzen}
...
$$A(r; h) = r^2\pi + r^2\pi + 2r\pi{}\cdot{}h \TALS{ = \LoesungsRaumLen{35mm}{2r\pi(r+h)}}$$

Dabei ist $A$ der Name des Terms und $r$ bzw. $h$ sind die Parameter.
\vspace{3mm}
\begin{beispiel}{Auswerten}{beispiel_terme_werte_einsetzen}
...
\begin{gesetz}{Klammern}{}\index{Klammern}
...
\GESO{\olatLinkArbeitsblatt{Terme [A1Te]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/106261488881900}{3. (alle), 4. a) c) e) und g) und Kap. 5. a) c) \TRAINER{Aufgabe 6. nur TALS oder als Option}}}%% GESO
