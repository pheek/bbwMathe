...
\begin{definition}{Term}{definition_term}
  ...
  $a$, $x$))
  \item ein Klammerausdruck (\zB{} \fbox{({\color{ForestGreen}T})}, inkl.  Wurzeln \fbox{$\sqrt{\color{ForestGreen}T}$})\footnote{Dabei wird der
...
%%    \begin{itemize}
   \item eine \textbf{Potenz}\index{Potenz}\footnote{Als Exponent darf
     ...
     ${\frac{a}{b}}^c$ ist nämlich nicht klar, wohin das $c$ denn gehört.} (\fbox{${\color{ForestGreen}T_1}^{\color{ForestGreen}T_2}$} \zB{} $a^3$, $(2a - 4)^{x+2}$)
