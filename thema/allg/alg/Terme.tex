...
\olatLinkGESOKompendium{1.1}{6}{1}
...
\begin{tabular}{|c|c|}
  ...
  $x^6\text{, für } x=-1$ & $x^6= \LoesungsRaum{+1}$\\
  $-x^5\text{, für } x=-10$ & $-x^5= \LoesungsRaum{+100\,000}$\\
  $(-x)^3\text{, für } x=-2$ & $(-x)^3= \LoesungsRaum{+8}$\\
...
\newpage
\aufgabenFarbe{Füllen Sie die folgende Tabelle aus:}
