...
\newpage
  ...
  \noTRAINER{\mmPapier{12}}%% END noTRAINER

%%  \GESOAadB{22}{Optional: 6., 7.}
%%  \TALSAadB{8}{Optional: 1., 2.}
...
\TNT{2}{Rechnen Sie nie mit bereits gerundeten Zwischenresultaten. Der Fehler kann sich dadurch vergrößern!}%% END TNT
