...
\TNT{4}{Bem.: $\frac{1}{9} = 0.111\overline{1}$, $\frac{1}{99} = 0.0101\overline{01}$, $\frac{1}{999} = 0.001001\overline{001}$, ...}
...
\aufgabenFarbe{Runden Sie die Zahl 3.21459 auf zwei Dezimalen: \LoesungsRaumLang{3.21}. Runden Sie die selbe Zahl 3.21459 auf drei Dezimalen: \LoesungsRaumLang{3.215} und runden Sie nun das gerundete Resultat auf zwei Dezimalen: \LoesungsRaumLang{3.22}. Was ist davon zu halten?\\
\TNT{2}{Rechnen Sie nie mit bereits gerundeten Zwischenresultaten. Der Fehler kann sich dadurch vergrößern!}
}
...
\TRAINER{$$\mathbb{N} \subset \mathbb{Z} \subset \mathbb{Q} \subset
  \mathbb{R} $$}%
\noTRAINER{\vspace{15mm}}
\end{gesetz}

\TNT{7.6}{(Trainer: Beginne beim skizzieren mit $\mathbb{R}$)\\
