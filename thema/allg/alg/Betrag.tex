...
\GESO{%% TR GESO
  ...
  \tiprobutton{math} (Pfeil nach rechts) \tiprobutton{1}
  \tiprobutton{neg} \tiprobutton{6} \tiprobutton{enter}
...
$|x| = 4$ \TRAINER{$\mathbb{L}_x=\{4, -4\}$}%

$|x| = -4$ \TRAINER{$\mathbb{L}_x=\{\}$}%
...
\subsection*{Aufgaben}
\TALSAadB{9}{5-7}
\GESOAadB{23}{14. a) b) c) f) 15. a) 17. a) 18. a)}
\newpage
