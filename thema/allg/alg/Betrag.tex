...
\GESO{\matheNinjaLink{Betrag}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/105951761084932}}
\TALS{\matheNinjaLink{Betrag}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/106261459444683}}
...
\begin{definition}{Betrag}{definition_betrag}\index{Betrag}\index{Absolutbetrag}
  ...
  senkrechte Striche:\index{$\mid\cdot \mid$ s. Betrag(-striche)|textbf}\\
  $$\begin{array}{rcl}
    |-7| & = & +7\\
...
\subsection*{Aufgaben}
\GESO{\olatLinkArbeitsblatt{Betrag [A1B]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/105796974541159}{1.}}%% END olatLinkArbeitsblatt
\TALS{\olatLinkArbeitsblatt{Betrag [A1B]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/105796974602793}{1.}}%% END olatLinkArbeitsblatt


\subsection{Betragsgleichungen \GESO{ (optional)}}
...
\TNT{6}{%%
  ...
  $x_1=11$; 2. Fall $x-3 <=0$, dann ist $-(x-3)=8$ (m.\,a.\,W.: $(x-3)=-8$) und somit $x_2=-5$
}% END TNT


\subsection*{Aufgaben}
\GESO{\olatLinkArbeitsblatt{Betrag
    [A1B]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/105796974541159}{2.,
3. }}%% END olatLinkArbeitsblatt
\TALS{\olatLinkArbeitsblatt{Betrag
    [A1B]}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/105796974602793}{2.,
3.}}%% END olatLinkArbeitsblatt
