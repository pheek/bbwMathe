...
\begin{itemize}
  ...
  \item Kürzen (und erweitern)
	\item Gleichnamig machen\index{gleichnamig}, Hauptnenner\index{Hauptnenner} (kgV\index{kgV}\GESO{\cite{marthaler21} Seite 43})
	\item Brüche addieren/subtrahieren
  \item multiplizieren
	\item Doppelbrüche (Brüche dividieren) \GESO{S. 45 \cite{marthaler21}}
\end{itemize}
...
\GESOAadBMTA{48ff}{5. d), 6. a), 7. a), 8. b), 9. c) h), 10. b),
11. a) c) d) e) f), (Optional 12.,) 13. a)}%

\GESOAadBMTA{48ff}{2. d) 3. c) d)}%
}


\newpage
\subsection{Rechnen mit Bruchtermen}
\GESOTadBMTA{43}{3.3} \GESO{und} \GESOTadBMTA{44}{3.4}
...
\GESO{
\GESOAadBMTA{49ff}{17. c) d), 19. c) e), 20. e),
...
\newpage
\subsection*{Aufgaben}
\GESOAadBMTA{51ff}{27. 28. b) f) 29. d) e) 30. d) e) 31. b) 32. a) 33. a) f) 34. a) 35. b) 36. d) 37. a) 38. d)}%
%
...
\TALSAadBMTA{21ff}{45. a) c) 46. c) d) 47. a) b) c) e) 48. a) 49. a)
