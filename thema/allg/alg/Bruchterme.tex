...
$\frac1x$              & \TRAINER{0}                       & \TRAINER{$\mathcal{D}=\mathbb{R}\backslash\{0\}$}\\\hline  
$\frac1{2-x}$          & \TRAINER{2}                       & \TRAINER{$\mathcal{D}=\mathbb{R}\backslash\{2\}$}\\\hline
$\frac{x}{(x-5)(x+3)}$ & \TRAINER{-3; 5}                   & \TRAINER{$\mathcal{D}=\mathbb{R}\backslash\{-3; 5\}$}\\\hline
$\frac{11}{5x^2-5x-60}$ & \TRAINER{-3; 4}                   & \TRAINER{$\mathcal{D}=\mathbb{R}\backslash\{-3; 4\}$}\\\hline
...
\begin{bbwFillInTabular}{c|c|l}%%
Bruch                  & Was darf nicht eingesetzt werden? & $\mathcal{D}$ Definitionsmenge \\\hline
$\frac{7x^4-4x+11}{3x^2-5x}$ & \TRAINER{$0; \frac53$}                   & \TRAINER{$\mathcal{D}=\mathbb{R}\backslash\{0;\frac53\}$}\\\hline
\end{bbwFillInTabular}
