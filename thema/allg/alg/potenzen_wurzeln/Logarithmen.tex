...
\begin{bemerkung}{Zehnerlog.}{}
  ...
  $${\color{blue}10}^{\color{red}x} = {\color{ForestGreen}p} \Longleftrightarrow {\color{red}x} = {\color{blue}\lg}({\color{ForestGreen}p})$$
\end{bemerkung}
...
\subsubsection{Weitere Logarithmusgesetze\GESO{ (optional)}}
