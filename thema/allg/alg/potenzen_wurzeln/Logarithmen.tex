...
\TALS{
  ...
  $$a^b = c \Longleftrightarrow \log_a(c)=b$$
  folgt durch Einsetzen von $b$ aus der rechten Gleichung in die linke
...
\subsection*{Aufgaben}
\TALS{Andere Basis:\\}
\TALSAadB{62ff}{185. a) b) c) g), 186. a) d) h), 187. a) c) e)  und
  (optional) 188.}
\TALS{Logarithmengesetze:\\}
\TALSAadB{64ff}{190. a) b) d), 191. a) c) e), 192. c), 193. a) c) e),
  194. a) c) d), 196. a) b) c) d), 197. a) b) e) f), 198. a) b) e) f),
  202. a) b), 203. b) d) 204. a) b) c), 206. a) c) f) und 208. a) b)}
