...
$3.4^{\frac{x}2} = 16 \Longrightarrow x= \LoesungsRaum{\frac{2\cdot{}\lg(16)}{\lg(3.4)}}$
 \TNT{2}{$$\lg\left(3.4^{\frac{x}2}\right) = \lg(16)$$
 $$\frac{x}2 \cdot{} \lg(3.4) = \lg(16)$$
  $$\frac{x}2 = frac{\lg(16)}{\lg(3.4)}$$
  $$x = frac{2\cdot{}\lg(16)}{\lg(3.4)}$$
 }%% end TNT
...
\AadBMTA{105ff}{21. a) b) c) d) e), 22. a) 23. a) c), 24. c), 25. b)
  d) }
...
\AadBMTA{106}{33. (Schreiben Sie die Lösung mit Hilfe des $\ln()$.}
...
\newpage
\TALS{%%
\subsubsection{Diverse Notationen\GESO{ (optional)}}\index{Logarithmus!Notationen}
