...
\TALS{Andere Basis:\\}
\TALSAadB{62ff}{184. a), 185. a) b) c) g), 186. a) d) f) h), 187. a) c) e)  und
  (optional mit TR) 188.}
\newpage
...
\TALS{%% Beweis nur bei TALS
  \TNT{10}{
    ...
    $$\Longleftrightarrow \lg(\underbrace{a\cdot{}a\cdot{}a\cdot{}...\cdot{}a}_{x-\textrm{Faktoren}}) = \lg(p)$$
    $$\Longleftrightarrow \underbrace{\lg(a)+\lg(a)+\lg(a)+ ... + \lg(a)}_{x-\textrm{Summanden}}= \lg(p)$$
...
\end{bemerkung}
 ...
 \begin{bemerkung}{}{}
   $$\log_a(a) = \LoesungsRaum{1} \textrm{ , denn } \TRAINER{a^1 = a}$$
\end{bemerkung}

 \begin{bemerkung}{}{}
   $$\log_a(1) = \LoesungsRaum{0} \textrm{ , denn } \TRAINER{a^0 = 1}$$
\end{bemerkung}
...
\subsection*{Aufgaben}
\TALSAadB{64ff}{191. a) b) e), 192. c), 193. a) c) e),
