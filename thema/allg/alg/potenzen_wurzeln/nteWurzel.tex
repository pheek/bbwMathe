...
\begin{gesetz}{}{}
$$\sqrt[n]{a^n} = \LoesungsRaumLen{50mm}{\left(\sqrt[n]a\right)^n = a}$$
\end{gesetz}

\begin{beispiel}{$n$-te Wurzel}{}
  $$\sqrt[4]{a^{12}} =  \LoesungsRaumLen{40mm}{\sqrt[4]{\left(a^3\right)^4}} = \LoesungsRaumLen{30mm}{a^3}$$
\end{beispiel}
...
\begin{gesetz}{Mulitplikation, Division}{}
  ...
  $$\sqrt[n]{A\cdot{}B}     = \LoesungsRaumLen{60mm}{\sqrt[n]{A}\cdot{}\sqrt[n]{B}}$$ und
  $$\sqrt[n\,]{\frac{A}{B}} = \LoesungsRaumLen{60mm}{\frac{\sqrt[n]{A}}{\sqrt[n]{B}}}$$
\end{gesetz}
...
\begin{gesetz}{Wurzeln von Wurzeln}{}
  $$\sqrt[m\,]{\sqrt[n]{a}} = \LoesungsRaumLen{50mm}{\sqrt[m\cdot
      n]{a}}=\LoesungsRaumLen{40mm}{a^\frac1{mn}} = \LoesungsRaumLen{30mm}{\sqrt[n\,]{\sqrt[m]{a}}}$$
\end{gesetz}
...
\begin{gesetz}{Wurzelschreibweise}{}
  $$a^\frac{m}n = \LoesungsRaumLen{30mm}{\sqrt[n]{a^m}} = \LoesungsRaumLen{40mm}{\left(\sqrt[n]{a}\right)^m}$$
\end{gesetz}
