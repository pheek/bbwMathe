...
\TRAINER{Buch «Arithmetica Integra» von Michael Stifl 1544. Buch 1 Seite 31 über die «geometrische Progression»:}
...
\TRAINER{... erstes Auftreten des Permanensprinzips. Buch III S. 249. $(-)\cdot{}(-) = (+)$ ...}
\noTRAINER{\vspace{14mm}}
\bbwCenterGraphic{140mm}{allg/alg/img/permanentsprinzip/03Permanenzprinzip.png}
\TRAINER{Andere Erklärung: $0= (-6)\cdot{}(4-4) = (-6)\cdot{}4 + (-6)\cdot{}(-4)$ ergo $(-6)\cdot{}(-4) = 0$: Permanenz über das Distributivgesetz. }

\TRAINER{... schon auf der nächsten Seite rechnet Michael Stifl, als wären negative Zahlen (bis dahin «numeri absurdi») ganz normal: }
\bbwCenterGraphic{140mm}{allg/alg/img/permanentsprinzip/04NegativeExponenten.png}
\noTRAINER{«Aber diese Spekulation muss an einem Beispiel gezeigt werden.»}
