...
$$10^{-n} = \LoesungsRaumLen{35mm}{\frac{1}{10^n}}$$
\end{gesetz}

\begin{beispiel}{negative Exponenten bei Zehnerpotenzen}{}
$$10^{-3} = \LoesungsRaumLen{30mm}{0.001} = \LoesungsRaumLen{20mm}{\frac1{1000}} = \LoesungsRaumLen{15mm}{\frac1{10^3}}$$
\end{beispiel}
...
\vspace{30mm}
\TRAINER{Das Permanentsprinzip der nächsten Seite ist optional.}
\newpage
...
\begin{gesetz}{}{}
$a^{-n} = \LoesungsRaumLen{40mm}{\left(\frac1a\right)^n}$
\end{gesetz}
Begründung:
...
\begin{gesetz}{}{}
$\left(\frac{a}{b}\right)^{-n} = \LoesungsRaumLen{50mm}{\left(\frac{b}{a}\right)^{+n}}$
\end{gesetz}
...
\subsection*{Aufgaben}
\DeclareRobustCommand{\tempA}{Kapitel 3.3 Aufg. 65. - 79. (challenge:
       64. und 80.)}
...
(optional) Vermischte Exponentialgleichungen:
