...
Ein Blatt Papier wird 3 mal übe die Mitte gefaltet. Somit
sind \LoesungsRaumLen{30mm}{8} Schichten übereinander.

Wie viele Schichten sind es bei 4 mal falten? Bei 4 mal falten werden
es\\ \LoesungsRaumLen{20mm}{$16 = 2^4$} Schichten.

Die Formel bei $n$ maligem Falten lautet:

$$\text{Dicke} = \LoesungsRaumLen{30mm}{2^n}\text{ Schichten}$$


Wie Dick ist der Karton ohne ihn zu falten? Richtig:
...
\newpage
\subsection*{Repetition negative Zehnerpotenzen}

\begin{gesetz}{negative Zehnerpotenzen}{}
$$10^{-n} = \frac{1}{10^n}$$
\end{gesetz}

\begin{beispiel}{negative Zehnerpotenzen}{}
...
Buch 1 Seite 31 über die «geometrische Progression»:
...
%             \noTRAINER{\vspace{14mm}}
Termwerte waren ausschließlich positiv\TRAINER{, da geometrisch motiviert (Buch II S. 123)}:
...
\TNT{3}{Permanentsprinzip kann auch via Distributivgesetz motiviert werden: $0= (-6)\cdot{}(4-4) = (-6)\cdot{}4 + (-6)\cdot{}(-4)$ ergo $(-6)\cdot{}(-4) = 0$:

Schon auf der nächsten Seite benutzt Michael Stifl negative Zahlen (bis dahin «numeri absurdi»):}
\bbwCenterGraphic{140mm}{allg/alg/img/permanentsprinzip/04NegativeExponenten.png}
\begin{center}\tiny{Lat.: «Aber gezeigt soll werden diese Spekulation per Beispiel.»}\end{center}
