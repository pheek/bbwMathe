\section{Zehnerpotenzen}\index{Zehnerpotenzen}
\TadBMTA{61}{4.5}

\bbwCenterGraphic{8cm}{allg/alg/potenzen_wurzeln/img/one_in_a_mellon.jpg}

\TALS{Neben den im Buch (\cite{marthaler21alg} S. 62) angegebenen SI-Einheiten (Kilo, Mega, ...) sind die
Namen der positiven Zehnerpotenzen im Englischen anders als im
Deutschen. Hier zur Vollständigkeit:}
\GESO{Zusammenfassung der Namen und Kürzel der Zehnerpotenzen:}
