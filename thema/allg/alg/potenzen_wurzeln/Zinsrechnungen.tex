...
\newpage
\section{Zins}\index{Textaufgaben zur Zinsrechnung}\index{Zins|textbf}
\sectuntertitel{65\,\% der Leute können nicht Prozentrechnen; zum
Glück gehöre ich zu den restlichen 45\,\%!}
...
\begin{definition}{Prozent}{}\index{Prozent|textbf}\index{$\%$}
$$1\% := \frac1{100} = 0.01$$
\end{definition}
...
\subsubsection{Rate vs. Faktor I}\index{Rate|textbf}\index{Faktor!Zunahme}\index{Zunahmerate|textbf}\index{Zunahmefaktor|textbf}
\label{RateZins1}
...
Zinssatz $p$ (= Zuwachs\textbf{rate}\index{Zuwachsrate}\index{Zunahmerate})& Zinsfaktor &
$r$\\\hline
3\%              &   0.03           &  1.03 \\\hline
...
\TNT{4}{$$80 \cdot{} 1.077 \cdot{} 0.7 = 60.31,2 \text{ CHF } \approx{} 60.30 \text{ CHF }$$}
...
\subsection{Zinseszins}\index{Zins!Zinseszins}
...
\TRAINER{ (Wenn wir das Runden  auf 0.01 Taler jedes Jahr
miteinbeziehen, so kommen wir auf 144.99,0 Taler)}.


Nach 1000 Jahren wachsen unsere CHF 20.-- also auf $20 \cdot{}
1.02^{1000}$ an\\
($\approx 8.0 Mia. \text{ Taler}$)

Dies entspricht einem Faktor von fast 400 Millionen. 
}%% END TNT

\subsubsection{Zinseszinsformel}\index{Zins!Zinseszins}
...
\TNT{2.8}{ca. $2\,150$ CHF. Es gilt mit $x$=Startwert: $5.00 =
x \cdot{} 0.7^{17}$. Eine genauere Angabe ist bei drei signifikanten
Stellen nicht möglich.}%% end TNT
\end{itemize}

%\AadBMTA{355}{13. und 14.}
%%\GESOAadBMTA{207}{10. a)} %% die anderen setzen Lograithmen voraus! und 12.}
%%\GESOAadBMTA{207}{9. a) und 11. a)}
\TRAINER{Wer jetzt will, kann sich noch an die Aufgabe auf der
nächsten Seite wagen.}
\newpage
...
wird als Eulersche Konstante\index{Eulersche Zahl} mit $\e$ bezeichnet.
\newpage
\subsection*{Leonhard Euler}


\bbwCenterGraphic{5cm}{allg/alg/potenzen_wurzeln/img/Euler_phi.jpg}
\begin{center}\textit{Leonhard Euler (1707-1783)}\end{center}
...
\begin{definition}{Eulersche Zahl}{}\index{Eulersche Zahl|textbf}\index{$\e$!Eulersche Konstante|textbf}
