...
\TNT{3.2}{$$-16a^8b^3c^5$$\vspace{22mm}}
\TRAINER{optionale Anwendung:}
...
\begin{definition}{Potenz}{}\index{Potenz|textbf}
...
\begin{gesetz}{Produkt}{}
  $$a^m\cdot a^n = \LoesungsRaumLen{30mm}{a^{m+n}}$$
\end{gesetz}
   ...
   \TALS{$a^m\cdot a^n =
    ...
    = a^{m+n}$}
   \GESO{$7^5\cdot{} 7^3 = (7\cdot{}7\cdot{}7\cdot{}7\cdot{}7) \cdot{} (7\cdot{}7\cdot{}7)=7^{5+3}$}%%
}%% END TNT

   \begin{gesetz}{Quotient}{}Für $m,n>0$ gilt:
   $$a^m : a^n = \frac{a^m}{a^n}= \LoesungsRaumLen{30mm}{a^{m-n}}$$
   \end{gesetz}
...
$$(a^n)^m = \LoesungsRaumLen{30mm}{a^{n\cdot{}m}} = \LoesungsRaumLen{30mm}{(a^m)^n}$$
\end{gesetz}
  Begründung:
...
%%  OLAT Arbeitsblatt
\DeclareRobustCommand{\tempA}{Kapitel 2 (inkl. 2.1 gleiche Basis) (Aufgaben 17., 18, danach 22. - 43.)}
\GESO{\olatLinkArbeitsblatt{Potenzgesetze}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/102690264435484}{\tempA}}%% END olatLinkArbeitsblatt
\TALS{\olatLinkArbeitsblatt{Potenzgesetze}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/104915210426569}{\tempA}}%% END olatLinkArbeitsblatt
...
\begin{gesetz}{Produkt}{}
$$a^n \cdot{} b^n  = \LoesungsRaumLen{30mm}{(ab)^n}$$
\end{gesetz}
  ...
  \TNT{2.4}{
    \TALS{$a^n\cdot b^n
= \underbrace{\aaaa}_{n\text{ Faktoren}}\underbrace{\bbbb}_{n\text{ Faktoren}}
= \underbrace{ab\cdot ab\cdot ... \cdot ab}_{n\text{ Faktoren}} =
(ab)^n$}%%
...
\begin{gesetz}{Division}{}
  $$a^n : b^n = (a:b)^n$$
  bzw.
  $$\frac{a^n}{b^n} = \LoesungsRaumLen{30mm}{\left(\frac{a}{b}\right)^n}$$
\end{gesetz}
...
\begin{bemerkung}{Achtung}{}
  $$a^3 \cdot{}  b^4 \ne \, ???$$ \TRAINER{keine gleiche Basis, kein gleicher Exponent}

  $$a^3 +        b^3 \ne \, ???$$ \TRAINER{keine Punkt-Rechunung!}

  $$a^3 - a^4 = a^3\cdot{}(1 - a) = a^3 - a^4$$
  \TRAINER{keine wirkliche Vereinfachung}
\end{bemerkung}
...
$(-s^3)^4 = \LoesungsRaum{-s^{4\cdot{}3} = s^{12}}$

Exponentenvergleich: Finde $x$:

$$(r^x)^{10}\cdot{}r^{22} = r^{72}$$
\vspace{3mm}
$x=\LoesungsRaum{5}$
\newpage
...
\GESO{\olatLinkArbeitsblatt{Potenzgesetze}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/102690264435484}{Kapitel
    2.2 (Aufg. 44. - 52.)  }}%% END olatLinkArbeitsblatt
...
\GESO{\olatLinkArbeitsblatt{Potenzgesetze}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/102690264435484}{Kapitel
    2.3 (Aufg. 53. - 55.)  }}%% END olatLinkArbeitsblatt
\TALS{\olatLinkArbeitsblatt{Potenzgesetze}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/104915210426569}{Kapitel
    2.3 (Aufg. 53. - 55.)}}%% END olatLinkArbeitsblatt
