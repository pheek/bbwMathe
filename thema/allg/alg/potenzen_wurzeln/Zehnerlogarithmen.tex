...
\GESO{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/110436259154906}{1.}
}%% end GESO
\TALS{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/110436259219039}{1.}
}%% ent TAL
\newpage
...
\GESO{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/110436259154906}{2.}
}%% end GESO
\TALS{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/110436259219039}{2.}
}%% ent TALS
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsubsection{Logarithmus der Wurzel\GESO{ (optional)}}
...
\TNT{6}{
  $$x = \lg\left(\sqrt[3]{10^4}\right)$$
  $$x = \lg\left(10^{\frac43}\right)$$
  $$x = \frac43$$
}%% end TNTeop
...
\GESO{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/110436259154906}{3.}
}%% end GESO
\TALS{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/110436259219039}{3.}
}%% ent TALS
