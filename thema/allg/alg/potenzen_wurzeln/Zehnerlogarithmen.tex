...
Begründung:
\TRAINER{ Durch beidseitiges Exponenzieren der Definition...
...
$${\color{gray}8=\lg(10^8)=\lg(10^{3+5})}=\lg(10^3\cdot{}10^5) =
\lg(10^3)+\lg(10^5){\color{gray}=3+5=8}$$
...
\TALS{
  ...
  Daraus folgt:
  $$a\cdot{}b = 10^{\lg(a\cdot{}b)} = 10^{\lg(a) + \lg(b)}$$
