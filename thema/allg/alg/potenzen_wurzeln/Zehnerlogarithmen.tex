...
>>>>>>> 4f3890da85924318daec64127173803745994921
    \end{center}
\end{definition}
...
$$\lg(10^x) = x \Longleftrightarrow 10^{\lg(10^r)} = 10^r$$
=======
Begründung \TRAINER{ durch beidseitiges Exponenzieren der Definition...
>>>>>>> 4f3890da85924318daec64127173803745994921

$$\lg(10^r) = r \Longrightarrow 10^{\lg(10^r)} = 10^r
\stackrel{x:=10^r}{\Longrightarrow} 10^{\lg(x)} = x$$
}%% END TRANIER
