...
\sectuntertitel{Der Logarithmus erzählt nie über seine Vergangenheit,
  weil er Angst hat vor negativen Zahlen.}

\begin{center}
  \textit{logos}: Das Verhältnis, \textit{arithmos}: Die Zahl
\end{center}
...
\GESO{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029794/CourseNode/110436259154906}{1. bis 5.}
}%% end GESO
\TALS{
  \olatLinkArbeitsblatt{A2Log}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/110436259219039}{1. bis 5.}
}%% ent TALS
