...
\aufgabenFarbe{Aufgaben aus dem «Potenzen Arbeitsblatt» \texttt{olat.bbw.ch} Kap. 5 Wurzeln}
...
\TALS{
 $$(x^m)^n = x^{m\cdot n}\ \ \textrm{, }\ \ \left(\sqrt[n]{a}\right)^n = a \textrm{ und } a^{m+n} =a^m\cdot{}a^n.$$
}%% END TALS
\GESO{$$a^m\cdot{}a^n = a^{m+n}$$}
...
\TALS{
 ...
 Es gelten die üblichen Potenzgesetze\GESO{\footnote{S. 81 \cite{marthaler21}}} nun auch für die $n$-ten Wurzeln.
...
\GESO{Die Rechengesetze für $n$-te Wurzeln sind im Buch \cite{marthaler21} auf Seite 82 zu finden.}
...
\subsection{Aufgaben}
\TALSAadB{51ff}{141. f) g) i), 142. b) d) i), 143. a) d) j), 144. b) i),
                149. a) d) h) i), 150. h) und 157. a) b) k)}
\GESOAadB{85 ff}{[Wenn möglich immer mit Taschenrechner] 9. g), 11. a) e) g) i),
                 12. a) b) d), 13. a) b), 16. a) c) d), 17. a) b), 19. a) d) i),
                 20. a) c), 21. a) c), 22. a) c) e), 24. a)}

\aufgabenFarbe{Aufgabenblatt Potenzgesetze im \texttt{olat.bbw.ch}, dort Kap. 6 rationale Exponenten}
