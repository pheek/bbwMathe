...
\subsection*{Aufgaben}
\GESOAadB{84ff}{1. c) g), 2. a) d), 3. a) c) e) f) g) h), 4. c) b) d)}
...
\subsection{Aufgaben}
\TALSAadB{???}{???}
\GESOAadB{85 ff}{[Wenn möglich immer mit Taschenrechner] 8. f), 9. g),
10. g), 11. a) e)
  g) i), 12. a) b) d), 13. a) b), 16. a) c) d), 17. a) b),
  19. a) d) i), 20. a) c), 21. a) c), 22. a) c) e), 24. a)}
\aufgabenfarbe{  ... und die Aufgaben im Aufgabenblatt Potenzgesetze
  unter \texttt{olat.bbw.ch}, dort Kap. 1.5}
\newpage
