...
$$=\LoesungsRaumLen{50mm}{\TRAINER{\text{Erst am Schluss ausfüllen: } }(7x+5z){\color{ForestGreen}(\sqrt{x}+t)^2}}$$
...
Term wie folgt:
$$7x\cdot{}{\color{ForestGreen}(\sqrt{x}+t)^2} + 5z\cdot{}{\color{ForestGreen}(t+\sqrt{x})^2} = 7x\cdot{\color{ForestGreen}\LoesungsRaumLen{10mm}{u}}
+ 5z\cdot{\color{ForestGreen}\LoesungsRaumLen{10mm}{u}} =$$

\TRAINER{Rücksubstitution}

$$(7x+5z)\cdot{\color{ForestGreen}\LoesungsRaum{u}} = (7x+5z){\color{ForestGreen}\LoesungsRaum{(\sqrt{x}+t)^2}}$$
