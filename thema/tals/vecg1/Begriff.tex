...
Wer von den dreien erreicht das andere Ufer als erstes?
\TNTeop{

  Für die Ufererreichung (Zeit) ist lediglich die «$y$»-Koordinate der Geschwindigkeit
...
Abkürzung: Wir rechnen nur die Geschwindigkeiten in km/h: A:
$2\cdot{}\sqrt{2}\approx 2.8$; B: $3$; C:
$\frac{3.5}2\cdot{}\sqrt{3}\approx 3.03$. Somit ist C am schnellsten.
}%% END TNTeop
%%\newpage


Wo landen die drei Schwimmer am anderen Ufer?\label{woLandenDieSchwimmer}
...
\subsection{Richtung vs. Skalare}\index{Richtung!eines Vektors}\index{Skalar}
...
\noTRAINER{
\begin{tabular}{ll}\hline
  Skalare Größen& \hspace{50mm}Vektorielle Größen\\\hline
\end{tabular}
}%% end no Trainer
\newpage
...
\subsection{Betrag (Länge) von Vektoren}\index{Betrag!eines Vektors|textbf}
...
\begin{definition}{Vektor}{}\index{Vektor}
  Ein \textbf{Vektor} besteht aus einer \textbf{Länge}\index{Länge!Vektor} und, sofern eine Länge
  vorhanden ist, aus einer \textbf{Richtung}\index{Richtung!Vektor}.
\end{definition}
