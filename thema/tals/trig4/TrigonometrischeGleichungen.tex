...
Berechnen Sie die Lösungsmenge $\mathbb{L}_x$ für
$$\cos(x) = -\sin(211\degre)$$
im Definitionsbereich $\mathbb{D}=[0; 360\degre]$.


\TNT{14}{
1. Sinusfunktion ist ungerade:

$$\cos(x) = \sin(-211\degre)$$

2. $\cos(x) = \sin(x+90\degre)$
...
4. $x$ auf den Definitionsbereich einschränken:

Der $\cos$ ist gerade, somit ist $x_1=+301\degre$ sofort auch eine
Lösung.

5. Der $\cos$ ist symmetrisch gegenüber $180\degre$ und somit ist $x_2
= 360\degre-301\degre = 59\degre$ auch eine Lösung.

$$\Longrightarrow \mathbb{L}_x = \{59\degre, 301\degre\}$$
}%% END TNT
\newpage
