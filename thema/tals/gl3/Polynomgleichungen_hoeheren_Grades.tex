...
\input{tals/gl3/Polynome}\newpage

\input{tals/gl3/Produkt_gleich_Null}\newpage
...
\TNT{1.6}{\texttt{solve($..., x$)} liefert $-7 \le x \le -5 \text{ or } x\ge 2$}
...
c)  optional
  ...
  Die harte Tour\footnote{Solche und ähnliche Verfahren wendet auch der
...
\bbwCenterGraphic{15cm}{tals/gl3/img/HalbgraphischEinstiegsbeispiel.png}
...
\bbwCenterGraphic{15cm}{tals/gl3/img/HalbgraphischeMethode.png}
}
