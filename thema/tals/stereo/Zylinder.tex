...
\begin{gesetz}{Oberfläche allgemeiner Zylinder (inkl. Prisma)}{}\index{Oberfläche!Zylinder inkl. Prisma}
  ...
  \begin{center}\fbox{$S = \LoesungsRaumLang{G + D + M}$}\end{center}
  \begin{center}\fbox{$S = \LoesungsRaumLang{2\cdot{}G + U\cdot{}h}$}\end{center}
\end{gesetz}
...
\TALSAadBMTG{41ff}{37. (Körperdiagonale im Würfel),
  38. (Körperdiagonale im Quader), 40. (Schnittfläche
im Würfel)}
\TALSAadBMTG{194ff}{5., 11.}

\newpage


\subsection{Prisma}\index{Prisma|textbf}
...
\TALSAadBMTG{195ff}{14. (H-Träger), 23., 29. a) c)}
\newpage


\subsection{Kreiszylinder}\index{Zylinder!Kreiszylinder}\index{Kreiszylinder|textbf}
...
\TALSAadBMTG{198ff}{35. (Körperdiagonale im Kreiszylinder), 36. (Hohlkörper), 41. b) d)}
\newpage
