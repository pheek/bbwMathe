...
\noTRAINER{\platzFuerBerechnungen{12}}
\TRAINER{
  \begin{enumerate}
...
\olatLinkArbeitsblatt{Extremwertaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/109831007505402}{2.1: Tagestemperatur}
%%\TALSAadBMTA{320}{15.}
\newpage
...
\olatLinkArbeitsblatt{Extremwertaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/109831007505402}{2.2: Marmorplatte}
...
\TNTeop{Verschiedene Lösungswege sind denkbar;
  ...
  Variable $h$ = Höhe:
  $$V(h) = \frac13 G(h)\cdot{}h = \frac13\left(50-2h^2\right)\cdot{}h $$
  $\Longrightarrow h_{\text{max}}  = \frac{5\sqrt{3}}{3} \approx 2.88675$

  Variable $\alpha$ = Winkel einer Zeltstange gegenüber dem Boden:
  $$V(\alpha) = \frac13 G(\alpha)\cdot{}h(\alpha) = \frac13 \cdot{}2
  \cdot{} 5^2 \cdot{} \cos^2(\alpha)\cdot{}5\cdot{}\sin(\alpha)$$
  $\Longrightarrow \alpha_{\text{max}} \approx 35.2644\degre$

  Variable $a$ = Seitenlänge des Grundseitenquadrates:
  $$V(a) = \frac13\cdot{}G(a)\cdot{}h(a) = \frac13 a^2 \cdot{} \sqrt{25-\frac{a^2}2}$$
  $\Longrightarrow a_{\text{max}} = \frac{10\sqrt{3}}{3} \approx 5.7735$

  allen gemeinsam: Mit einer Größe (Parameter) wird «gespielt», um das
  Volumen zu berechnen.

  $V=\frac{500\sqrt{3}}{27}\approx 32.075$
}%% END TNTeop
%%\newpage
...
\TNT{14}{
  \bbwCenterGraphic{10cm}{tals/stereo/img/Himmelslaterne.png}
}
\newpage
...
\subsubsection{Rezept}
  ...
  \item \textbf{Zielgröße} festlegen: Dies ist hier die zu maximierende Oberfläche. Also sind die gesuchten Variable die Höhe $h$ und die Quadratseite $x$. Die zu maximierende Fläche ist
    \TNT{2.8}{Oberfläche: $$x^2 + 4\cdot{}x\cdot{}h$$\vspace{2cm}}
...
Repetition quadratische Funktionen:

\olatLinkArbeitsblatt{Extremwertaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/109831007505402}{1.12 Repetition: Eckige Dachrinne}

Nicht quadratische Optimierungsaufgaben:

\olatLinkArbeitsblatt{Extremwertaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/109831007505402}{Aufg. 2.3
  Rechteck unter Parabel}

Optimierungsaufgaben aus der Stereometrie:

\olatLinkArbeitsblatt{Extremwertaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/109831007505402}{Kap. 3
  Auswahl: 3.1 Kartonschachtel, 3.2 Streichholzschachtel, 3.5 Toblerone,
  3.6 Tipi, 3.7 Würfel in Pyramide, 3.11 Zylinder in Kegel, 3.14
  Zylindermantel in Kugel, 3.16: Kegel in Kugel, 3.20: Halbkugel auf Zylinder}


%\TALSAadBMTA{282}{58.}

%%\TALSAadBMTA{311}{49. [Straßenlampe], 52.}
%%\Frommenwiler: {243ff}{922. und 927. [Optional: 924]}

%%Geometriebuch (Stereometrie):
%%\TALSAadBFWG{173}{224. [Optional: 222., 223., 225. und 228.]}
%%\TALSAadBMTA{320ff}{12., 13. und 16.}
\newpage
...
$$V = r^2\pi\cdot{}h$$
Da das Volumen V = 1 (Liter = Kubikdezimeter) ist, gilt für die Höhe:
$$h = \frac{1}{r^2\pi}$$
...
$$A=2r^2\pi + 2r\pi \cdot{} \frac1{r^2\pi}$$

Betrachten Sie $A$ in Abhängigkeit von $r$ und finden Sie mit dem TR erst
\begin{itemize}
\item
...
\TNT{2}{$$p(5.5) := 5 = a\cdot{}(5.5-7)(5.5-4) = a\cdot{}(-1.5)(1.5) = -2.25 a = \frac{-9}4 a$$} %% END TNT
...
Nebenbedingung: $b = \LoesungsRaum{p(x) = p(5.5 + d) = p(5.5-d)}$
...
Zweite Größe (hier Fläche) finden: $F(d) = \LoesungsRaum{F\left(\frac{\sqrt{3}}2\right) \approx 5.77 }$
