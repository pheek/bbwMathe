...
Algebrabuch:
\TALSAadB{242}{915. a) b) c) [ohne Wertebereiche]} %% Weitere mögliche: , 916., 917., 918. und 919.}
...
\TNT{8}{Verschiedene Lösungswege sind denkbar;
...
\subsubsection{Rezept}
  ...
  \item \textbf{Zweite Größe bestimmen} Die zweite Größe kann hier entweder die Oberfläche, oder die Höhe der Laterne sein. Wir berechnen beides:
    ...
    \TNT{3.2}{$$h = 2-2x = 2-2\cdot{}\frac47 = \frac67 [\textrm{m}]$$
    $$F(x) = y_S = x^2 + 4\cdot{}x\cdot{}h = \left(\frac47\right)^2 + 4\cdot{}\frac47 \cdot{} \frac67= \frac{112}{49} = \frac{16}{7} [\textrm{m}^2]$$}
...
\TALSAadB{192ff}{722. [Optional 720. und 721.]}

\TALSAadB{243ff}{922. und 927. [Optional: 924]}

Geometriebuch (Stereometrie):
\TALSGeomAadB{173}{224. [Optional: 222., 223., 225. und 228.]}
