...
Wir suchen diejenige positive $x$-Position, wo der Wert kleinsten ist.
...
\TNTeop{Verschiedene Lösungswege sind denkbar;
  ...
  Variable $h$ = Höhe:
  $$V(h) = \frac13 G(h)\cdot{}h$$ \TRAINER{$h\approx 2.89$, $V=\frac{500\sqrt{3}}{27}\approx 32.1$}

  Variable $\alpha$ = Winkel einer Zeltstange gegenüber dem Boden:
  $$V(\alpha) = \frac13 G(\alpha)\cdot{}h(\alpha)$$ \TRAINER{$\alpha \approx 35.3\degre$}

  Variable $a$ = Seitenlänge des Grundseitenquadrates:
  $$V(a) = \frac13\cdot{}a^2h(a)$$ \TRAINER{$a \approx 5.77$}
...
\olatLinkArbeitsblatt{Extremwertaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/109831007505402}{Aufg. 2.3
  Rechteck unter Parabel und 2.4 Radiergummi}
