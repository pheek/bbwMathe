...
\sectuntertitel{Endlich technisch möglich: 3D in Farbe: {\color{red}D}{\color{blue}D}{\color{ForestGreen}D}} 

\TALSTadBMTG{183}{12}%%\TALSTadBFWG{133}{3}
...
\end{itemize}
\newpage
\subsection{Überblick über die betrachteten Körper}\index{Prisma}\index{Kreiszylinder}\index{Pyramide}\index{Kreiskegel}\index{Kugel}\index{Konus}
