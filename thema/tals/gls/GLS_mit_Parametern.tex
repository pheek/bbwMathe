...
wir die erste Gleichung mit \LoesungsRaumLen{10mm}{6} und die zweite Gleichung mit \LoesungsRaumLen{10mm}{5} multiplizieren\footnote{Danke Melisa für den Tipp: Natürlich könnte man auch zuerst die erste Gleichung mit 5 und die zweite Gleichung mit 3 multiplizieren, um so das $x$ zu eliminieren. Doch mit Melisas Trick, fällt auch das $q$ direkt weg.
}:

\TNT{3.2}{\gleichungZZ{18x-30y}{6p-30q}{25x+30y}{80p+30q}}
...
Einsetzen in eine der beiden ursprünglichen Gleichungen
...
\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 11: a) b) c) d) e)}
\newpage
