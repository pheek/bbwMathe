...
\TNTeop{
  ...
  \textbf{SF2}: Aus (III) sehen wir, dass auch $a+1=0$ die Gleichung
  löst. Es gilt: $x$ ist beliebig und $a=-1$

  Aus der 2. Gleichung folgt danach mit $a=-1$: $x+y=-1$ und somit $y=-x-1$
...
\olatLinkArbeitsblatt{Gleichungssysteme}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/112603866140343}{Kap. 11.1: a) bis f)}
