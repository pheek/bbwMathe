...
wie die Abblidung zeigt:
  ...
  \TNT{0.8}{Die Hauptbedingung ist hier die \textbf{Fläche}.}


  2. \textbf{Nebenbedingung}\index{Nebenbedingung!Extremwertaufgaben}

  \TNT{1.6}{Die senkrechte Kathete $h$ darf nicht höher als der Graph von
...
\TNT{4}{Die Zielfunktion ist hier die \textbf{Fläche in Abhängigkeit von
    $x$}.
  ...
  \TNT{6}{
    Um $A(x) = -x^2 + \frac23\cdot{}x$ zu maximieren, suchen wir den
  ...
  \TNT{4}{Die maximal mögliche Fläche misst $\frac{9}{16}$ (Einheitsquadrate).}
