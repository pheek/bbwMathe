...
a) Parabel durch Scheitelpunkt $P=(-3|1)$ und durch $P'=(-2|2)$ zeichnen. \TRAINER{=verschobene Normalparbel}
...
\bbwGraph{-4}{4}{-4}{4}{
\bbwDot{-3,1}{red}{north}{P}
\bbwDot{-2,2}{red}{west}{P'}
\bbwDot{2,2}{blue}{south}{Q}
...
\AadBMTA{273ff}{7., 8. und 9. mit \texttt{geogebra.org}, 17. a) c),
  18. a) c) und 28. b) c)}
...
\TNT{5.2}{Ansatz: Die Funktionsgleichung lautet $y=a(x-x_1)(x-x2)$.\\
...
\TALSAadBMTA{277}{33.}%%30. a) b), 31. c), 32. a), 33.}
\newpage
...
Von einer Parabel ist der Scheitel $S(2|3)$ gegeben. Ebenfalls ist bekannt, dass die Parabel durch den Punkt $P\left(-\frac{1}{2}\middle|1\right)$ geht.
  ...
  \subsection*{Aufgabe}
  \AadBMTA{275}{23. a), 10. a), 16. a) c) d), 19. b), 20. b),
    21. (rot), 22. (grün), 24. a), 34. a) und 35. a)}%%16. a) c) d)}
...
\begin{tabular}{c|l}
  ...
  \hline\\
  Nullstellenform, faktorisierte Form, Produktform & $f: y=a(x-x_0)(x-x_1)$\\
  \hline\\
