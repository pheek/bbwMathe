...
\DeclareRobustCommand{\vorgehensTitelchen}[1]{\textbf{\color{brown}#1
\\
}}
...
\TNT{3.2}{Entweder ablesen oder beide Funktionsterme gleichsetzen, denn $S(x_s|y_s)$ muss auf beiden Geraden liegen:
  $$g(x_s) = y_s = f(x_s)$$
