...
\TNTeop{
  a) Entweder $\Spvek{2;3}$ oder $\Spvek{-2;-3}$. (und viele andere)
...
\begin{gesetz}{}{}
  ...
  $$a_x\cdot{}b_x + a_y\cdot{}b_y  + a_z\cdot{}b_z = |\vec{a}|\cdot{}|\vec{b}|\cdot{}\cos(\gamma)$$
\end{gesetz}
 

Nach obigem Gesetz sind die beiden folgenden Definitionen identisch:
\begin{definition}{Skalarprodukt im $\mathbb{R}^3$}{}\index{Skalarprodukt}
  $$\vec{a\vphantom{b}}\circ\vec{b} := a_x\cdot{}b_x + a_y \cdot{} b_y + a_z\cdot{}b_z$$
oder mit $\gamma$ als Zwischenwinkel von $\vec{a}$ und $\vec{b}$:
  $$\vec{a\vphantom{b}}\circ\vec{b} := |\vec{a}|\cdot{}|\vec{b}|\cdot{}\cos({\gamma})$$
\end{definition}


\begin{gesetz}{Winkel und
    Skalarprodukt}{}\index{Skalarprodukt!Zwischenwinkel}
...
$$\vec{a} = \Spvek{5;3;p} \hspace{11mm} \vec{b} = \Spvek{6;p;9}$$
  ...
  \TNT{6}{
    TR: solve (59 = $\arccos{\frac{a\circ b}{|a|\cdot{}|b|}}$, p)
  ...
  \olatLinkArbeitsblatt{Vecg. II Skalarprodukt}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/108600440643739}{Kap. 1.1
    bis 1.5} %% end link
Lösen Sie je die erste Aufgabe aus jedem Kapitel. Die weiteren Aufgaben
...
\subsection*{Aufgaben}
  ...
  \olatLinkArbeitsblatt{Vecg. II Skalarprodukt}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/108600440643739}{Kap. 1.6
    bis 1.9} %% end link
