...
$$\stackrel{\frown}{\alpha} \text{rad} = \left(\frac{{\stackrel{frown}{\alpha}}\cdot{}180}{\pi}\right)^\circ$$
...
\begin{gesetz}{Bogenlänge und Sektorfläche}{}
  ...
  $$b = r \cdot{} \stackrel{\frown}{\alpha}$$
  $$A = \frac12 \cdot{} b\cdot{} r = \frac{1}{2} \cdot{} r^2 \stackrel{\frown}{\alpha}$$
\end{gesetz}

Beispiel:

Berechnen Sie Bogenlänge $b$ und Fläche $A$ eines Kreissektors mit Radius $r = 1.4$ und Sektorwinkel $\stackrel{\frown}{\alpha} = 0.36$ (im Bogenmaß).


\TNTeop{
  Bogenlänge:

  $b = r \cdot{} \stackrel{\frown}{\alpha} = 1.4 \cdot{} 0.36 = 0.504 $

  Fläche

  $A = \frac12 \cdot{} r^2\stackrel{\frown}{\alpha} = \frac12 \cdot{}1.4^2 \cdot{} 0.36 = 0.3528$
}%% end TNT eop
