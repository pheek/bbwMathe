...
\textbf{Polynome}.%%\footnote{Siehe dazu auch im Anhang das Summenzeichen auf Seite \pageref{Summenzeichen}.}
...
\end{tabular}
    ...
    \end{definition}
Dabei bezeichnet $n$ ($\in \mathbb{N}_0$) den \textbf{Grad} des Polynoms,
