...
Dabei ist $g$ die «Fallbeschläunigung»: $g\approx 9.8 \frac{\text{m}}{\text{s}} \approx 10$.

Mit Zahlen:

$$h(t) = 30\cdot{} t - \frac{10}2 t^2$$
...
$$25 = 30x - 5x^2$$
  ...
  Ist die Diskrimiienante = 0, so haben wir genau eine Lösung für die Zeit
  ...
  b) was bedeutet dies? Bei $h=45$ Metern hat die Gleichung geanu eine Lösung: Da ist der Ball ganz oben.
  $$h = 45 = 30x - 5x^2\,\,\,\, | : 5$$ 
  $$9 = 6x-x^2$$
  sortieren
  $$x^2 - 6x + 9 = 0$$
  $$(x-3)^2 = 0$$
  Nur eine Lösung, nämilch $x=t=3$ s.
