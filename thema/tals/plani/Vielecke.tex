...
\begin{tabular}{rp{90mm}}
  Höhe $h_a$, $h_b$ und $h_c$ & Senkrechte (Lot) auf die Seiten.\\\hline
    ...
    Seitenhalbierende\index{Seitenhalbierende} $s_a$, $s_b$ und $s_c$ & halbieren die
  ...
  der beiden parallelen Seiten an. Fläche $A = mh = \frac{a+c}2\cdot{}h$
\end{tabular}


\TRAINER{\bbwCenterGraphic{17cm}{tals/plani/img/Dreiecksteile.png}}
\noTRAINER{\bbwCenterGraphic{17cm}{tals/plani/img/DreiecksteileLeer.png}}

\TRAINER{\bbwCenterGraphic{14cm}{tals/plani/img/Trapez.png}}
\noTRAINER{\bbwCenterGraphic{14cm}{tals/plani/img/TrapezLeer.png}}


\TNTeop{Trapez: $m=\frac{a+c}2$ Fläche: $F = m\cdot{}h = \frac{a+c}{2}\cdot{}h$}
%\newpage
...
\subsection*{Aufgaben}
\AadBMTG{51}{2. b), 4. (Rechteck), 5. b) (Parallelogramm)
  8. (Rhombus), 12. (Quadrat), 22. (Umkreis) , 25.*  (Inkreis/Trapez)}

%\aufgabenFarbe{Strukturaufgaben: 3. a) b) c) d) y) z) aa) bb)}
\aufgabenFarbe{Strukturaufgaben: 3. a) b) c) d)}

\olatLinkArbeitsblatt{Strukturaufgaben}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/107682599240642}{VT1\_6. (Trapez  mit speziellen Winkeln)}
