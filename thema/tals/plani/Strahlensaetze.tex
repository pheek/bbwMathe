...
\TNT{5.6}{
  ...
  $$\Delta SCA \sim \Delta SDB \Longrightarrow a:b = p : (p+q) $$
  $$\Delta SCE \sim \Delta SDF \Longrightarrow x:y = p : (p+q) $$
  ergo
  $$a:b = x:y$$
  \vspace{10mm}
}%% END TNT
...
$${\color{ForestGreen} a}:{\color{red} b}={\color{gray} c}:{\color{blue} d}  \Longleftrightarrow \frac{{\color{ForestGreen} a}}{{\color{red} b}}=\frac{{\color{gray} c}}{{\color{blue} d}} \Longrightarrow {\color{red} b}\cdot{}{\color{gray} c}={\color{ForestGreen} a}\cdot{}{\color{blue} d}$$
\end{bemerkung}
