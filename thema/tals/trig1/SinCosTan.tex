...
\bbwCenterGraphic{6cm}{tals/trig1/img/Ae27.png}
$$\beta\approx \LoesungsRaum{26\degre - 28\degre}$$

\bbwCenterGraphic{3.5cm}{tals/trig1/img/Ae58.png}
$$\beta\approx \LoesungsRaum{57\degre - 59\degre}$$

\bbwCenterGraphic{6cm}{tals/trig1/img/Ae29.5.png}
$$\beta\approx \LoesungsRaum{29\degre - 30\degre}$$
...
\olatLinkArbeitsblatt{Höhenmessung}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/102901169721727}{3-5 Höhenmessungen}

\olatLinkArbeitsblatt{Geo-Dreieck}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/106803565412026}{3-5 Höhenmessungen}

\newpage
\subsection{Tangens}\index{Tangens|textbf}
...
\bbwCenterGraphic{50mm}{tals/trig1/img/Tan.png}
...
\newpage
\textbf{Nochmals eine Höhe rechnen:}

\textbf{Gegeben}:

Augenhöhe ($a$) $1.68$ m

Abstand zum Haus ($d$): $20$ m

Winkel (Elevation) ($\epsilon$): $28\degre$

\textbf{Gesucht}:

Wie hoch ($h$) ist das Haus?

Berechne dazu die Gegenkathete $g$ und addiere die Augenhöhe $a$ dazu.
\TNT{6.4}{

  $\frac{g}{d} = \tan(\epsilon)$

$\Longrightarrow g = d\cdot{} \tan(\epsilon)$

$\Longrightarrow h = a + g = a + d\cdot{} \tan(\epsilon) = 1.68 + 20.0
\cdot{} \tan(28\degre) \approx 12.3 \text{ m}$


  
}% end TNT

Ermitteln Sie die fehlende Größe ($b$, $a$, $c$) mit dem Taschenrechner:

\begin{tabular}{ccc}\hline
  \includegraphics[width=50mm]{tals/trig1/img/Tan3.25.png} &
  \includegraphics[width=65mm]{tals/trig1/img/Tan4.66.png} &
  \includegraphics[width=50mm]{tals/trig1/img/Tan5.84.png} 
\end{tabular}

\TNTeop{$b\approx 3.25 \text{ m }, a \approx 4.66 \text{ dm }, c
  \approx 5.84 $}%% end TNTeop
\newpage
...
Ermitteln Sie den Winkel $\beta$ dem Taschenrechner:

\begin{tabular}{ccc}
\includegraphics[width=58mm]{tals/trig1/img/Atan41.6.png}  &
\includegraphics[width=55mm]{tals/trig1/img/Atan36.9.png}  &
\includegraphics[width=58mm]{tals/trig1/img/Atan22.6.png} 
  \end{tabular}

\TNTeop{
  links: $\beta \approx 41.6\degre$

  mitte: $\beta \approx 36.9\degre$

  rechts: $\beta \approx 22.6\degre$
}%% end TNTeop{}
...
\begin{gesetz}{Sin / Cos / Tan}{}
  ...
  \raisebox{-5mm}{\includegraphics[width=58mm]{tals/trig1/img/gah.png}}
\end{gesetz}
...
\subsection*{Aufgaben}
\olatLinkArbeitsblatt{Sinus/Cosinus/Tangens}{https://olat.bms-w.ch/auth/RepositoryEntry/6029786/CourseNode/101586242856840}{Täglich
5-10 Minuten}
...
\subsection{Die wichtigsten Winkel}

\subsection*{Einstiegsaufgaben}

Berechnen Sie die fehlenden mit «?» markierten Größen von Hand und
geben Sie die Resultate exakt an:


\begin{tabular}{ccc}
  \includegraphics[width=60mm]{tals/trig1/img/WW4_30.png}  &
  \includegraphics[width=50mm]{tals/trig1/img/WW2.png}  &
  \includegraphics[width=40mm]{tals/trig1/img/WW7.png}  

\end{tabular}

\TNTeop{  
Erstes Dreieck: Gegenwinkel = 60 Grad. Hypotenuse AB = 8 cm und Kathete BC = $4\cdot{}
\sqrt{3}$ cm

Mittleres Dreieck: Beide Winkel 45 Grad (halbes Quadrat) und 2. Kathete = 1

Rechtes Dreieck: Oberer Winkel = 30 Grad. Kurze Kathete = 7/2 =
3.5. Die lange Kathete ist somit $\frac{7}{2} \cdot{} \sqrt{3} = 3.5\cdot{}\sqrt{3}$
}%% end TNTeop

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsubsection{Merkregel der wichtigsten Sinus-Werte}\index{Sinushand}
