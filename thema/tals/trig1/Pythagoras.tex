...
\draw[color=qqwuqq] (2.37,2.49) node {$90\text{\degre}$};
\end{scriptsize}
\end{tikzpicture}
...
\subsection{Satz}\index{Pythagoras!Trigonometrie}\index{Satz des Pythagoras!Trigonometrie}
...
Beweis mit Pythagoras (optional): $h^2 = a^2 - p^2$ und $h^2 = b^2 -
  q^2$.\\
Somit gilt
...
\item 60\degre: Das gleichseitige Dreieck\index{gleichseitiges Dreieck}\index{Dreieck!gleichseitiges}
...
\subsection*{Aufgaben}
\AadBMTG{37ff}{7. und 20.}

\subsection*{«1»-«1»-«Wurzel 2»; «1»-«2»-«Wurzel 3»}
...
\begin{bbwFillInTabular}{|c|p{9cm}|} 
  ...
  $\begin{array}{ll}
    ...
    h^2 =& \LoesungsRaum{a^2 - x^2 = a^2 - \left(\frac{a}{2}\right)^2
      = \frac{3}{4}a^2}\\
%%    h=& \LoesungsRaum{\sqrt{3}\cdot{}x, \text{ denn } x^2+h^2=a^2=(2x)^2}                \\
    h=& \LoesungsRaum{\frac{\sqrt{3}}{2}\cdot{}a = \sqrt{3}\cdot{} x}
  \end{array}$ \\
...
\subsection*{Aufgaben}
\AadBMTG{37ff}{19., 20., 21., 24., und 26.* und 27.*}
\newpage
