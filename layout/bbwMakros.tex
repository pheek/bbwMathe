...
%%Häuschenpapier
\definecolor{bbblue}{rgb}{0.9,0.95,0.85}
\newcommand{\mmPapierZwei}[2]{\begin{tikzpicture}
  \draw[step=4mm,bbblue,thin]
  (0, 0) grid ({#2}, {#1});
  \end{tikzpicture}}%%

\newcommand{\mmPapier}[1]{\mmPapierZwei{#1}{16.8}}
\newcommand{\mmPapierTheorie}[1]{\mmPapierZwei{#1}{17.6}}
