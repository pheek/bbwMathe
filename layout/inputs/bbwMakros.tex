...
\weblink{\raisebox{-5mm}{\externerLinkEPS{}}}{#2} {#4} & \weblink{#1}{#2}\\
...
\begin{tabular}{|lp{111mm}|}\hline%%
\weblink{\raisebox{-5mm}{\externerLinkEPS{}}}{#3} \weblink{\raisebox{-5mm}{\olatBBWLogo}}{#3} \weblink{#1}{#3}& \weblink{#2}{#3}\\
\multicolumn{2}{|p{172mm}|}{\cellcolor{aufgabenFarbe}#4}\\\hline
\end{tabular}%%
...
\GESO{%%
\olatLink{{\Huge K}}{Kompendium}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/102901164962365}{Kapitel #1; Seite #2; Aufgaben #3}%%
}%% END GESO
}%%
