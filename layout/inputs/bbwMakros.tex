...
\newcommand{\olatLinkArbeitsblatt}[3]{\weblink{Arbeitsblatt \olatBBWLogo{}#1}{#2}:\\\begin{center}#3\end{center}}%% END olatLinkArbeitsblatt
\newcommand{\olatLinkGESOKompendium}[2]{\olatBBWLogo\weblink{Kompendium}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/102901164962365}}%% END olatLinkArbeitsblatt
\newcommand{\olatLinkTALSStrukturaufgabenSPF}[2]{\olatBBWLogo\weblink{Strukturaufgaben
Schwerpunktsfach}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/102901174299246}}%% END olatLinkArbeitsblatt
\newcommand{\olatLinkTALSStrukturaufgabenGLF}[2]{\olatBBWLogo\weblink{Strukturaufgaben
Grundlagenfach}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/102901174291476}}%% END olatLinkArbeitsblatt
