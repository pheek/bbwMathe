...
\newcommand{\bbwAufgabenPartTitle}{AA1}
...
\newcommand{\aufgSubLabel}{\color{blue}{{\tiny[\bbwAufgabenPartTitle]} \bbwAufgabenNummer. \alph*)}}
\newenvironment{bbwAufgabenBlock}{%% Begin Part:
