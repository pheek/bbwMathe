...
%%\newcolumntype{A}{>{\columncolor[HTML]{AAACED}} p{3cm}}
%%\definecolor{lightblah}{gray}{0.9}
\newcommand{\olatLOGOLink}[3]{%%
\begin{tabular}{lcp{80mm}}%%
%%\olatBBWLogo{} & #1 & \aufgabenFarbe{#3}\\%%
\weblink{\raisebox{-5mm}{\olatBBWLogo{}}}{#2} & \weblink{#1}{#2} & \cellcolor{aufgabenFarbe}#3\\
%%A & B & \cellcolor{aufgabenFarbe}C\\
\end{tabular}%%
}%% END Command olatLOGOLink

\newcommand{\olatLOGOLinkAlt}[3]{\weblink{
\olatBBWLogo{}%%
\begin{tabular}{l}%%
OLAT:\\%%
{#1}
