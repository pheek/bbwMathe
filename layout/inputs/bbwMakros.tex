...
%% GESO
\newcommand{\versionGESOMajorDate}{9. Mai 2023}
\newcommand{\versionGESOMajorVSR}{1.11.5 (\LaTeX{})}

%% TALS
\newcommand{\versionTALSMajorDate}{9. Mai 2023}
\newcommand{\versionTALSMajorVSR}{1.11.5 (\LaTeX{})}
...
\newcommand{\olatLinkVideo}[3]{\olatLink{\raisebox{-6mm}{\includegraphics[width=12mm]{logos/seite.pdf}}}{Video: #1}{#2}{#3}}%%
