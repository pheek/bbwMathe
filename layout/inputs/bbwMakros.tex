...
\newcommand{\olatLOGOLinkMittel}[3]{%%
...
\multicolumn{2}{|c|}{\cellcolor{aufgabenFarbe}#3}\\\hline
\end{tabular}%%
}%% END Command olatLOGOLink
...
\newcommand{\matheNinjaLink}[2]{\olatLOGOLink{Mathe Ninja Link \raisebox{-5mm}{\includegraphics[width=15mm]{img/matheninja/turtle.png}}}{#2}{#1}}
