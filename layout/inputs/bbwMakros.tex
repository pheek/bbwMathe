...
\newcommand{\LoesungsRaumLang}[1]{\LoesungsRaumCM{60mm}{#1}}
...
\newcommand{\olatLinkArbeitsblatt}[3]{\olatLOGOLink{Arbeitsblatt:#1}{#2}{#3}}%%
...
%% Use
%% \olatLinkGESOKompendium{Seite/Seiteff}{Aufgabe(n)}
\newcommand{\olatLinkGESOKompendium}[2]{\olatLOGOLink{Kompendium}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/102901164962365}{Seite #1 --- #2}}%%
...
\newcommand{\matheNinjaLink}[2]{\olatLOGOLink{Mathe Ninja Link \includegraphics[width=15mm]{img/matheninja/turtle.png}}{#2}{#1}}
