...
\newcommand{\olatLinkArbeitsblatt}[3]{\weblink{
\olatBBWLogo{}%%
\begin{tabular}{l}%%
OLAT Arbeitsblatt\\%%
{#1}
...
\aufgabenFarbe{\begin{center}
Nummer: #3
\end{center}}}%%
%%\newcommand{\olatLinkArbeitsblatt}[3]{\href{#2}{#1;#3}}%% END 


%% Use:
%% \olatLinkPruefung{Einstiegstest}{«URL»}

\newcommand{\olatLinkPruefung}[2]{\weblink{
\olatBBWLogo{}%%
\begin{tabular}{l}%%
OLAT-Prüfung\\%%
{#1}
...
%% TODO Links auf folgendes Kommando umleiten


\newcommand{\olatLOGOLink}[3]{\weblink{
\olatBBWLogo{}%%
\begin{tabular}{l}%%
OLAT Arbeitsblatt\\%%
{#1}
...
\newcommand{\olatLinkGESOKompendium}[1]{\olatBBWLogo\weblink{Kompendium}{https://olat.bbw.ch/auth/RepositoryEntry/572162163/CourseNode/102901164962365}
\aufgabenFarbe{#1}}%% END olatLinkArbeitsblatt

\newcommand{\olatLinkTALSStrukturaufgabenSPF}[1]{\olatBBWLogo\weblink{Strukturaufgaben
Schwerpunktsfach}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/102901174299246}\aufgabenFarbe{#1}}%% END olatLinkArbeitsblatt
\newcommand{\olatLinkTALSStrukturaufgabenGLF}[1]{\olatBBWLogo\weblink{Strukturaufgaben
Grundlagenfach}{https://olat.bbw.ch/auth/RepositoryEntry/572162090/CourseNode/102901174291476}\aufgabenFarbe{#1}}%% END olatLinkArbeitsblatt
