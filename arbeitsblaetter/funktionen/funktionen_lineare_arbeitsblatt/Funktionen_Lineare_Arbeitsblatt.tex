...
\newpage
\subsection{Kerze}
Eine Kerze hat anfänglich eine Höhe von 26 cm. Nun wird die Kerze
angezündet. Nach 30 Minuten sind 4.3 cm abgebrannt.

a) Wie lautet die Funktionsgleichung $y=f(x)$ mit $x$=Zeit in Minuten
und $y$= Höhe in cm? (Tipp Steigung / $y$-Achsenabschnitt)

\TNT{4}{$y=f(x)$ ; $y =-\frac{4.3}{30}x +26$}


b) Wann ist die Kerze abgebrannt? (Tipp: Nullstelle)

\TNTeop{$$0 = -\frac{4.3}{30}x +26$$
$$-26 = -\frac{4.3}{30}x$$
$$26 = \frac{4.3}{30}x$$
$$26\cdot{} 30 = 4.3\cdot{}x$$
$$\frac{26\cdot{} 30}{4.3} = x$$
$$ x\approx  181 \text{ Minuten} \approx  \text{ in drei Stunden und einer Minute}$$
}
...
Tipp: Resultate immer auch noch nachprüfuen!)
