...
\TNTeop{
<<<<<<< HEAD
Seien $s$ die $53 \text{ cm}$ und $t$ die Seite der Grundfläche, so
gilt $t = s-2\sqrt{3}h$ und somit für das Volumen:
$$V(h) = G(h) \cdot{} h = \left(\frac{t}2 \right)^2 \sqrt{3} \cdot{}
h = \frac{(s-2h\sqrt{3})^2}{4} \cdot{} \sqrt{3}\cdot{} h$$
...
>>>>>>> 9c41ef6896ff7bb1c9675df56b9641fb68a88999
}
...
0.62040324 $$
$$h_{\text{max}} = \frac{\frac[4]{3^3}\cdot{} (\sqrt{3}-1)\cdot{} \sqrt{2}}{6} \approx 0.39331989$$
}%% end TNT eop
