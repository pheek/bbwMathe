...
\TRAINER{$0.89^4 \textrm{kg} \approx 62.74\% = 0.6274 kg = 627.4 g$}
...
\TRAINER{$T_{1/2} = n = \log_{0.89}(0.5)\approx 5.948$ Jahre.}
...
\item Gehen Sie zunächst von sechs Generationen innerhalb von 24 h aus
  ...
  \TNT{2}{$f(t) = \text{G}_0 \cdot{} (2^6)^\frac{t}{24} = \text{G}_0
    \cdot{} 2^\frac{t}{4}$; $b$ = $\text{G}_0$; $a=2$ und $\tau=4$;
...
$$2\cdot{}\text{G}_0 = \text{G}_0 \cdot{} 2^\frac{6.5\text{T}_2}{24}
    \Longrightarrow$$
    $$2^1 = 2^\frac{6.5\text{T}_2}{24}$$
    $$\Longrightarrow$$
    $$1 = 6.5\cdot{}\text{T}_2 : 24$$
    $$\Longrightarrow$$
    $$\text{T}_2 = 24/6.5 \approx 3.6923 \text{ h}$$
  }
