...
\bbwActAufgabenNr{} \textbf{Grog}

In der Küche der Berghütte steht eine Flasche Grog, die genau einen Liter des
heiß begehrten Getränks enthält. Abgemacht war unter den Bergleuten,
dass der Grog nach der harten Bergtour gerecht aufgeteilt werde.
...
\item Geben Sie eine Formel für den Wert des Wohnwagens in
  ...
  \TRAINER{$$f(t) = a^t = a^t \cdot{} 100\%$$
    $$f(5) = 25\% = 0.25 = a^5$$
    somit: $$a=\sqrt[5]{0.25}$$
    $$f(t) = \left(\sqrt[5]{0.25}\right)^t\,\,\,\,\, \left(\cdot{} 100\%\right)$$
  }
