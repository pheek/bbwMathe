...
$a^{\frac{1}{16}}$. Zunahme also als Faktor: 1.01145; als Rate 1.145\% jährlich.}
\item Was prognostizieren Sie bei exponentiellem Wachstum fürs Jahr 2040?
\TRAINER{$ = 89\,850 \cdot{} a^{\frac{43}{16}} \approx 146\,585 $ Einwohner}
...
$$t = 5\cdot{} \log_{16}\left(\frac{150}{2\,500}\right) \approx
    -5.0736 \textrm{ h} \text{ (ca. 2 Uhr morgens) }$$
...
\item Berechnen Sie die jährliche Inflationsrate und geben Sie das
  Resultat in \% auf eine Dezimale gerundet an.
    ...
    \TRAINER{$80 \cdot{} a^6$ mit $a=\sqrt[5]{1.165}$ ergibt:
        $80\cdot{}a^6 \approx 96.09$ \euro{}}
    ...
    \item Gehen wir von gleichbleibender Inflationsrate während der
      ...
      \TRAINER{$p$ = Preis vor sieben Jahren. Es gilt: $p\cdot{}a^7 = 75.-$ und somit: $p = \frac{75}{a^7}\approx 60.56$ \euro{}.}
