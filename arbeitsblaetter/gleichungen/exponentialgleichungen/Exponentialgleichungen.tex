...
\item $7\cdot{}3^x = 2 + 4\cdot{}3^x$ $\Longrightarrow$ $\lx=\LoesungsRaumLang{\{\frac{\lg(2)-\lg(3)}{\lg(3)}\approx  -0.369070\}}$ \abplz{7.2}
...
\item $2^{x+1}=5^x + 5^{x-1}$ $\Longrightarrow$ $\lx=\LoesungsRaumLang{\{\frac{\ln(3)-\ln(5)}{\ln(2)-\ln(5)} \approx 0.557   \}}$ \abplz{7.2} \noTRAINER{\seitenUmbruchImAufgabenteil{}}
...
angewachsen?\TRAINER{ 27 990.14 CHF} \abplz{6}
\item Auf welchen Betrag ist das Kapital nach 50 Jahren
angewachsen? \TRAINER{ 122868.39 CHF} \abplz{6}
\item Auf welchen Betrag ist das Kapital nach $n$ Jahren
angewachsen? \TRAINER{  $22\,000\cdot{} 1.035^n$} \abplz{6} %%\noTRAINER{\seitenUmbruchImAufgabenteil{}}
...
\platzFuerBerechnungenBisEndeSeite{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Rate finden}
In einer Dessertschüssel seien anfänglich ca. 100 Bakterien einer gewissen Art
gemessen worden. Nach 18 Stunden sei der Bestand bei Zimmertemperatur auf
15 000 angestiegen.

\begin{bbwAufgabenBlock}
\item Berechnen Sie den Zunahmefaktor pro Stunde. \TRAINER{1.321}
\item Was wäre die Zuwachsrate in \% pro Viertelstunde (=15 Min.)?
\TRAINER{7.2\,\%}
\item Nach wie vielen Stunden beliefe sich die Anzahl Bakterien auf 10 000?  \TRAINER{16.5 h}
\end{bbwAufgabenBlock}
