...
\begin{center}\textit{\tiny{V 1.1 --- 28. Feb. 2026}}\end{center}
...
\item $bx^2 + bx + 1 =8x $
\LoesungsBlock{$\mathbb{L}_b= \left\{ 4; 16 \right\}$}
...
\item $ px^2 - 5x + 4 = 0 $
\LoesungsBlock{
Fall $p=0$: Genau eine Lösung: Die Gleichung wird linear mit
$x_1= \frac{4}{5}$.

Fall $p=\frac{25}{16}$: Genau eine Lösung: $x_1=\frac85$

Fall $p > \frac{25}{16}$: Keine Lösung

Fall $p < \frac{25}{16}$ aber $p\ne{}0$: Zwei Lösungen:

$$x_{1,2} = \frac{5\pm{}\sqrt{25-16p}}{2p}$$
}
