...
\item Die um $\frac14$ verminderte Zahl ... \LoesungsRaumLen{30mm}{$x-\frac14$}\abplz{0.8}
...
\LoesungsRaumLen{160mm}{$x$ = Alter von ihr in Jahren (oder $x$ =
Alter von ihm in Jahren)}\abplz{2}
...
angetrieben in km}\abplz{2}

\item Kim kann $5$ m/s schneller laufen als ...

\LoesungsRaumLen{160mm}{$x$ = Laufgeschwindigkeit von Kim in m/s}\abplz{2}
...
\LoesungsRaumLen{160mm}{Karls Erspartes sind  $19.80$ CHF. (Karl hat
...
\LoesungsRaumLen{160mm}{Die Zeitspanne misst $6$ Sekunden.}\abplz{2}
