...
\item Die um $\frac14$ verminderte Zahl ... \LoesungsRaumLen{30mm}{Bei
...
... \LoesungsRaumLen{30mm}{$\frac{x}{a}$}\abplz{0.8}
\item Die Hälfte der um 3\,\% verminderten Zahl
... \LoesungsRaumLen{30mm}{$\frac12\cdot{}\left(0.97\cdot{}x\right) = \frac{0.97}{2}\cdot{}x$}\abplz{0.8}
...
$25$ kg. Wie schwer ist das andere Gewicht?

\LoesungsRaumLen{160mm}{Das andere Gewicht misst $39$ kg.}\abplz{2}

\item Die Differenz zweier Zeitdauern ist 18 Minuten. Die kleinere
...
Karls Erspartes sind  $19.80$ CHF. (Karla hat somit
...
\item
Kai addiert zu einer gedachten Zahl $x$ die Zahl 5, setzt rechts an die
Summe die Ziffer 7, dividiert die entstandene Zahl durch 11,
multipliziert den Quotienten mit 4 und erhält das 14-fache der
ursprünglichen Zahl. Um welche Zahl $x$ handelt es sich?

\LoesungsRaumLen{160mm}{
$(((x + 5)\cdot{}10 + 7) : 11)\cdot{}4 = 14\cdot{} x$

$$(((x+5)\cdot{}10+7) : 11) = 14 \cdot{} x : 4$$

mit 11 multiplizieren
$$((x+5)\cdot{}10+7 = 11\cdot{}14 x : 4$$

-7:

$$(x+5)\cdot{}10 = 11\cdot{}14 x : 4 - 7$$

$$10x + 50 = 11\cdot{}14 x : 4 - 7$$

-50
$$10x = 11\cdot{}14x:4 - 57$$

$-11\cdot{}14x:4$:

$$10 x - 11\cdot{}14x:4 = -57$$

$x$ ausklammern:

$$x\cdot{} \left(10 - 11\cdot{}14:4\right) = -57$$

Durch die Klammer teilen:

$$x = \frac{-57}{10 - \frac{11\cdot{}14}{4}} = 2$$
Die gedachte Zahl war 2.
}\abplz{6}


\item Wie viele Fußballbildchen erhält Max, wenn 960 Bildchen so
zwischen ihm und Moritz aufgeteilt werden, dass Moritz 72 Bildchen
weniger erhält als Max?

\LoesungsRaumLen{160mm}{Max erhält 516 Bildchen (Moritz erhält 444).}\abplz{2}
...
{\tiny{(Alle Preise verstehen sich pro Monat inklusive SMS und Anrufe in der Schweiz inklusive Datenpaket von 5 GiB pro Monat; nicht kumulierbar.)}}
...
\LoesungsRaumLen{160mm}{Tonis Abo kostet CHF $9.90$ pro Monat.}\abplz{6}


\vspace{3mm}


\item Ein Kapital steigt in einem Jahr von CHF 50\,000 auf CHF
51\,250. Wie groß ist sein Zinssatz?

\LoesungsRaumLen{160mm}{
Sei $p$ der Zinssatz somit ist $50\,000 + \frac{50\,000 \cdot{} p}{100}$ das neue Kapital:

$$50\,000 + \frac{50\,000 \cdot{}p}{100} = 51\,250$$
ergo, wenn ich CHF 50\,000 ausklammere:
$$50\,000 \cdot{}\left(1 + \frac{p}{100}\right) = 51\,250$$
$$1 + \frac{p}{100} = \frac{51\,250}{50\,000}$$
$$\frac{p}{100} = \frac{51\,250}{50\,000} - 1$$
$$p = 100 \cdot{} \left(\frac{51\,250}{50\,000} - 1\right) =
2.5 \,\%$$
}\abplz{2}
\noTRAINER{\newpage}
...
\item Welches Kapital ist bei einem Zinssatz von 3\,\% nach zwei
Jahren auf CHF 20\,000 angestiegen?

\LoesungsRaumLen{160mm}{
Sei $x$ das ursprüngliche Kapital vor der Verzinsung.
Nach einem Jahr ist das Kapital auf 104\,\% angestiegen, also auf
$\frac{x}{100}\cdot{}(100 + 4) = x \cdot{} 1.04$

Nach einem weiteren Jahr wächst es nochmals um den selben Faktor:

$\frac{x\cdot{}1.04}{100}\cdot{}(100+4) = x\cdot{}1.04\cdot{}1.04$

Dies ergibt die gesuchten 20\,000 CHF:

Die Gleichung lautet
$$x\cdot{}1.04 \cdot{} 1.04 = 20\,000$$
Somit ist
$$x = \frac{20\,000}{1.04 \cdot{} 1.04} \approx CHF 18\,491.10$$
}\abplz{8}%% end LoesungsRaumLen


\item
In 170 g eines ungezuckerten griechischen Naturjoghurts wird Zucker
untergemischt. Wie viel Zucker muss den 170 g zugegeben werden, damit
in der Mischung 8\,\% (Gewichtsprozente) Zucker vorhanden sind?

\LoesungsRaumLen{160mm}{
Variable $x$ = Anzahl g Zucker, die zugegeben werden muss.

Das Totalgewicht ist demnach 170 [g] + $x$ [g].

Variante I: $8\,\% : \frac{x}{\text{Totalgewicht}} = \frac{x}{170+x} =
0.08$
...
$x = 170 \cdot{} 0.08 + 0.08x$

$x - 0.08\cdot{}x = 170\cdot{} 0.08$

$x \cdot{} (1-0.08) = 170 \cdot{} 0.08$

$x = \frac{170\cdot{} 0.08}{1-0.08} = \frac{13.6}{0.92} \approx 14.8
[\text{g}]$

Variante II:

$x = 8\,\% \text{ von } 170 [\text{g}] + x$

heißt:

$\frac{170+x}{100} \cdot{} 8 = x$

$170 + x = \frac{100}{8}\cdot{}x$

$170 = \left(\frac{100}{8} - 1\right)\cdot{} x = \frac{23}{2}\cdot{}x$

$x = 170 : \left(\frac{23}{2}\right) \approx 14.78 [\text{g}]$

Probe: Total der Masse = $170 + 14.78 \approx 184.78$ g.

$8\,\% von 184.78 \approx 14.78$ q. e. d.
...
\item Eine Zahl um einen Sechstel vermindert ergibt dasselbe, wie die
Zahl um sechs vermindert. Wie lautet die Zahl?

\LoesungsRaumLen{160mm}{Sei $x$ die Zahl. Um einen Sechstel vermindert, ist
relativ gemessen; das heißt $x\cdot{}\frac56$. 
Um sechs vermindert, ist jedoch absolut: $x-6$. Die Gleichung lautet also: $x\cdot{}\frac56=x-6$. Somit ist $x=36$.}\abplz{6}

\item Die Summe von fünf aufeinanderfolgenden natürlichen Zahlen ist gleich
620. Wie lauten die fünf Zahlen?

\LoesungsRaumLen{160mm}{Sei $x$ die kleinste der fünf Zahlen, so sind
die anderen vier Zahlen $x+1$, $x+2$, $x+3$ und $x+4$. Die Gleichung
dazu lautet $x + (x+1) + (x+2) + (x+3) + (x+4) = 620$ oder
vereinfacht: $5x+10=620$, was uns zu $x=122$ bringt. Die fünf Zahlen
lauten also 122, 123, 124, 125 und 126.}\abplz{6}

\noTRAINER{\newpage}


\item An einer Sylvesterparty stößt jeder mit jedem an. Da sieben
Gäste zusätzlich gekommen sind, erklingen die Gläser 322 weitere
Male. Wie viele Gäste nehmen an der Sylvesterparty teil?

\LoesungsRaumLen{160mm}{Seien $n$ die Anzahl effektiver Gäste. Somit ist $n-7$
die Anzahl vorgesehener Gäste. Da jeder mit jedem anstößt, stoßen $n$
Personen mit $n-1$ Personen an. Da es immer zwei dieser «Anstoßen» für ein
Erklingen braucht, erklingen die Gläser $\frac{n\cdot{}(n-1)}{2}$
Mal. Wären 7 Personen weniger, so erklängen die Gläser nur
$\frac{(n-7)\cdot{}(n-8)}{2}$ Mal. Diese Differenz ist 322. Was uns
zur Gleichung bringt:
$$\frac{n\cdot{}(n-1)}2 - \frac{(n-7)(n-8)}2 = 322$$
Auflösen:
$$n^2 - n - (n^2-15n+56) = 2\cdot{} 322$$
$$14n-56=644$$
Und somit $n=50$: Es nehmen effektiv 50 Personen teil.
}
\end{bbwAufgabenBlock}
