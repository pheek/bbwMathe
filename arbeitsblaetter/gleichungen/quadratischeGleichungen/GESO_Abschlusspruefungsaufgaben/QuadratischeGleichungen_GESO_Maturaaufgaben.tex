...
\TRAINER{$ \mathcal{D} = \mathbb{R}\backslash{}\{3\}, \LoesungsMenge{} = \{8\}$}
...
\TRAINER{$ \mathcal{D} = \mathbb{R}\backslash{}\{2\}, \LoesungsMenge{} = \{1\}$}
...
\TRAINER{$ \mathcal{D} = \mathbb{R}\backslash{}\{3\}, \LoesungsMenge{} = \{12\}$}
...
\TRAINER{$ \mathcal{D} = \mathbb{R}\backslash{}\{4\}, \LoesungsMenge{} = \{5\}$}
...
\TRAINER{$\mathcal{D} = \mathbb{R}\backslash{}\{0, 3\}; \LoesungsMenge{}=\{-5, 2\}$}
