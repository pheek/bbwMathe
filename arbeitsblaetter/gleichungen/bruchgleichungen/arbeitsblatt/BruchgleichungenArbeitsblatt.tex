...
\item $\frac{2x+5}{x+5} = \frac{3x-6}{5+x} - \frac{x-11}{x+5}$ \hspace{10mm}    $\DefinitionsMenge{}= \LoesungsRaumLang{\mathbb{R} \backslash \{-5\}}$ $\LoesungsMenge{}_x = \LoesungsRaumLang{\mathbb{R}\backslash \{-5\}}$\abplz{6}
