...
\item $$5-x\cdot{}(x-4) = 5x-x^2+6$$
\LoesungsBlock{$\lx=\{-1\}$}

\item $$\frac15 + \frac{3x\cdot{}(1-x)}{8} = \frac14 - \frac{(3x-3)(x-2)}{8}$$
\LoesungsBlock{$\lx=\{\frac{14}{15}\}$}

\item $$(3x-2)^2 -x\cdot{}(x-3(x-4))  + 5 = 11x^2$$
\LoesungsBlock{$\lx=\{\frac38\}$}

\item $$\frac{1}{2}\cdot{x} + \frac{x}{3} = 5$$
\LoesungsBlock{$\lx=\{ 6 \}$}

\item $$\frac{1}{7}x + 2 = 0.23x + \sqrt{3}$$
\LoesungsBlock{$\lx=\{\frac{700(2-\sqrt{3})}{61} \approx 3.075 \}$}
...
\item $$7x + 3 = 4x + 5$$
\LoesungsBlock{$\lx=\{\frac23\}$}

\item $$\sqrt{7}x + 3 = 4x + \sqrt{5}$$
\LoesungsBlock{$\lx=\{ \frac{\sqrt{5}-3}{\sqrt{7}-4} =
\frac{3-\sqrt{5}}{4-\sqrt{7}}\approx 0.5641 \}$}

\item $$a\cdot{}x + 3 = 4x + b$$
\LoesungsBlock{$\lx=\{ \frac{b-3}{a-4} = \frac{3-b}{4-a} \}$}
...
\item $$a^2x+a = a^3x -a$$
\LoesungsBlock{$\lx=\{\frac{2}{a\cdot{}(a-1)}\}$}
...
\item $$\sqrt{7}\left(\sqrt{28}ax+3b\right) = -6-bx\cdot{}\left(1-\frac17a\right)$$
\LoesungsBlock{$\lx=\left\{\frac{-6 -3\sqrt{7}b}{14a+b-\frac{ab}7}\right\}
= \left\{\frac{-42 -21\sqrt{7}b}{98a+7b-ab}\right\}$}

\item $$(x+2s)^2 = 2x\cdot{}(x+3s)-x\cdot{}(x+3)$$
...
\item $$ax+b^2 = a^2 - bx$$
\LoesungsBlock{$\lx=\{a-b\}$. Sonderfall $a=-b$, dann $\lx = \mathbb{R}$. Spezialfall, aber kein neuer Sonderfall: Falls $a=b\ne0$ dann ist $(a+b)x=0$ und somit $\lx = \{0\}$; diese Lösung ist aber bereits in $\lx=\{a-b\}$ eingerechnet, also kein neuer Sonderfall.}
