...
\kKommentar{Neue Aufgaben in anderem Stil.}
...
\kKommentar{2-3 weitere Trainingsaufgaben...}
...
\kTrainingAufgabe{\eng{translate}%%
  ...
  $$\frac{\frac{ax^2}{y+2}}{\frac{2a}{y^2-4}}$$
}{%% Löäsung
}
...
\kTrainingAufgabe{\eng{translate}
  ...
  $$\frac{\frac{28a^2}{x}}{\frac{14a}{2x^2}}$$
  \kKommentar{neue Aufgabe}
}{%% Lösung(en)
  $$\frac{28a^2}{x} :  \frac{14a}{2x^2}=\frac{28a^2}{x} \cdot{}  \frac{2x^2}{14a}= 4ax$$
