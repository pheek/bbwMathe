...
%% Aufgabe Zahlmengen
\kTrainingAufgabe{
\deu{Ordnen Sie die folgenden Zahlen allen möglichen Zahlmengen $\mathbb{N}$, $\mathbb{Z}$, $\mathbb{Q}$ oder $\mathbb{R}$ zu}\eng{Find the least powefull set for the given number
...
\kTrainingAufgabe{%%
  \deu{Zerlegen Sie in Faktoren}\eng{translate: factorize}:\\
(\deu{Alle Aufgaben sind mit dem Taschenrechner
    lösbar.}\eng{translate: All
    problems are solvable using the calculator.})
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
\item $a^2 + 2a -15$
\item $a^3-a^2-6a$
...
\kTrainingAufgabe{%%
\eng{translate:}Schreiben Sie als Bruch ohne negative Exponenten:
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
\item $2x^{-3}$
  \item $ab^{-5}$
...
\kTrainingAufgabe{%%
\eng{translate:}Schreiben Sie die Terme ohne Quotienten:
\begin{multicols}{3}
\begin{enumerate}[label=\alph*)]
\item $\frac{a}{b^2}$
  \item $\frac1{ab^2}$
...
\kNiveauAufgabe{%%
\eng{translate:}Wenden Sie die Potenzgesetze an und schreiben Sie so einfach wie möglich:
\begin{multicols}{3}
\begin{enumerate}[label=\alph*)]
