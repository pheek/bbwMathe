...
\renewcommand{\fragenMarkierung}{\colorbox{orange!30}{\kAufgabenBuchstabe{}\,\arabic{aufgabenNummer}}}
\kMetaAufgabe{#1}{#2}%%
...
%% #1 kurzinfo
%% #2 content
\newcommand{\chapterIntro}[2]{ \begin{center}{\textit{#1}}\end{center}
\begin{tcolorbox}[colback=blue!10!white, colframe=black, arc=2mm]
#2
\end{tcolorbox}
}%% end command chapterIntro