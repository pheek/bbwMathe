...
\kNiveauAufgabe{
Nennen Sie eine mögliche Exponentialfunktion $f(x) = a^x$ [bzw. $a^\frac{x}{\tau}$] (also mit $f(0)=1$), bei der sich der Funktionswert
...
\kKommentar{Lösung mit Struktur der Aufgabe $a^x$ prüfen.}
