...
\begin{itemize}
    ...
    \item Es werden nur einseitige Hypothesentests betrachtet
\end{itemize}
...
Wir gehen von einer Binomialverteilung aus.
...
\kNiveauAufgabe{
Christian und Philipp gönnen sich ab und zu einen Spieleabend. Sie besitzen klassische sechsseitige Spielwürfel. Ein Würfel wird 60-mal geworfen. Sei $X =$ Die Anzahl der geworfenen \epsdice{6}-er.

a) Wir nehmen vorerst an, alle Würfel seien fair. Bestimmen Sie den Erwartungswert für die Anzahl der geworfenen Sechsen bei 60 Würfen. 

b) Bestimmen Sie die Wahrscheinlichkeit, dass in 60 Würfen mit einem fairen Würfel genau 14 Sechsen fallen.

\vspace{3mm}

Nun besteht im Laufe eines Spieleabends der Verdacht, dass der mitgebrachte Würfel von Philipp manipuliert ist und häufiger eine 6 zeigt als ein fairer Würfel.
...
a) $$\mathbb{E}(\epsdice{6})= n\cdot{} p  = 60 \cdot{} \frac{1}{6} = 10$$
...
zu wenig Gewicht haben. Der Vertrieb behauptet, dass mindestens 95\,\% das Normgewicht haben. Wir gehen von einer Binomialverteilung aus. Zur Prüfung wird ein linksseitiger Test mit 60 Gläsern und einem
...
$H_0$: 95\,\% der Dosen sind OK. $n=60$, $p=0.95$, $\alpha\le10\,\%$

Linksseitiger Test:

Ablehnungsbereich: [0;54], Annahmebereich [55;60] Die 49 guten Gläser liegen im Ablehnungsbereich; die Hypothese 95\,\% sind OK wird verworfen.

Alternativ: Rechtsseitiger Test

$H_0$ max 5\,\% der Dosen sind fehlerhaft

Der Annahmebereich ist [0;5], der Ablehungsbereich [6;60]. Die 11 fehlerhaften Gläser liegen im Ablehungsbereich. Auch diese mit dem Gegenereignis formulierte Nullhypothese kann verworfen werden. 
}%
