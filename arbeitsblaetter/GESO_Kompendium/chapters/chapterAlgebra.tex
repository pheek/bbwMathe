...
\kTrainingAufgabe{
\deu{Ordnen Sie die folgende Zahlen allen möglichen Zahlmengen
...
\begin{enumerate}[label=\alph*)]
 ...
 \item$\sqrt{\frac82}$ : $\mathbb{N}, \mathbb{Z},
   \mathbb{Q}, \mathbb{R}$
\end{enumerate}
\end{multicols}
...
\kKommentar{Begriff «wissenschaftliche Schreibweise» aufnehmen}

\kKommentar{Begriff «signifikante Stellen» aufnehmen!}
...
\kKommentar{Frage wie ``Runden Sie auf zwei Dezimalen'' generell weglassen.}
...
\kNiveauAufgabe{%%
  \deu{Stellen Sie in der wissenschaftlichen Notation dar}
  \eng{Express the following numbers in scientific notation}
:\\
...
\begin{enumerate}[label=\alph*)]
 ...
 \item $3^{10}$
 \item $7200$
 \item $3.02\cdot{}10^8 - 2.97\cdot{}10^7$
 \item $\pi \cdot{} \sqrt{8.73}$
\end{enumerate}}{%% Lösungsteil
\begin{enumerate}[label=\alph*)]
 \item $4.702\cdot{}10^{11}$
 \item $5.905\cdot{}10^4$

   Unklar, wie viele Nullen signifikant waren, wir geben alle an:
 \item $7.200 \cdot{} 10^3$

   Die Aufgabenstellung hatte drei signifikante Stellen, wir geben in der
   Lösung auch drei an.
 \item $2.72\cdot{}10^8$
   \item $9.09$
\end{enumerate}
}%% end kNiveauAufgabe/Lösugsteil
...
\subsection{\deu{Betrag}\eng{absolute value}}
...
\kTrainingAufgabe{$2.995$
\kPlatzFuerBerechnungen{2}
}{$3.00$}
%% %%%%%%%%%%%%%%%%%%%%%%% Aufgabe %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\kTrainingAufgabe{$2.9949$
...
\kKommentar{Summenzeichen kommt im RLP nicht vor!}

\kKommentar{Alle Summenzeichen streichen!}

\kKommentar{Wird nur beim Bernoulli verwendet und sollte nur dort im
  dortigen Zusammenhang
  vorkommen, aber nicht «schreiben Sie jeden Summanden einzeln auf».}
%% %%%%%%%%%%%%%%%%%%%%%%% Aufgabe %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\kKommentar{Zweiklammeransatz (planmäßiges Ausprobieren)}
...
\kKommentar{Unbedingt noch ein Beispiel mit Differenz von Brüchen.}
...
\kNiveauAufgabe{
  \deu{Vereinfachen Sie den folgenden Bruchterm.}
...
\kKommentar{Ist das eine neue Aufgabe?}
...
\kKommentar{Wunsch RoMi: Noch 2 Aufgaben im obigen Stil.}
...
\deu{Vereinfachen Sie folgende Terme so weit wie möglich. Resultat in Wurzelschreibweise:}
\eng{Simplify the following expressions as far as possible. Write the results as roots:}
...
\item $\sqrt[3]{x}\cdot{}\sqrt[3]{8xy} \cdot{} \sqrt[3]{xy^2}$
\end{enumerate}
\end{multicols}
...
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
\item $\sqrt[3]{26\cdot{}\sqrt[4]{a^3}  + 1\cdot{}\sqrt[4]{a^3}} =\sqrt[4]{81a} = 3\sqrt[4]{a}$
\end{enumerate}
\end{multicols}
}%%
...
\kKommentar{RLP: Exponentialgleichungen in log Gleichungen umschreiben}
...
\kTrainingAufgabe{
  ...
  \kKommentar{Michael: Eher nicht; Phi: Eher doch!}
}{%% Lösung
...
\kTrainingAufgabe{
  Schreiben Sie in der Logarithmischen Schreibweise und berechnen Sie $x$:
