...
\isAufgaben{
\subsection{\deu{Vorbemerkungen/Notationen}\eng{Preliminaries/Notations}}
...
%% %%%%%%%%%%%%%%%%%%%%%%% Aufgabe %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\kNiveauAufgabe{
  \eng{Calculate the mean and the standard deviation of the following ages of learners}%
  \deu{Berechnen Sie Mittelwert und die Standardabweichung der folgenden Alter von Lernenden}:

\begin{tabular}{l|r|r|r|r}\hline
Alter (Jahre) & 10   & 11 & 12 & 13\\\hline
Anzahl        &  7   &  3 &  8 & 10\\
 \end{tabular}

Wenn die Lehrperson auch mit eingerechnet wird, steigt der Mittelwert
um 1.25 Jahre. Wie alt ist die Lehrperson.

}{%Lösungsteil
$n$ = Stichprobenumfang = 28. Mittelwert $\overline{x} =
11.75$. Standardabweichung $\sigma = 1.18; S=1.21$.

Die Lehrperson ist 48 Jahre alt. 
...
\kKommentar{Kapitel getauscht, da Maßzahlen für Boxplot relevant}
...
\deu{\textbf{Informationen aus einem Diagramm herauslesen}:}
\eng{\textbf{Read information from a diagram}:    }
...
\kKommentar{Geändert, da mathematisch nicht lösbar}
...
\kNiveauAufgabe{
\deu{
Legoteile werden maschinell abgepackt. Bei kleinen Teilen der selben
Sorte entstehen Abweichungen in der Anzahl pro Schachtel, welche
korrigiert werden müssen.

Das folgende Diagramm zeigt eine Testproduktion:

Die $x$-Achse im folgenden Diagramm zeigt die Anzahl Teile, die pro
Schachtel aufrgetreten sind und die $y$-Achse zeigt die Anzahl der
Schachteln mit der entsprechenden Teile-Anzahl.

a)
Ermitteln Sie Mittelwert und Standardabweichung der Anzahl Teile pro
Schachtel dieser hypotetischen Testproduktion.

b) Erstellen Sie einen Boxplot zu den gegebenen Daten.
}%% end deu

\eng{
translate}%% end eng

\includegraphics[width=120mm]{img/daan/Legoteile.png}
...
\kKommentar{neue Aufgabe: ev mehr in dem Stil?}

\kPlatzFuerBerechnungen{8}

}{%% Lösungen
a) $$\overline{x} = 29.6136; \sigma = 2.1236 (S=2.1482)$$

b)

\includegraphics[width=120mm]{img/daan/LegoteileBoxplot.png}

}%% end Aufgabe


\kKommentar{Ev auch Aufgaben aus den Sozialwissenschaften.}
