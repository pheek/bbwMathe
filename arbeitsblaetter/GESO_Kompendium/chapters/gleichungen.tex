...
\chapterIntro{Gleichungen}{
\begin{itemize}
    \item lineare Gleichungen auch mit Parametern
    \item quadratische Gleichungen (ohne Parameter)
    \item lineare Gleichungssysteme (ohne Parameter, auch aus Textaufgaben: Mischaufgaben, Arbeit/Leistungsaufgaben
    \item Substitution wird nicht verlangt
    \item Exponenteialgleichungen und einfache logarithmische Gleichungen $\log_5(x-6)=25$ und elementare Potenzgleichungen $x^3 = 64$.
...
\kPlatzFuerBerechnungen{6}
\kNiveauAufgabe{
\deu{Lösen Sie nach $x$ auf:}
\eng{Solve for $x$:}
\begin{multicols}{2}
    \begin{enumerate}[label=\alph*)]
        \item $\left(\frac{1}{4}\right)^x = 64$
        \item $2^x\cdot{}2^{3x-3}=2^5$
