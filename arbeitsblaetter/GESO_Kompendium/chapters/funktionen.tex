...
\begin{itemize}
    \item Lineare Funktionen: Skizzieren, ablesen
    \item Ein- und Zweipunkte Aufgaben.
    \item Parallel und Senkrecht-stehende Geraden durch einen Punkt.
    \item Nullstellen, $y$-Achsenabschnitt, Steigung
    \item Exponentielle Prozesse aus Textbeschreibung modellieren.
    \item Halbwertszeit
    \item Sättigungsprzesse (beschränktes Wachstum, beschränkter Zerfall)
\end{itemize}
