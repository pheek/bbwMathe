...
{\huge{\textbf{Aufgabensammlung\hspace{50mm}\,}}}\\\kKommentar{WORKING DRAFT} \end{center}
...
%%
\deu{Mit {\colorbox{blue!30}{(T)}} gekennzeichnete Aufgaben dienen
lediglich dem Training als Einstiegsaufgaben.\\
Mit \colorbox{red!30}{(N)} gekennzeichnete Aufgaben haben das Niveau
