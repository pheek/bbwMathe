...
\subsubsection{\eng{Word problems leading to linear equations}\deu{Text9aufgaben, die auf lineare Gleichungen führen}}
...
\subsection{\eng{Systems of linear equations with two
unknowns.}\deu{Lineare Gleichungssysteme mit zwei Unbekannten}}
...
@ Christian: Die musst Du mir nochmals erklären ($x^3$ ??)
