...
\begin{multicols}{2}
  ...
  \item
    \gleichungZZ{\frac{x+y}{6}}{\frac{x}{2}-5}{x+8}{\frac{y+x}{6}}
  \item
...
\item
    ...
    \item Letzte beiden Lösungen .... coming soon ...
    \end{enumerate}
}%%%
...
\subsection{\eng{Power Equations}\deu{Potenzgleichungen}}

\subsubsection{\eng{Elementary Power Equations}\deu{Elementare
Potenzgleichungen}}
...
\kTrainingAufgabe{
\kKommentar{In 2 Aufgaben geteilt: Training/Niveau}
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
\item $x^4=64$
\item $(x-2)^2 = 144$
...
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
\item $\Lx=\pm 2\sqrt{2} \approx \{-2.828, + 2.828\}$
\item $\Lx=\{-10; +14\}$
\item $x = \sqrt[3]{18}$
\item $x = \frac12$
...
= \mathbb{R}$). \\
Verwenden Sie die Solve-Funktion zur Überprüfung Ihres Resultates.\\
...
Use the calculators «solver» to check your result.\\
