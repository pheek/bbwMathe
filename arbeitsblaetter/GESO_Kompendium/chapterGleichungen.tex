...
\subsection{\deu{Textaufgaben, die auf Gleichungssysteme mit zwei Unbekannten führen}\eng{Word problems leading to systems of equations with two unknowns}}
...
\subsection{\deu{Textaufgaben}\eng{word problems}}
...
und bestimmen Sie die Lösungsmenge; $\mathbb{G}=\mathbb{R}$. Exakte Werte
angeben:}
\eng{State the domain, then solve the equation, and determine the solution set; $\mathbb{G}=\mathbb{R}$. Provide exact values.}
\\
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
...
Taschenrechner. $\mathbb{G}=\mathbb{R}$.}
\eng{State the domain, then solve the equation, and determine the solution set using the calculator. $\mathbb{G}=\mathbb{R}$.}
\\
\begin{multicols}{2}
\begin{enumerate}[label=\alph*)]
...
\subsection{\eng{Elementary Power Equations}\deu{Elementare Potenzgleichungen}}
\deu{Lösen Sie die Gleichung nach
$x$ auf und schreiben Sie die Resultate als exakte Werte ($\mathbb{G} =
\mathbb{R}$). Ein ausführlicher, schrittweiser Lösungsweg wird
...
function and express the results as exact values ($\mathbb{G} = \mathbb{R}$).A detailed, step-by-step solution is required.  Check your result with the calculator's SOLVER.}
...
\eng{Solve the equation for $x$ without using the calculator's solve function and express the results as exact values ($\mathbb{G} = \mathbb{R}$).\\
