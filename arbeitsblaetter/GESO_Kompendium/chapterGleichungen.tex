...
function and express the results as exact values ($G = \mathbb{R}$).A detailed, step-by-step solution is required.  Check your result with the calculator's SOLVER.}
