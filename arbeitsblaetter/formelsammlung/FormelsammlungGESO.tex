...
\newcommand{\versionsnummerFoSa}{2021-06-23 0.1.4}
...
%%\bbwCenterGraphic{8cm}{PotenzFkt.pdf}
$m$ gerade

\bbwCenterGraphic{8cm}{PotenzFktx2x4.pdf}

$m$ ungerade
\bbwCenterGraphic{8cm}{PotenzFktx3x5.pdf}


$m<0$: Hyperbeln

$m$ gerade
\bbwCenterGraphic{8cm}{PotenzFkt1overx2x4.pdf}
...
\raisebox{-5cm}{\includegraphics[width=3.5cm]{img/KombinatorikMultiplikation.pdf}} &
Andrea hat drei verschiedene Hosen und vier verschiedene Pullover.
Es gibt somit $3\times4$ mögliche Kombinationen.\\
\end{tabular}
