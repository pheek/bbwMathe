...
\newcommand{\versionsDatumFoSa}{2021-07-06}

%% ID (ca. alle jahre), Subversion: Größere Änderungen, Revision: Jede
%% Umstellung/Korrektur/Typos
\newcommand{\versionIdSubRev}{0.2.7}
...
\renewcommand{\arbeitsblattTitel}{Formelsammlung --- gesundheitlich-soziale BMS\TRAINER{ (V \versionIdSubRev)}}
...
Fühler (Whisker) werden auf max. $1.5\cdot\textrm{IQR}$ begrenzt ({\color{blue} Ausreißerschwellen blau}),
