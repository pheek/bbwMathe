...
\RLP{$$g\-:\,\,\,\,\, y = f(x) = m\cdot{}x + q \textrm{\,\,\,\,oder\,\,\,\,} f(x)=a\cdot{}x + b$$}
...
\begin{itemize}
\item Balken- und Kreisdiagramme werden für ordinale und nominale
  Skalen verwendet.
...
\tiprobutton{ncrnpr}       &Kombinatorik      &  Fakultät: {\color{red}\textbf{!}}\\
                           ...
                           &                  &  $\frac{n!}{(n-k)!}$: Tippe $n$ nPr $k$\\\hline
