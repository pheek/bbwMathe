...
\TRAINER{«Schritte zum Boxplot als Fließtext
  daneben. Ausreißerschwellen {\color{ForestGreen}grün} im
...
Ausreißerschwellen ({\color{ForestGreen}grün NOCH TODO...})),
danach nach \textit{innen} gehen: Fühler sind die von der Box
entferntesten Nicht-Ausreißer ({\color{blue}blau}). Ausreißer
