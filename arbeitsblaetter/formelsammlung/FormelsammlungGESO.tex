...
\newcommand{\versionsDatumFoSa}{2024-04-25}
\newcommand{\versionIdSubRev}{0.5.1}
...
\thispagestyle{fancy} \fancyhf[HC]{\metaHeaderLine} \fancyhf[HR]{\thepage{}} \fancyhf[HL]{}  \fancyhf[FR]{} \fancyhf[FC]{}%%
}%% END newcommand "headerUndFooterJedeSeite

\newcommand{\headerUndFooterJedeSeite}{%%
\thispagestyle{fancy} \fancyhf[HRE]{} \fancyhf[HRO]{\thepage{}} \fancyhf[HC]{} \fancyhf[HLO]{} \fancyhf[HLE]{\thepage{}} \fancyhf[FR]{} \fancyhf[FC]{}%%
}%% END newcommand "headerUndFooterJedeSeite
...
\subsection*{Runden}
Bsp.: Runden auf \textbf{\color{farnFarb}vier}  Dezimalen.
Betrachte die nächste Ziffer und runde auf, falls diese
{\color{red}Ziffer} $\ge 5$. Bsp.:

$3.\mathbf{\color{farnFarb}4729}\mathbf{\color{red}6}44 \approx 3.\mathbf{\color{farnFarb}4730}$; \hfill{ }
$70.\mathbf{\color{farnFarb}0031}\mathbf{\color{red}4}998\approx 70.\mathbf{\color{farnFarb}0031}$
...
zählen. Bsp. \textbf{\color{farnFarb}vier} signifikante Stellen:

$$\mathbf{\color{farnFarb}208.0} \textrm{ cm} = \mathbf{\color{farnFarb}2.080} \textrm{ m} = 0.00\mathbf{\color{farnFarb}2080} \textrm{ km}$$
...
$$\log_{\color{farnFarb}a}({\color{red}b}) = \frac{\lg({\color{red}b})}{\lg({\color{farnFarb}a})} = \frac{\ln({\color{red}b})}{\ln({\color{farnFarb}a})}$$}
\FAKTORAQ{$$\log(a^x) = x\cdot{}\log(a)$$
$$\log_{\color{farnFarb}b}({\color{red}a}) = \frac{\lg({\color{red}a})}{\lg({\color{farnFarb}b})} = \frac{\ln({\color{red}a})}{\ln({\color{farnFarb}b})}$$}
\end{tcolorbox}%
%
%%\RLP{\forceCB{}}%%
%%\forceCB{}%%
...
\gleichungZZ{{\color{farnFarb}\frac6{x+1}} + {\color{red}\frac8{y-2}}}{11}{{\color{farnFarb}\frac2{x+1}} - {\color{red}\frac{10}{y-2}}}{-9}
Substituiere
${\color{farnFarb}a}={\color{farnFarb}\frac1{x+1}}$ und
${\color{red}b} = {\color{red}\frac1{y-2}}$:

\gleichungZZ{{6\color{farnFarb}a} + 8{\color{red}b}}{11}{2{\color{farnFarb}a} - 10{\color{red}b}}{-9}
...
%und Quartile ({\color{blue}$Q_1$}, {\color{farnFarb}$Q_3$})einzeichnen
%\item IQR := {\color{farnFarb}Q3}-{\color{blue}Q1} rechnen
...
\ifdefined\versionHECH%%
danach nach \textit{\color{farnFarb}innen} gehen
\fi%%
: Fühler sind die von der Box
entferntesten Nicht-Ausreisser ({\color{farnFarb}grün}). Ausreisser
