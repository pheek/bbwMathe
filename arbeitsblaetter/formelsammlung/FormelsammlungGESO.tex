...
\renewcommand{\headerUndFooterDieseSeite}{\thispagestyle{empty}}
%%\renewcommand{\headerUndFooterDieseSeite}{\thispagestyle{fancy}\fancyhf[FC]{Seite \thepage{}}}


%%% Ananlog für Seitennumemern
\renewcommand{\geometrieErsteSeite}{\newgeometry{left=0.3cm,right=0.3cm,top=0.3cm,bottom=0.5cm}}
%%\renewcommand{\geometrieErsteSeite}{\newgeometry{left=0.3cm,right=0.3cm,top=0.3cm,bottom=1.5cm}}


%\newgeometry{left=0.3cm,right=0.3cm,top=0.3cm,bottom=0.5cm}
%%\newgeometry{left=0.3cm,right=0.3cm,top=0.3cm,bottom=2.5cm}




\newcommand{\versionsDatumFoSa}{2023-01-17}

%% ID (ca. alle jahre), Subversion: Grössere Änderungen, Revision: Jede
%% Umstellung/Korrektur/Typos
\newcommand{\versionIdSubRev}{0.4.2}
...
%%\renewcommand{\metaHeaderLine}{Formelsammlung (GESO \noTRAINER{2021}\TRAINER{\versionsnummerFoSa{}} BMS Winterthur)}
