...
\usepackage{makecell}
\renewcommand{\metaHeaderLine}{Formelsammlung GESO (v 0.0.9 2021-06-14 fp)}
...
$$c+b\cdot{}a^t = c + b\cdot{}e^{mx} \textrm{ mit } m = \ln(a)$$

bzw.

$$c+b\cdot{}a^\frac{t}\tau = c+b\cdot{}e^{mx} \textrm{ mit } m=\ln(a^\frac1\tau)$$
...
\subsection*{Skalen}
\bbwCenterGraphic{15cm}{img/FlowchartSkalentyp.pdf}
\vspace{5mm}
