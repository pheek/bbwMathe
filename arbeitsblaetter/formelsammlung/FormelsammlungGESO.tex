...
zählen. Bsp. \textbf{\color{ForestGreen}vier} signifikante Stellen:

$$\mathbf{\color{ForestGreen}208.0} \textrm{ cm} = \mathbf{\color{ForestGreen}2.080} \textrm{ m} = 0.00\mathbf{\color{ForestGreen}2080} \textrm{ km}$$
