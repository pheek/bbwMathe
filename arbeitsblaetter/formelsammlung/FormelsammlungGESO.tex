...
\thispagestyle{empty}%%
\else
\thispagestyle{fancy} \fancyhf[HR]{Seite \thepage{}} \fancyhf[FR]{}%%
\fi%% version DEST
}%% END newcommand "headerUndFooterDieseSeite
...
\thispagestyle{fancy} \fancyhf[HR]{Seite \thepage{}} \fancyhf[HL]{} \fancyhf[HC]{}
\ifdefined\versionDEST%%
\thispagestyle{empty}%%
\fi%%
