...
\usepackage{makecell}
\renewcommand{\metaHeaderLine}{Formelsammlung GESO (v 0.0.14 2021-06-15 fp)}
\renewcommand{\arbeitsblattTitel}{Formelsammlung}
...
$$(a+b)^2 = a^2+2ab + b^2$$%%
$$(a-b)^2=a^2-2ab+b^2$$%%
$$(a+b)\vphantom{(a+b)^2}\cdot(a-b) = a^2 - b^2$$
\end{gesetz*}
...
\subsection*{Runden}
Runden auf $4$ Dezimalen: betrachte die nächste Ziffer und runde auf, falls diese {\color{red}Ziffer} $\ge 5$.

Beispiel

$$3.4729\textbf{\color{red}6}44 \approx 3.4730$$
$$0.00314\approx 0.0031$$
(Alle vier Dezimalen sind anzugeben.)

\subsection*{Signifikante Stellen}
Führende Nullen zählen nicht, nachfolgende Nullen zählen:

248 cm = 2.48 m = 0.00248 km

Bsp.: \textbf{Vier} signifikante Stellen:

24866 cm $\approx$ \textbf{248.6} cm

0.0020866 km $\approx$ 0.00\textbf{2087} km
...
\TRAINER{Noch stehen gelassen, da im Kompendium oder in alter Prüfung gesichtet.}
...
\TRAINER{Wollne wir so viele Beispile???}
$$5x-3a = 2cx-7b$$
...
für Bruchgleichungssysteme:

\gleichungZZ{\frac1{x+1} + \frac3{y-2}}{66}{\frac2{x+1} + \frac5{y-2}}{16}
Substituiere $a:=\frac1{x+1}$ und $b:=\frac1{y-2}$:
\gleichungZZ{a + 3b}{66}{2a + 5b}{16}
...
\subsection*{Skalen}
\bbwCenterGraphic{15cm}{img/Skalentyp.pdf}
\TRAINER{Mir fehlt hier noch das Beisipiel «Anzahl» bei Verhältnsisskala.}
...
\TRAINER{Christian: Besipiel T-Shirts? Was war damit gemeint?}
...
Gegeben Kugeln in einer Urne:
\begin{itemize}
\item $N$ mögliche Nieten
\item $T$ mögliche Treffer
\item $t$ gewünschte Treffer
\item $n$ «gewünschte» Nieten ($n$+$t$ = gezogene Elemente)
\end{itemize}
Wahrscheinlichkeit \textbf{genau} $t$ Treffer zu ziehen:

$$P(X=k) = \frac{ {T \choose t} \cdot {N  \choose n} }{{T+N \choose t+n}}.$$
