...
\TRAINER{ev nur am Schulss bei TR:}
...
$$\log_a{}(z)=x \Longleftrightarrow{} a^x = z$$\TRAINER{ev. BASIS $b$?}
\end{tcolorbox}
...
\TRAINER{ev alle TR Knöpfe auf letzter Seite?\\}
...
\bbwCenterGraphic{18cm}{boxplot4.png}
