...
\newcommand{\versionsnummerFoSa}{2021-06-28 0.2.1}
...
\subsection*{Runden}
Bsp.: Runden auf \textbf{\color{ForestGreen}vier}  Dezimalen: Betrachte die nächste Ziffer und runde auf, falls diese {\color{red}Ziffer} $\ge 5$.
...
$m$ > 0: Parabel ($m$ gerade) & $m$ > 0: Parabel ($m$ ungerade)\\   %%\bbwCenterGraphic{8cm}{PotenzFkt.pdf}
  \includegraphics[width=7cm]{PotenzFktx2x4.pdf} &
  \includegraphics[width=7cm]{PotenzFktx3x5.pdf}\\

$m<0$: Hyperbel  ($m$ gerade) & $m<0$: Hyperbel ($m$ ungerade)\\
  \includegraphics[width=7cm]{PotenzFkt1overx2x4.pdf}&
  \includegraphics[width=7cm]{PotenzFkt1overx3x5.pdf}
  \end{tabular}
...
\def\missifarbig{M{\color{ForestGreen}i}{\color{red}ss}{\color{ForestGreen}i}{\color{red}ss}{\color{ForestGreen}i}{\color{cyan}pp}{\color{ForestGreen}i}}
«\missifarbig»-Formel: Wie viele verschiedene Wörter sind mit den Buchstaben des Wortes «\missifarbig» bildbar? Sind einige Buchstaben gleich, so reduziert sich die Anzahl der Möglichkeiten.
$$N = \frac{11!}{{\color{ForestGreen}4}!{\color{red}4}!{\color{cyan}2}!}$$
