...
%% Für Notationen   mit m, q, ... (Rahmenlehrplan [RLP])
\newif\ifisHECH
\newif\ifisRLP
...
\item Säulen- und Kreisdiagramme werden für ordinale und nominale
  Skalen verwendet (und bei quntitativ diskreten Datentypen, wenn es
  wenige Ausprägungen sind).
...
\item Die Höhe der Balken wird durch die (absolute / relative) Häufigkeit der entsprechenden
  Werte festgelegt.
\item Die Flächeninhalte der Rechtecke entsprechen sind proportional
  zu den Häufigkeiten.
