...
\usepackage{makecell}
\renewcommand{\metaHeaderLine}{Formelsammlung GESO (v 0.0.15 2021-06-15 fp)}
...
$$0.\textbf{\color{ForestGreen}0031}\textbf{\color{red}4}\approx 0.\textbf{\color{ForestGreen}0031}$$
...
\textbf{\color{ForestGreen}30.89}\textbf{\color{red}6} = \textbf{\color{ForestGreen}30.90}
...
\TRAINER{Rest: Noch stehen gelassen, da im Kompendium oder in alter Prüfung gesichtet.}
