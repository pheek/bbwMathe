...
\renewcommand{\metaHeaderLine}{Formelsammlung (v 0.0.27 DRAFT 2021-06-20 fp)}
...
$$\log_a(b) = \frac{...}{...} = \frac{}{}$$ \TRAINER{Wieder Farbig}
\end{gesetz*}
...
Auswertung: \tiprobutton{2nd}\tiprobutton{data_stat-reg-distr}\tiprobutton{2}
\end{rezept*}
