...
1 \TRAINER{ $\in\mathbb{N}$};
-4 \TRAINER{ $\in\mathbb{N}$};
8.3 \TRAINER{ $\in\mathbb{N}$};
$\frac{\pi}{3}$ \TRAINER{$\in\mathbb{N}$};
$\sqrt{4}$ \TRAINER{ $\in\mathbb{N}$};
$\frac{3\pi}{2\sqrt{\pi^2}}$ \TRAINER{ $\in\mathbb{Q}$};
$\sqrt{18-7\pi}$ \TRAINER{ $\not\in\mathbb{R}$}
