...
mit  \tiprobutton{xyzabcd} \tiprobutton{plus} \tiprobutton{fuenf} \tiprobutton{enter}
...
Basen; dazu muss die \tiprobutton{ln_log}-Taste jedoch mehrfach gedrückt
werden.
...
Mit \tiprobutton{eins} können Sie die Funktion definieren:
...
Auswahl. Wählen Sie \tiprobutton{zwei}:
