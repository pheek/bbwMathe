...
\begin{center}V 1.3 (2025-10-18) \end{center}
\section{Zehnerlogarithmen}

\textbf{\bbwAufgabenNummer{}.}
Berechnen Sie von Hand den Wert des Termes:
...
\begin{bbwAufgabenBlock}
\item $\lg(1001) \approx  \LoesungsRaum{3.0004}$\abplz{4}
\item $\lg(5) \approx  \LoesungsRaum{0.69897}$\abplz{4}
\item $\lg(0.02) \approx  \LoesungsRaum{-1.69897}$\abplz{4}
\item $\lg(10\cdot{}\pi) \approx  \LoesungsRaum{1.497}$\abplz{4}
\seitenUmbruchImAufgabenteil{}
\item $\lg\left(\left(10^{10}\right)^{10}\right) =  \LoesungsRaum{100 \text{ exakt }}$\abplz{6}
\item $\left(\lg\left(10^{10}\right)\right)^{10} =  \LoesungsRaum{10^{10}}$\abplz{6}
...
% neu:
\item $10 = \sqrt[x]{1000}$ $\LoesungsRaum{\Longrightarrow 10^x=1000 \Longrightarrow x=\lg{1000} = 3}$\abplz{4}


\vspace{2mm} Taschenrechner:
\item $10 = \sqrt[x]{500}$ $\LoesungsRaum{\Longrightarrow 10^x=500 \Longrightarrow x=\lg{}(500) \approx 2.6990}$\abplz{4}
...
\item $10 = \sqrt[x+3]{35000}   \LoesungsRaum{10^{x+3} = 35000 \Longrightarrow x+3 = 35\,000 \Longrightarrow 10^x = 35 \Longrightarrow x=\lg{}(35) \approx 1.5441}$\abplz{4}
...
%neu:
\item $3 = \sqrt[x]{81}  \LoesungsRaum{\Longrightarrow 3^x=81 \Longrightarrow x=\log_3{}(81) = \log_3{3^4} = 4}$\abplz{2}
...
%neu
\item $2 = \sqrt[x]{512}  \LoesungsRaum{\Longrightarrow 2^x=512 \Longrightarrow x=\log_2{}(512) = \log_2{2^9} = 9}$\abplz{2}
...
%neu
\item $10=\sqrt[x]{500}$ \LoesungsRaum{$10^x=500 \Longrightarrow x=\lg{500} \approx 2.6990$}\abplz{3.2}
...
\begin{bbwAufgabenBlock}
\item $7^x = 51$   $\Longrightarrow$ $x=\LoesungsRaum{ \frac{\lg(51)}{\lg(7)}}$\abplz{2}
\item $\log_4(18) = \LoesungsRaum{\frac{\lg(18)}{\lg(4)}}$\abplz{2}
\item $6^{2x} = 100$   $\Longrightarrow$ $x=\LoesungsRaum{ \frac1{\lg(6)}}$\abplz{2}
\item $3.4^{\frac{x}{2}} = 8.7$   $\Longrightarrow$ $x=\LoesungsRaum{ 2\cdot{} \frac{\lg(8.7)}{\lg(3.4)} }$\abplz{2}
%neu
...
\begin{bbwAufgabenBlock}
\item $\log_3(81)     =    \LoesungsRaum{4}$\abplz{2}
...
\item $\log_x\left( 3 \right) = \frac15 \Longrightarrow x =    \LoesungsRaum{243}$\abplz{2}
...
\TRAINER{(Taschenrechner liefert «overflow»)}
%
\end{bbwAufgabenBlock}
...
%%
\item $c^2= \sqrt[x]{c^4} \Longrightarrow x =    \LoesungsRaum{2}$\abplz{2}
...
\item $25=\sqrt[a\cdot{}x]{5^3}  \Longrightarrow x =    \LoesungsRaum{\frac3{2a}}$\abplz{4}
...
\item $70=20 + 25 \cdot{} 1.43^{\frac{x}3}  \Longrightarrow x \approx    \LoesungsRaum{5.814}$\abplz{8}

\item
$x=\log_{13}\left(5^{2000}\right) \Longrightarrow \LoesungsRaumLen{45mm}{x \approx 1254.95}$ \abplz{2}

\item $1000=\log_{x}\left(5^{2000}\right) \Longrightarrow
\LoesungsRaumLen{30mm}{x=25}$ \abplz{2}
...
\item $3 = \e^{\frac{x}4} \Longrightarrow x=    \LoesungsRaum{4\cdot{} \ln(3) (\approx 4.394)}$\abplz{4}
\item $\e^2 = \sqrt[x]{100} \Longrightarrow x= \LoesungsRaum{\frac12\cdot{}\ln(100)}$\abplz{4}
\end{bbwAufgabenBlock}
...
\item $\log_b\left(\frac{b\cdot{}(1+\psi)}{\psi^2-1}\right)  \LoesungsRaum{1-\log_b(\psi-1)}$\abplz{6}
