...
\item $-a\cdot{}(b\cdot{}(-4)) = \LoesungsRaumLang{4ab}$\abplz{4}
\item $-b\cdot{}(-a^2+x) = \LoesungsRaumLang{+a^2b - bx}$\abplz{4}\newpage
\item $-1(5-x)=\LoesungsRaumLang{x-5}$\abplz{4}
\item $5x\cdot{}(ab-1)=\LoesungsRaumLang{5xab - 5x}$\abplz{4}
\item $3rst + rst=\LoesungsRaumLang{4rst}$\abplz{4}
\item $-b\cdot{}(-(a^2)x) = \LoesungsRaumLang{a^2bx}$\abplz{4}\newpage
\end{bbwAufgabenBlock}
\newpage
...
\item $9a\cdot{}(a^2-b)-b\cdot{}(a-b^2) = \LoesungsRaumLang{9a^3 - 10ab + b^3}$\abplz{4}
\end{bbwAufgabenBlock}
\newpage
