...
%% wie AufgabeML, aber ohne das Gleichheitszeichen
...
\aufgabeML{2}{\text{Berechnen Sie (mit TR) und schreiben Sie in wissenschaftlicher Notation: }4^{44}}{ 3.09485 \cdot{} 10^{26}}
...
\TRAINER{277 bbw x 159 Liter pro bbl = 44\,043 Liter = 44.043 m$^3$.}

\item Wie groß in m$^2$ ist der dadurch entstehende Ölteppich ungefähr?
\TRAINER{44.043 [m$^3$] : 0.00008 [m] = 550\,538 m$^2$ $\approx$ 55 ha.}
...
\textbf{Aufgabe \arabic{bbwAufgabenNummerCounter}.} :\,\,
Welche Terme liefern für alle Werte von $a$ ein Resultat $\ge 0$,
selbst wenn $a$ negativ ist?

$-\left(a^4\right); -a^{(4)}; (-a)^4; -a^4; \left(-a^4\right); -\left(a\right)^4$


\TRAINER{Nur $(-a)^4$ wird für alle Werte von $a$ einen Wert $\ge 0$ annehmen. }
...
\aufgabeML{2}{ar^n - br^n}{(a-b)r^n}

\aufgabeML{2}{a^2(a-b)^n - b^2(a-b)^n}{(a^2-b^2)(a-b)^n = (a+b)(a-b)(a-b)^n = (a+b)(a-b)^{n+1}}
\noTRAINER{\newpage}
...
\aufgabeML{6}{-(2s)^4\cdot{}s^3}{-16s^7}
\noTRAINER{\newpage}
...
\aufgabeML{6}{x^{s+10} : x^{10}}{x^{(s+10)-(10)} = x^s}
\aufgabeML{6}{a^{5n-4} : a^{2n+3}}{a^{(5n-4)-(2n+3)} = a^{5n-4-2n-3} =
a^{3n-7}}
\noTRAINER{\newpage}
...
\aufgabeML{4}{x^5 : r^5}{\left(\frac{x}{r}\right)^5}
...
(-p^3:q)^2 = \left(\frac{p^3}{q}\right)^2 =\frac{p^6}{q^2}}
\TRAINER{Das Minuszeichen fällt weg, wegen dem geraden Exponenten ($2$).}
...
\aufgabeMLo{6}{7^{19} \cdot{} 7^3 = 7^x}{19 + 3 = x \Longrightarrow x = 22}
\aufgabeMLo{6}{\left(a^{10}\right)^x = a^{150}}{10x = 150 \Longrightarrow x = 15}
\aufgabeMLo{6}{\left(a^x\right)^3 \cdot{} a^5= \left(a^2\right)^x \cdot{}a^7}{3x+5=2x+7\Longrightarrow x = 2}
...
\aufgabeML{2}{-\left(-(-a)^2\right)^0}{-1}
\aufgabeML{2}{a^5\cdot{}a^{2}\cdot{}a^0\cdot{}a^{7}\cdot{}a\cdot{}a^{4}}{a^{19}}
\aufgabeML{4}{\left( \left( \left(  \left(   \frac37b^{7} + \sqrt{b^2}\right)^{14}  \right)^0 \right)^{3}
\right)^8}{1}

\aufgabeML{4}{-\left(- \left(- \left(-  \left(   \frac18c^{6} + 0.44 \right)^{3}  \right)^0 \right)^{3}
\right)^7}{-1}
\newpage

\subsection{Negative Exponenten bei Zehnerpotenzen}
...
\noTRAINER{\bbwCenterGraphic{80mm}{img/koch.png}}
\TRAINER{\bbwCenterGraphic{50mm}{img/koch.png}}
...
$N_i$  & $1$ & $4$      & \LoesungsRaum{$16$} & \LoesungsRaum{$64$}
& \LoesungsRaum{$4^4$} & ... & \LoesungsRaum{$4^n$}\\\hline%%
$G_i$  & $1$ & $\frac43$ & \LoesungsRaum{$\left(\frac43\right)^2$}
& \LoesungsRaum{$\left(\frac43\right)^3$}
& \LoesungsRaum{$\left(\frac43\right)^4$}
& ...
& \LoesungsRaum{$\left(\frac43\right)^n$}
\end{bbwFillInTabular}%% 
...
\aufgabeMLo{6}{(a^3)^x = \frac{a^{2x}}{a^{-2}}}{3x = 2x - (-2) \Longrightarrow 3x = 2x+2 \Longrightarrow x=2}

\aufgabeMLo{6}{2^x = 4^{-4}}{2^x = 2^{-8} \Longrightarrow x=-8}
\noTRAINER{\newpage}

\aufgabeMLo{6}{(3^x)^6 = \frac1{81}}{3^{6x = 3^{-4}} \Longrightarrow 6x
...
\aufgabeMLo{6}{x^3=125^{-1}}{x^3 = \frac1{125} = \frac1{5^3}
...
\aufgabeML{4}{\sqrt{a^4b^2c^6}}{a^2bc^3}

\aufgabeML{4}{\sqrt{x} + 3\sqrt{x} - 6\sqrt{x}}{-2\sqrt{x}}\noTRAINER{\newpage}

\aufgabeML{6}{\frac18 \sqrt{a} - \left( -\frac14 \sqrt{a} + \frac16 \sqrt{a}  \right) + \frac13 \sqrt{a}}{\frac{13}{24} \sqrt{a}}


Bringen Sie unter eine Wurzel und vereinfachen Sie so weit wie
möglich:

\aufgabeML{2}{3\sqrt{b}}{\sqrt{9b}}


\aufgabeML{3.2}{\frac{\sqrt{c}}4}{\sqrt{\frac{c}{16}}}\noTRAINER{\newpage}

\aufgabeML{6}{\frac{\sqrt{x^3y}}{\sqrt{xy^5}}}{\sqrt{\frac{x^2}{y^4}}
= \frac{x}{y^2}}

\aufgabeML{6}{\sqrt{2ab} \cdot{}  \sqrt{\frac{8a}b}
}{\sqrt{2ab\cdot{}\frac{8a}b} = \sqrt{16a^2} = 4a}\noTRAINER{\newpage}


\aufgabeML{6}{\sqrt{\frac{9x^3}{5y}} : \sqrt{\frac{49x}{20y^5}}}{\frac{6xy^2}{7}}


Vereinfachen Sie durch partielles Radizieren (teilweises
Wurzelziehen):


\aufgabeML{2}{\sqrt{16x}}{4\sqrt{x}}

\aufgabeML{2.8}{\sqrt{8a^3}}{\sqrt{2\cdot{}4\cdot{}a^2\cdot{}a} =
2a\sqrt{2a}}

\aufgabeML{4}{\sqrt{48x^3y^5z^2}}{\sqrt{16\cdot{}3\cdot{}x^2\cdot{}x\cdot{}y^4\cdot{}y\cdot{}z^2}
= 4xy^2z\sqrt{3xy}}\noTRAINER{\newpage}

\aufgabeML{4}{\sqrt{g^3 + g^2}}{\sqrt{g^2 \cdot{} (g+1)} =
g\cdot{}\sqrt{g+1}}

\aufgabeML{6}{\sqrt{a^3+a^2b-ab^2 -b^3}}{(a+b)\cdot{}\sqrt{a-b}}
\TRAINER{$\sqrt{a^3+a^2b-ab^2-b^3} = \sqrt{a^2(a+b)-b^2(a+b)} = \sqrt{(a^2-b^2)(a+b)}
= \sqrt{(a+b)(a-b)(a+b)} = \sqrt{(a+b)^2 \cdot{} (a-b)} =
(a+b)\cdot{}\sqrt{a-b}$}%% end TRAINER


\aufgabeML{2}{\sqrt{a^2 + b^2}}{\sqrt{a^2 + b^2} \text{ kann nicht
...
\aufgabeML{4}{\left(\sqrt[n]{x} + \sqrt[m]{y}  \right) \cdot{}   \left(\sqrt[n]{x} - \sqrt[m]{y}  \right) }{ \left(\sqrt[n]{x^2} - \sqrt[m]{y^2}  \right) }
...
\aufgabeML{4}{\left(\frac8{64}\right)^\frac13}{\frac12}

Berechnen Sie mit dem Taschenrechner und geben Sie drei signifikante
Stellen an.

\aufgabeML{4}{\sqrt{\sqrt[3]{10}\cdot{}\sqrt[4]{10}}}{\sqrt[24]{10^7}\approx 1.96}
...
\aufgabeML{4}{a^\frac13}{\sqrt[3]{a}}

\aufgabeML{4}{4xy^{\frac32}}{\sqrt{16x^2y^3}}

\aufgabeML{4}{f^\frac14 + g^\frac14}{ \text{ Kann nicht vereinfacht
werden. Oder trivial: } \sqrt{\left(f^\frac14 + g^\frac14\right)^2}}
\noTRAINER{\newpage}

\aufgabeML{6}{rst^{\frac{m+n}{m-1}}}{\sqrt[m-1]{(rs)^{m-1}t^{m+n}}}
\noTRAINER{\newpage}

Schreiben Sie als Wurzelterm und ohne negative Exponenten:

\aufgabeML{4}{x^{\frac{-4}3}}{\sqrt[3]{\frac1{x^4}}}

\aufgabeML{4}{3y^{-0.8}}{\sqrt[5]{3^5\cdot{} \frac1{y^4}}}

\aufgabeML{6}{\left(\frac1a\right)^\frac{-3}4}{\sqrt[4]{a^3}}

\noTRAINER{\newpage}

Schreiben Sie als Potenz:

\aufgabeML{2}{\sqrt[3]{x}}{x^\frac13}

\aufgabeML{4}{\sqrt[5]{x^4}}{x^\frac45}

\noTRAINER{\newpage}
Multiplizieren Sie Potenzen mit gleicher Basis:

\aufgabeML{2}{a^\frac12\cdot{} a^{\frac32}}{a^2}
\aufgabeML{3.2}{c^{\frac{-2}3} \cdot{} c^{\frac16} \cdot{}
c^\frac12}{c^0 = 1}

\aufgabeML{4}{x^\frac{r}s \cdot{} x^\frac{t}u}{x^\frac{ru+st}{su}}

\noTRAINER{\newpage}
Dividieren Sie Potenzen mit gleicher Basis:

\aufgabeML{3.2}{\frac{c^{\frac34}}{c^\frac12}}{c^\frac14=\sqrt[4]{c}}

\aufgabeML{3.2}{b^{\frac34} : b^{\frac{-5}6}}{b^\frac{19}{12} = \sqrt[12]{b^{19}}}


\noTRAINER{\newpage}
Multiplizieren Sie die Potenzen mit gleichen Exponenten:

\aufgabeML{2}{72^\frac12 \cdot{} 0.5^\frac12}{36^\frac12 = 6}

\aufgabeML{2}{r^\frac37 \cdot{} \left(\frac1r\right)^\frac37}{1}

\aufgabeML{4}{\left(\frac{5s}{7t}\right)^{\frac{-1}4}  \cdot{}  \left(\frac{7t}{5u}\right)^\frac{-1}4}{\left(\frac{s}u\right)^\frac{-1}{4}
= \left(\frac{u}s\right)^\frac14 = \sqrt[4]{\frac{u}s}}

\noTRAINER{\newpage}

Dividieren Sie Potenzen mit denselben Exponenten:

\aufgabeML{3.2}{\left(\frac1{r^2}\right)^\frac{-2}3  :   r^\frac{-2}3}{r^2}
\aufgabeML{4}{(a-b)^\frac13 :
(a^2-b^2)^\frac13}{\left(\frac{a-b}{(a-b)(a+b)}\right)^\frac13
= \sqrt[3]{\frac1{a+b}} = \frac1{(a+b)^\frac13}}
...
\aufgabeML{4}{\left(s^\frac{-2}5\right)^\frac{-5}6}{s^\frac13
= \sqrt[3]{s}}

\aufgabeML{2}{(49x^2)^\frac{-1}2}{\frac1{7x}}

\aufgabeML{4}{\frac{(e-1)^\frac73}{(e-1)^\frac{8}3}}{(e-1)^\frac{-1}3
= \left(\frac1{e-1}\right)^\frac13 = \sqrt[3]{\frac1{e-1}}}
