...
\aufgabeML{6}{x^7\cdot{} x^{n+1}}{x^{n+8}}
...
\aufgabeML{6}{a^{5n-4} : a^{2n+3}}{a^{(5n-4)-(2n+3)} = b^{5n-4-2n-3} = b^{3n-7}}
...
\aufgabeML{6}{a^7 \cdot{} b^7}{(ab)^7}
\aufgabeML{6}{x^5 \cdot{} r^5}{\left(\frac{x}{r}\right)^5}
\aufgabeML{6}{(2x)^4\cdot{}y^4}{16(xy)^4}
\aufgabeML{6}{2a^5\cdot{}b^5}{2(ab)^5}
\aufgabeML{6}{1.25^{2s}\cdot{}8^{2s}}{10^{2s}}
...
\aufgabeML{6}{(-2p^3)^2 : (2q)^2}{\left((-2p^3) : (2q)\right)^2 = (-p^3:q)^3}
