...
\item $15xy+14xz+16yz = $\LoesungsRaumLang{Keine gemeinsamen Faktoren:
Ist nicht faktorisierbar!}
...
\item $25a^4-2 = $ \LoesungsRaumLang{Kann ohne Wurzeln nicht
faktorisiert werden. Sonst: $(5a^2 + \sqrt{2})(5a^2-\sqrt{2})$}
...
\item $q-4r^2+p^2 + 4qr = $\LoesungsRaumLang{Kann nicht faktorisiert
werden.}
