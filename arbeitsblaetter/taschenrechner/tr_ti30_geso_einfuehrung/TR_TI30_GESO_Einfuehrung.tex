...
existiert die Taste \tiprobutton{2nd} \tiprobutton{neg_answer}. ANS steht für den Wert des
...
und danach das Resultat $\cdot4$.


Starten Sie
eine Rechnung mit einem Operationszeichen (\zB \tiprobutton{mult}\tiprobutton{4}), so
