...
Mit der Taste \tiprobutton{2nd}\tiprobutton{sin_num-solv} ist ist der Rechner in der
Lage, lineare Gleichungen zu lösen. Beispiel:

$$x+2 = 3x-4$$
$$\lx = \{2.5\}$$

Aber \textbf{Achtung}: Dem Resultat ist nicht immer zu trauen. Der
Rechner versucht das Resultat anzunähern. So findet er auch für
unlösbare Gleichungen meist eine Lösung:

$$x+1 = x+2$$

$$\lx = \{\}\text{, der Rechner liefert: } \approx 1.845\cdot{}10^{12}$$

\subsection{Quadratische Gleichungen}\label{quadGL}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection{Lineare Gleichungssysteme}\label{gleichungssysteme}
...
\end{tabular}
\newpage
\section{Geradengleichung durch zwei gegebene Punkte}\index{geradengleichung}\label{geradengleichung}
...
\item
Unter \textbf{\texttt{STAT-REG}} \tiprobutton{2nd} \tiprobutton{data_stat-reg-distr}
