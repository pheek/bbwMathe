...
Sie deren Seitenlängen in Abhängigkeit von $a$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Würfel III (auf Spitze)}
Ein Würfel wird auf dem Boden so auf seine Spitze gestellt, dass eine Raumdiagonale senkrecht steht.
Welcher Winkel entsteht zwischen einer der drei unteren Seiten und dem Boden?

\TNTeop{
Betrachten Sie den Würfel über eine Kante:
\bbwCenterGraphic{8cm}{img/wuerfelAufSpitze.png}

So kann man leicht sehen, dass der gesuchte Winkel $\alpha$ gleich dem Arcustangens von $\sqrt{2}$ ist.

$$\alpha = \arctan\left(\sqrt{2}\right) \approx 54.74\degre$$
}
...
=\arccos\left(\frac{\sqrt3}3\right) \approx 54.74\degre$$
