...
Schnittebene (inkl. Seitenkante) in Abhängigkeit von $a$ oder $x$.
=======
roten Linie geschnitten wird. Beschriften Sie die Strecken mit $a$,
$x$ oder $b$ oder Vielfachen davon.
>>>>>>> 985696beea379c2412aa8cad66995036816f4fd5
...
b) Drücken Sie die Strecke $b$ durch $a$ aus.
...
$$h^2 = r^2 - (\frac{\sqrt{2}}2\cdot{}a)^2$$
$$h = \sqrt{r^2 - (\frac{\sqrt{2}}2\cdot{}a)^2}$$
