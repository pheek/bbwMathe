...
Abtand = $\sqrt{6^2 + 9^2} =\sqrt{117} \approx 10.8$
}%% end TNT
}%% end AufgabeML
...
a) $$g: \,\,\,  \vec{r}(t) = \Spvek{1;2;1} + t\cdot{}\Spvek{-3;5;1}; h: \,\,\,  \vec{r}(t) = \Spvek{4;11;3} + s\cdot{}\Spvek{1;1;-1}$$
b) $$g: \,\,\,  \vec{r}(t) = \Spvek{3;-3;8} + t\cdot{}\Spvek{0;1;0};
h: \,\,\,  \vec{r}(t) = \Spvek{-1;5;2} + s\cdot{}\Spvek{3;1;1}$$

Geben Sie zunächst die Lösungen exakt an (von Hand)

Prüfen Sie das Resultat mit dem Taschenrechner und geben Sie auf vier
signifikante Stellen an.

\TNTeop{
Siehe Lösungen OLAT Marthaler S. 307 Aufg. 35

a) Abstand = $\sqrt{26} \approx5.099$

b) Abstand = ... (coming soon)
