...
b) $\overrightarrow{PQ} = \Spvek{3s-4;s-t+8;s-6}$;  Parameter: $t=\frac{49}5$ und $s=\frac{9}5$; Distanzvektor $\overrightarrow{PQ} = \frac75\cdot{}\Spvek{1;0;-3}$; Abstand = $\frac75 \cdot{} \sqrt{10} \approx 4.43$
}
}%% end AufgabenNr
