...
}{Der Lösungsvektor $\vec{d}$ ist gleich $\Spvek{-\frac13;-\frac95;\frac{31}{15}}$}
...
\aufgabeML{Bestimmen Sie die fehlenden Koordinaten, wenn gilt:
...
{$bx = \LoesungsRaum{-4}$, $c_y = \LoesungsRaum{\frac43}$ und $b_y
...
Lösung zu a) $\overrightarrow{0A} = \LoesungsRaum{\Spvek{5;1}}$.
...
Quadrate streichen und zusammenfassen:
$$49+36-1-4 = 8y + 16 x$$
Grundform:
$$y= -2x + 10$$
