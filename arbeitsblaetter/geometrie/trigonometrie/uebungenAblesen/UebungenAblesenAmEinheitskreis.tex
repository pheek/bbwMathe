...
\noTRAINER{
\begin{tabular}{ccc}
\includegraphics[width=5cm]{img/Einheitskreis304560.png} &\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, &\includegraphics[width=5cm]{img/Einheitskreis304560.png}\\
\end{tabular}
}
...
\noTRAINER{%
\begin{tabular}{ccc}
\includegraphics[width=5cm]{img/Einheitskreis304560.png} & \includegraphics[width=5cm]{img/Einheitskreis304560.png} & \includegraphics[width=5cm]{img/Einheitskreis304560.png}\\
\end{tabular}%
}
...
g) $\sin(135\degre) = \cos(135\degre)$ \LoesungsRaum{Falsch: Sin ist positiv, Cos ist negativ: Die Werte sind gleich}

h) $\cos(\alpha) = \sin(\alpha + 90\degre)$ \LoesungsRaum{Wahr: Kreis um 90 Grad drehen: Phasenverschiebung.}
