...
\begin{center}V 0.3 (2026-02-13) \end{center}
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{enumerate}[resume=aufgaben]
        ...
        \begin{tikzpicture}[scale=1.2, thick]
            ...
            \draw (A) -- (C) node[midway, above left]{$b=7$ dm};
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{enumerate}[resume=aufgaben]
        ...
        \begin{tikzpicture}[scale=1.6, thick]
            ...
            \draw (A) -- (B) node[midway, below]{$\hspace{-8mm}c=5$} -- (C) -- cycle;
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{enumerate}[resume=aufgaben]
        ...
        \begin{tikzpicture}[scale=1.6, thick]
            ...
            \draw (A) -- (B) node[midway, left]{\hspace{-4mm}$a=4.5$} -- (C) node[midway, right]{\hspace{2mm}$c=5$} -- cycle;
...
\begin{minipage}[t]{0.48\textwidth}
    \begin{enumerate}[resume=aufgaben]
        ...
        \begin{tikzpicture}[scale=1.1, thick]
            ...
            \draw (A) -- (B) node[midway, below]{$c=?$} -- (C)
        node[midway, right]{$a=0.60$ dm} -- cycle;
            \draw (A) -- (C) node[midway, left]{$b=80$ mm};
...
\TNTeop{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
\subsection*{Vorwärtseinschnitt}

\begin{enumerate}[resume=aufgaben]
    \item Um eine unzugängliche Strecke (im Bild $\overline{CD}=x$) zu vermessen wird oft der
    \textbf{Vorwärtseinschnitt} verwendet.

    Dabei wird eine zugängliche Strecke (im Bild $\overline{AB}=a$) vermessen und
    von den Enden werden die Winkel ($\alpha_1$, $\alpha_2$, $\beta_1$
    und $\beta_2$) zu den Enden der gesuchten Strecke vermessen:

\bbwCenterGraphic{72mm}{./img/vorwaertseinschnitt.png}

Berechnen Sie damit die Strecke $x$ aus

$a=7.0$ km

$\angle DAB= \alpha_1 = 45\degre$

$\angle CAB= \alpha_2 = 40\degre$

$\angle ABD= \beta_1 = 55\degre$

$\angle ABC= \beta_2 = 60\degre$
...
\begin{enumerate}[resume=loesungen]
    ...
    \item $x = \overline{CD} \approx 0.62$ km
\end{enumerate}
\end{minipage}
