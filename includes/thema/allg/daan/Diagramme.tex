...
\subsection{Säulen- und
  Balkendiagramme}\index{Säulendiagramm@Saulendiagramm}\index{Balkendiagramm}
\theorieGESO{380}{24.1}
...
\begin{rezept}{}{}
  ...
  \item Skala (\noTRAINER{min..max}\TRAINER{min=7...max=32}) und Box zeichnen und Ausreißerschwellen bei $1.5\cdot$IQR andeuten\TRAINER{UAS=9-12=-3; OAS=17+12=29}.
  \item Ausreißer einzeichnen.
  \item Whisker einzeichenen: Minimum und Maximum innerhalb der Ausreißerschwellen: Hier bei \noTRAINER{.....}\TRAINER{7} und \noTRAINER{.....}\TRAINER{19}
