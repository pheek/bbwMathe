...
\GESO{S. Buch \cite{marthaler17} S. 44 Kap. 3.4 Brüche multiplizieren
  und dividieren}
...
\begin{beispiel}{}{}
$$\frac{\frac{x+1}{x^2-1}}{\frac{x^2+1}{-2-2x}}$$
\end{beispiel}

\TNT{7.2}{
  $= \frac{\frac{x+1}{(x-1)(x+1)}}{\frac{(x+1)(x+1)}{-2-2x}}$
  $= \frac{x+1}{(x-1)(x+1)} : \frac{(x+1)(x+1)}{-2-2x}$
  $= \frac{x+1}{(x-1)(x+1)}\cdot\frac{-2-2x}{(x+1)(x+1)}$
  $= \frac{1}{(x-1)}\cdot\frac{-2(1+x)}{(x+1)(x+1)}$
