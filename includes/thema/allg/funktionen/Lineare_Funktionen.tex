...
\GESO{(\cite{marthaler17}       S.237 (Kap. 14))}
\newpage
...
(oder Ordinatenabschnitt\index{Ordinatenabschnitt}\footnote{Die $y$-Koordinate wird auch
    Ordinate\index{Ordinate} genannt.}) genannt.
...
Suchen wir nun $f(x)=y=0$, so lesen wir dies in obiger Grafik etwa bei $x=-6$ ab.

\begin{definition}{Nullstelle}{}
  Eine \textbf{Nullstelle} gibt an, an welchen Stellen der Funktionsgraph die $x$-Achse schneidet.
  \end{definition}

Die Nullstelle einer linearen Funktion in ihrer Grundform ist nichts anderes als die Lösung der linearen Gleichung in ihrer Grundform. Nämlich:
...
Gesucht Nullstelle $x_0$ bei $y_0=0$:
...
\subsection*{Aufgaben}
\GESOAadB{250ff}{5. a) (1) und b) (1) 6. a) b) 7. a) 8. a) 10.}
...
Schreiben wir dies als Funktion in $x$, so können wir folgende Funktion definieren:
$$f(x): x \mapsto y = 4x-5+3x-18+16x$$
Stellen wir diese Funktion nun graphisch dar, so ergibt sich folgendes
Bild:

\raisebox{-1cm}{\includegraphics[width=7cm]{allg/funktionen/img/FunktionsplotAusGleichung.png}}

Die Lösung obiger Gleichung kann nun auf der $x$-Achse ungefähr bei $x=1.0$ abgelesen werden.

\TALSAadB{171ff}{601. a) b) c) e) f) 602. b) c) d) 603. b) c)
 604. 605. a) c) e) 606. a) c) 607. c) d) g) 608. a) 609. a) 610. a)
 611. a) 613. a) 616. c) 622. Flächen: 626. 628. und 629.}
\GESOAadB{252ff}{13. a) d), 14. a) c), 15. a) c), 16. a), 18. a), 19., 23. a) c) e) 25. a) (Optional: 30.) 34. a) b), und 35}
\GESO{\newpage}


\GESO{\input{allg/funktionen/AusAltenMaturapruefungenGESO}}
