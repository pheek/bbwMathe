...
Bemerkung: 
\TNT{2.4}{
$\frac{m}b=\frac{f(t)}{f(0)}=\frac{b\cdot{}a^{\frac{t}{\tau}}}{b\cdot{}a^{\frac0{\tau}}}
...
\item Wie sieht es mit der Basis $e$ aus? Mit welchem $b$ kann man die
  Zunahme als $f(t) = b \cdot{} e^{b\cdot{}t}$ angeben?
\end{enumerate}
...
\item $a=\frac{m}{b}=\frac{f(\tau)}{f(0)}$ ist der Abnahmefaktor ($0<a<1$) zwischen zwei Beobachtungszeitpunkten (im Abstand von $\tau$). Bei Halbierungsprozessen \zB wäre $a=0.5$.
\end{itemize}
