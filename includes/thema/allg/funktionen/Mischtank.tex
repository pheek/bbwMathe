%% Sirup-Beispiel
\paragraph{Mischtank}\index{Mischtank}\index{Sirup}\label{sirup_beispiel}
...
ausgetauscht wird. Sobald nur noch ein Anteil von \TRAINER{$\frac{1}{e}$}\noTRAINER{ ..... } der alten Luft im
...
3. Gedanke: Das Experiment vom 1. Gedanken können wir natürlich auch mit immer kleineren\TALS{, sogenannten infinitesimalen,} Schritten durchführen.
...
\GESO{Wenn wir (\zB mit dem Taschenrechner) die Schrittanzahl immer weiter vergrößen (und somit die pro Schritt ausgetauschte Menge immer verkleinern), so ergibt sich für 1000 Schritte ein Verhältnis von $\left(1-\frac{1}{1000}\right)^{1000}\approx 0.3677 \approx \frac1e$. }
