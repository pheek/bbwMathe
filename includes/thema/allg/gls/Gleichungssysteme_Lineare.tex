...
\paragraph{Rest-Aufgaben}: Eine Zahl $x$ ergibt beim Teilen durch 5
das Resultat 3 mit Rest 2. Wie lautet die Zahl?
\TNT{5.2}{Was bedeutet «Teilen mit Rest»\index{Rest!teilen mit}\index{teilen mit Rest}?
  ...
  Allgemein: $$A : B = C \textrm{ Rest } R \Longleftrightarrow B\cdot{}C + R = A$$

  Refernezaufgabe: Wenn wir eine Zahl durch 15 teilen, so erhalten wir
  8 Rest 4.
