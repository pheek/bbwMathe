...
\item $\overline{E}$ bezeichnet die Komplementärmenge von
  $E$\TRAINER{\footnote{Diese Tatsache gehört nicht zu Kolmogorofs
    Axiomen, kann jedoch daraus abgeleitet werden und wird häufig verwendet.}}, also alle Elemente aus $\Omega$, die nicht in $E$ liegen. Es gilt $P(\overline{E}) = 1-P(E)$. Mit anderen Worten: Die Wahrscheinlichkeit, dass ein Eregins \textbf{nicht} eintritt ist gleich 100\% \textbf{minus} die Warhscheinlichkeit, dass das Ereignis eintritt.
\end{itemize}
\end{gesetz}
