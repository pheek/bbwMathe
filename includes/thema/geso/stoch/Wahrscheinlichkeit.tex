...
Es gelten nach A. Kolmogorofs-Axiomen\footnote{Andrey Nikolaevich
  Kolmogorov 1903-1987} die folgenden Gesetze\TRAINER{\footnote{Streng genommen handelt es sich um Axiome.}}:
...
\begin{gesetz}{}{}
 $\overline{E}$ bezeichnet die Komplementärmenge von
  $E$, also alle Elemente aus $\Omega$, die nicht in $E$ liegen. Es gilt $P(\overline{E}) = 1-P(E)$. Mit anderen Worten: Die Wahrscheinlichkeit, dass ein Ereignis \textbf{nicht} eintritt ist gleich 100\% \textbf{minus} die Wahrscheinlichkeit, dass das Ereignis eintritt.\TRAINER{\footnote{Diese Tatsache gehört nicht zu Kolmogorofs Axiomen, kann jedoch daraus abgeleitet werden und wird häufig verwendet.}}
\end{gesetz}


\subsection*{Aufgaben}
\aufgabenfarbe{Kompendium: Kap. 5.3 Aufg. 8., 9. und 10.}
