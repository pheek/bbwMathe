...
\begin{gesetz}{Summenregel III}{}
  Um die Wahrscheinlichkeit eines Ereignisses zu berechnen, werden alle Wahrscheinlichkeiten derjenigen Endknoten zusammengezählt, deren Ergebnis zum gewünschten Ereignis gehören.
  \end{gesetz}
...
\bbwCenterGraphic{15cm}{geso/stoch/img/mind2sechser.png}
  ...
  Lösung mit Baum oder s. Binomialverteilung.

  a) mindestens 2 Sechser: $\frac2{27}\approx 0.07407$

  b) genau zwei Sechser: $\frac{5}{72}\approx 0.06944$
\vspace{10cm}}
\newpage
...
Peter gewinnt also mit $\frac29 + \frac8{28} = \frac{14}{27}$, was etwas mehr als 50\% ausmacht. Das Spiel ist nicht fair, denn wer als 2. würfeln darf, hat eine leicht höhere Gewinnchance.}
\newpage
