...
\bbwCenterGraphic{15cm}{geso/stoch/img/mind2sechser.png}
  ...
  Lösung mit Baum oder s. Binomialvertelung.

  a) mindestens 2 Sechser: $\frac2{27}\approx 0.07407$

  b) genau zwei Secheser: $\frac{5}{72}\approx 0.06944$
\vspace{10cm}}
\newpage
...
Peter gewinnt also mit $\frac29 + \frac8{28} = \frac{14}{27}$, was etwas mehr als 50\% ausmacht. Das Spiel ist nicht fair, denn wer als 2. würfeln darf, hat eine leicht höhere Gewinnchanche.}
\newpage
...
Die Wahrscheinlichkeit, dass er genau 17 Mal trifft, kennen wir
bereits von der Binomialverteilung (Bernoulli-Experiment):

$$P(E=17) = {20 \choose 17}\cdot 0.85^{17}\cdot 0.15^{3} $$
Dabei bezeichnet $E$ das Ereignis ``siebzehn Treffer in den 20 Würfen''.


Wie groß ist nun die Wahrscheinlichkeit, dass er bei 20 Würfen
...
erzielt. Dies nennen wir die kumulierte\footnote{«Kumulieren» von
  lat. cumulus = anhäufen.} Wahrscheinlichkeit\index{Wahrscheinlichkeit!kumulierte}:
