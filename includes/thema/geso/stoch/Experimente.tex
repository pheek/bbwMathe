...
\textbf{Beispiel 1}: Ich will bei beiden gezogenen Kugeln je einen Treffer:

($t=2$) mit zwei Ziehungen ($t+n=2$), somit keine Niete ($n=0$).
Wir erhalten:

$$P(t=2) = \frac{ {T\choose t} \cdot{} {{N}\choose {n}}}{{{T+N}
    \choose {t+n}}} = \frac{ {3\choose 2} \cdot{} {{4}\choose {0}}}{{7
    \choose 2}} = \frac{3\cdot{}1}{21} = \frac17 \approx 0.14$$

\textbf{Beispiel 2}: Ich will bei beiden gezogenen Kuglen genau einen Treffer:

($t=1$) mit zwei Ziehungen ($t+n=2$), somit eine Niete ($n=1$).
Wir erhalten:

$$P(t=1) = \frac{ {T\choose t} \cdot{} {{N}\choose {n}}}{{{T+N}
    \choose {t+n}}} = \frac{ {3\choose 1} \cdot{} {{4}\choose {1}}}{{7
