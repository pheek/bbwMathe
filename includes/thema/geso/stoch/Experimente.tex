...
Ein mehrfacher Münzwurf mit einer Münze ist ein typisches Bernoulli Experiment,
denn
...
(S. Youtube Videso dazu: Einfach-Mathe!)
...
\begin{gesetz}{Summenregel}{}\index{Summenregel!Baumdiagramm}
Alle von einem Knoten ausgehenden Äste haben in der Summe die Wahrscheinlichkeit 1 (= 100\%).
\end{gesetz}

\begin{gesetz}{Produktregel}{}\index{Produktregel!Baumdiagramm}
...
An einem Glücksrad wird gedreht. $75\degre$ erzielen sofort einen Gewinn. Die anderen $285\degre$ geben einen Verlust an. Zum Glück darf ich am Rad drei mal drehen. Das Spiel endet entweder beim ersten Gewinn oder aber spätestens nach drei maligem Drehen.
...
\aufgabenfarbe{Kompendium: Kap. 5.4 Aufg. 9., 10.}

Mehrstufige Zufallsexperimente:

\aufgabenfarbe{Kompendium: Kap.  5.5.2 Aufg. 17 - 23}
\newpage
...
Einstiegsvideo: ``EinfachMathe!'' (S. Wiki-Lernvideos)
...
\begin{gesetz}{Bernouilli-Formel}{}
  $$P(X=k) = {{n}\choose {k}}\cdot{}p^k\cdot{}p^{n-k}$$
\end{gesetz}

In obigem Beispiel ergibt sich:
$$P(X=3) =
{{5}\choose {3}} \cdot{}\left(\frac13\right)^3\cdot{}\left(\frac13\right)^{5-3}
\approx{} 0.04115 = 4.115\%$$
\newpage
