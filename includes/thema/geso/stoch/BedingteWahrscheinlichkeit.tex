...
Dabei ist $A\cap B$ dasjenige Ereignis, bei dem $A$ \textbf{und} $B$
eintritt; in obigen Beispiel: Alle Personen, die sowohl negativ
getestet (N), sowie auch krank (K) sind.
