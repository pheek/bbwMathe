...
vier Felder vorhanden. Es können jedoch (wie in obigem Beispiel) natürlich mehrere Splaten bzw. Zeilen als zwei vorkommen.

\subsection{Referenzaufgabe: Wirkstoff}
Es werden in einem Spital 123 Personen auf eine Krankheit getestet. Bei 99 Personen fiel der Test positiv aus. Trotzdem sind vier von diesen positiv getesteten Personen gesund und der Test hat falsch angegeben. Zweiundzwanzig (von allen 123) sind jedoch gesund und auch negativ getestet worden.
