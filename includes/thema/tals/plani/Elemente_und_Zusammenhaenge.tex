...
\theorieTALSGeom{8}{1.1; 1.1.1}
\theorieTALSGeom{1.1.2}{1.1.2}
...
\subsection*{Aufgaben}
%%\TALSGeomAadB{???}{???}
Das Buch hat hierzu (mit Ausnahme der Tangente \theorieTALSGeom{33}{1.2.5}) keine zusammengefasste Theorie: Die Aufgaben dazu sind verstreut in den übrigen Kapiteln zur Planimetrie zu finden (Seite 10 - 82 \cite{frommenwiler18geom}).
\TALSGeomAadB{10ff}{2. (1) (2) (3) 4. }
\TALSGeomAadB{16ff (Winkel am Kreis)}{23. a) c) e) }
\TALSGeomAadB{27ff (Kreisberührung)}{81. 82. 83. 86.}
\TALSGeomAadB{33ff (Tangenten)}{106. 107.}
\TALSGeomAadB{34ff (vermischte Aufgaben)}{113. }
\GESOAadB{???}{???}
\newpage
