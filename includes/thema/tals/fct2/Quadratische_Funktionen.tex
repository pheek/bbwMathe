...
\begin{bemerkung}{}{}
  Die Nullstellen der quadratischen Funktion entsprechen den Lösungen der zugehörigen quadratischen Funktion (mit $y=0$). Daher gilt auch hier.
...
Gegeben sind drei Punkte (1|3), (2|3.5) und (-3|11).
...
\begin{center}\fbox{$y = a(x-x_{0_1})\cdot{}(x-x_{0_2}),$}\end{center}

wobei $x_{0_1}$ und $x_{0_2}$ die Nullstellen der Parabel bezeichnen. 
\newpage
...
\TNT{5.2}{Die Funktionsgleichung lautet $y=a(x-x_1)(x-x2)$.\\
  ...
  Wir setzen den gemessenen Punkt (1|0.84) in die Gleichung ein und erhlaten $0.84 = a\cdot{}(1-0)(1-7)$.\\
  Daraus ergibt sich $a=0.84/(-6) = -0.14 $.\\
  Nun setzen wir 3.5 Meter in die Funktionsgleichnug $y = -0.14(x-0)(x-7)$ ein: und erhalten $y=-01.4\cdot{}3.5\cdot{}(-3.5) = 1.715m$; das ist die höchste Parabelstelle.}
