...
\TRAINER{Das Beispiel hat den Nachteil, dass hier das $X_P$ sofort
  durch $X_P=\frac{-B\pm\sqrt{D}}{2A}\frac{-B\pm\sqrt{0}}{2A} =
  \frac{-(-2.5)}{2\cdot{}\frac12} = 2.5$ gefunden werden kann. Leider
  habe ich kein Beispiel gefunden, das nur eine Lösung hat, und der
  gesuchte Parameter dennoch in $B$ oder $A$ der quadratischen
  Gleichung vorkommt.}
\newpage
